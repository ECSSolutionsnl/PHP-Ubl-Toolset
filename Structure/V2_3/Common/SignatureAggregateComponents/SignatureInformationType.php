...
namespace ECSSolutions\UblToolset\Structure\V2_3\Common\SignatureAggregateComponents;
...
class SignatureInformationType
{
     ...
     *  Identifier. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\SignatureBasicComponents\ReferencedSignatureID $referencedSignatureID
     */
     ...
     *  Identifier. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\SignatureBasicComponents\ReferencedSignatureID
     */
     ...
     *  Identifier. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\SignatureBasicComponents\ReferencedSignatureID $referencedSignatureID
     * @return self
     */
    public function setReferencedSignatureID(?\ECSSolutions\UblToolset\Structure\V2_3\Common\SignatureBasicComponents\ReferencedSignatureID $referencedSignatureID = null)
    {
     ...
     * @return self
     */
    public function setSignature(?\ECSSolutions\UblToolset\Structure\V2_3\Common\XmldsigCoreSchema\Signature $signature = null)
    {
