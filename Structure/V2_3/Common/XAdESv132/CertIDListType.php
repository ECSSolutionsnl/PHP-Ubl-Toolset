...
{
    /**
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\XAdESv132\CertIDType[] $cert
     */
    private $cert = [
     ...
     */
    public function addToCert(\ECSSolutions\UblToolset\Structure\V2_3\Common\XAdESv132\CertIDType $cert)
    {
        $this->cert[] = $cert;
        return $this;
    }
