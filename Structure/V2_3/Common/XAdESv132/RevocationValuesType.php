...
class RevocationValuesType
{
    ...
    /**
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\XAdESv132\EncapsulatedPKIDataType[] $cRLValues
     */
    private $cRLValues = null;

    /**
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\XAdESv132\EncapsulatedPKIDataType[] $oCSPValues
     */
    private $oCSPValues = null;

    /**
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\XAdESv132\AnyType[] $otherValues
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\XAdESv132\EncapsulatedPKIDataType $encapsulatedCRLValue
     */
    public function addToCRLValues(\ECSSolutions\UblToolset\Structure\V2_3\Common\XAdESv132\EncapsulatedPKIDataType $encapsulatedCRLValue)
    {
     ...
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\XAdESv132\EncapsulatedPKIDataType[] $cRLValues
     * @return self
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\XAdESv132\EncapsulatedPKIDataType $encapsulatedOCSPValue
     */
    public function addToOCSPValues(\ECSSolutions\UblToolset\Structure\V2_3\Common\XAdESv132\EncapsulatedPKIDataType $encapsulatedOCSPValue)
    {
     ...
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\XAdESv132\EncapsulatedPKIDataType[] $oCSPValues
     * @return self
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\XAdESv132\AnyType $otherValue
     */
    public function addToOtherValues(\ECSSolutions\UblToolset\Structure\V2_3\Common\XAdESv132\AnyType $otherValue)
    {
     ...
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\XAdESv132\AnyType[] $otherValues
     * @return self
     */
