...
class DebitNoteLineType
{
     ...
     *  Quantity. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\DebitedQuantity $debitedQuantity
     */
    ...
    /**
     * BBIE
     *  Debit Note Line. Tax Inclusive_ Line Extension Amount. Amount
     ...
     *  Debit Note Line
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\SubDebitNoteLine[] $subDebitNoteLine
     */
     ...
     *  Quantity. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\DebitedQuantity
     */
     ...
     *  Quantity. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\DebitedQuantity $debitedQuantity
     * @return self
     */
    public function setDebitedQuantity(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\DebitedQuantity $debitedQuantity = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\SubDebitNoteLine $subDebitNoteLine
     */
    public function addToSubDebitNoteLine(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\SubDebitNoteLine $subDebitNoteLine)
    {
     ...
     *  Debit Note Line
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\SubDebitNoteLine[]
     */
