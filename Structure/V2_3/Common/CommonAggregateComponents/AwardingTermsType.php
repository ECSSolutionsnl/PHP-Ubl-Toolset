...
class AwardingTermsType
{
     ...
     *  Code. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\WeightingAlgorithmCode $weightingAlgorithmCode
     */
     ...
     *  Text. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\TechnicalCommitteeDescription[] $technicalCommitteeDescription
     */
     ...
     *  Text. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\LowTendersDescription[] $lowTendersDescription
     */
     ...
     *  Text. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\PrizeDescription[] $prizeDescription
     */
     ...
     *  Text. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\PaymentDescription[] $paymentDescription
     */
    ...
    /**
     * BBIE
     *  Awarding Terms. No Further Negotiation Indicator. Indicator
     ...
     *  Indicator. Type
     *
     * @var bool $noFurtherNegotiationIndicator
     */
    private $noFurtherNegotiationIndicator = null;
     ...
     *  Awarding Criterion
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\AwardingCriterion[] $awardingCriterion
     */
     ...
     *  Person
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\TechnicalCommitteePerson[] $technicalCommitteePerson
     */
     ...
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\Prize[] $prize
     */
    private $prize = [
     ...
     *  Code. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\WeightingAlgorithmCode
     */
     ...
     *  Code. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\WeightingAlgorithmCode $weightingAlgorithmCode
     * @return self
     */
    public function setWeightingAlgorithmCode(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\WeightingAlgorithmCode $weightingAlgorithmCode = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\TechnicalCommitteeDescription $technicalCommitteeDescription
     */
    public function addToTechnicalCommitteeDescription(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\TechnicalCommitteeDescription $technicalCommitteeDescription)
    {
     ...
     *  Text. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\TechnicalCommitteeDescription[]
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\LowTendersDescription $lowTendersDescription
     */
    public function addToLowTendersDescription(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\LowTendersDescription $lowTendersDescription)
    {
     ...
     *  Text. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\LowTendersDescription[]
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\PrizeDescription $prizeDescription
     */
    public function addToPrizeDescription(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\PrizeDescription $prizeDescription)
    {
     ...
     *  Text. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\PrizeDescription[]
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\PaymentDescription $paymentDescription
     */
    public function addToPaymentDescription(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\PaymentDescription $paymentDescription)
    {
     ...
     *  Text. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\PaymentDescription[]
     */
    ...
    /**
     * Gets as noFurtherNegotiationIndicator
     *
     * BBIE
     *  Awarding Terms. No Further Negotiation Indicator. Indicator
     *  Indicates if no further negotiation is allowed (true) or not (false). 
     ...
     * @return bool
     */
    public function getNoFurtherNegotiationIndicator()
    {
        return $this->noFurtherNegotiationIndicator;
    }

    /**
     * Sets a new noFurtherNegotiationIndicator
     *
     * BBIE
     *  Awarding Terms. No Further Negotiation Indicator. Indicator
     *  Indicates if no further negotiation is allowed (true) or not (false). 
     ...
     *  Indicator. Type
     *
     * @param bool $noFurtherNegotiationIndicator
     * @return self
     */
    public function setNoFurtherNegotiationIndicator($noFurtherNegotiationIndicator)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\AwardingCriterion $awardingCriterion
     */
    public function addToAwardingCriterion(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\AwardingCriterion $awardingCriterion)
    {
     ...
     *  Awarding Criterion
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\AwardingCriterion[]
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\TechnicalCommitteePerson $technicalCommitteePerson
     */
    public function addToTechnicalCommitteePerson(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\TechnicalCommitteePerson $technicalCommitteePerson)
    {
     ...
     *  Person
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\TechnicalCommitteePerson[]
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\Prize $prize
     */
    public function addToPrize(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\Prize $prize)
    {
        $this->prize[] = $prize;
        return $this;
    }
     ...
     * @return bool
     */
    public function issetPrize($index)
    {
        return isset($this->prize[$index]);
    }
     ...
     * @return void
     */
    public function unsetPrize($index)
    {
        unset($this->prize[$index]);
    }
     ...
     *  In a design context , 1st place EUR 10 000 , 2nd place EUR 5000
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\Prize[]
     */
     ...
     * @return self
     */
    public function setPrize(?array $prize = null)
    {
        $this->prize = $prize;
        return $this;
    }
