...
class PackageType
{
     ...
     *  Code. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\PackageLevelCode $packageLevelCode
     */
     ...
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\PackagingTypeCode $packagingTypeCode
     */
    private $packagingTypeCode = null;

    /**
     * BBIE
     *  Package. Packaging Type. Text
     ...
     *  Text. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\PackagingType[] $packagingType
     */
     ...
     *  Text. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\PackingMaterial[] $packingMaterial
     */
     ...
     *  Package
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ContainedPackage[] $containedPackage
     */
     ...
     *  Transport Equipment
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ContainingTransportEquipment $containingTransportEquipment
     */
     ...
     *  Delivery Unit
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\DeliveryUnit[] $deliveryUnit
     */
     ...
     *  Code. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\PackageLevelCode
     */
     ...
     *  Code. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\PackageLevelCode $packageLevelCode
     * @return self
     */
    public function setPackageLevelCode(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\PackageLevelCode $packageLevelCode = null)
    {
     ...
     *  Package classification code
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\PackagingTypeCode
     */
     ...
     *  Package classification code
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\PackagingTypeCode $packagingTypeCode
     * @return self
     */
    public function setPackagingTypeCode(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\PackagingTypeCode $packagingTypeCode = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\PackagingType $packagingType
     */
    public function addToPackagingType(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\PackagingType $packagingType)
    {
     ...
     * @return bool
     */
    public function issetPackagingType($index)
    {
        return isset($this->packagingType[$index]);
    }
     ...
     * @return void
     */
    public function unsetPackagingType($index)
    {
        unset($this->packagingType[$index]);
    }

    /**
     * Gets as packagingType
     *
     * BBIE
     *  Package. Packaging Type. Text
     *  The type of packaging, described as a text.
     ...
     *  Text. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\PackagingType[]
     */
     ...
     * @return self
     */
    public function setPackagingType(?array $packagingType = null)
    {
        $this->packagingType = $packagingType;
        return $this;
    }
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\PackingMaterial $packingMaterial
     */
    public function addToPackingMaterial(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\PackingMaterial $packingMaterial)
    {
     ...
     *  Text. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\PackingMaterial[]
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ContainedPackage $containedPackage
     */
    public function addToContainedPackage(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ContainedPackage $containedPackage)
    {
     ...
     *  Package
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ContainedPackage[]
     */
     ...
     *  Transport Equipment
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ContainingTransportEquipment
     */
     ...
     *  Transport Equipment
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ContainingTransportEquipment $containingTransportEquipment
     * @return self
     */
    public function setContainingTransportEquipment(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ContainingTransportEquipment $containingTransportEquipment = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\DeliveryUnit $deliveryUnit
     */
    public function addToDeliveryUnit(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\DeliveryUnit $deliveryUnit)
    {
     ...
     *  Delivery Unit
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\DeliveryUnit[]
     */
