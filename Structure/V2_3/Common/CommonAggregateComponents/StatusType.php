...
class StatusType
{
     ...
     *  Code. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\ConditionCode $conditionCode
     */
     ...
     *  Code. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\StatusReasonCode $statusReasonCode
     */
     ...
     *  Text. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\StatusReason[] $statusReason
     */
     ...
     *  Text. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\Text[] $text
     */
    private $text = [
     ...
     *  Status
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\SubStatus[] $subStatus
     */
    private $subStatus = [
     ...
     *  Condition
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\Condition[] $condition
     */
    private $condition = [
     ...
     *  Code. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\ConditionCode
     */
     ...
     *  Code. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\ConditionCode $conditionCode
     * @return self
     */
    public function setConditionCode(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\ConditionCode $conditionCode = null)
    {
     ...
     *  Code. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\StatusReasonCode
     */
     ...
     *  Code. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\StatusReasonCode $statusReasonCode
     * @return self
     */
    public function setStatusReasonCode(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\StatusReasonCode $statusReasonCode = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\StatusReason $statusReason
     */
    public function addToStatusReason(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\StatusReason $statusReason)
    {
     ...
     *  Text. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\StatusReason[]
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\Text $text
     */
    public function addToText(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\Text $text)
    {
        $this->text[] = $text;
        return $this;
    }
     ...
     *  Text. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\Text[]
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\SubStatus $subStatus
     */
    public function addToSubStatus(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\SubStatus $subStatus)
    {
     ...
     * @return bool
     */
    public function issetSubStatus($index)
    {
        return isset($this->subStatus[$index]);
    }
     ...
     * @return void
     */
    public function unsetSubStatus($index)
    {
        unset($this->subStatus[$index]);
    }
     ...
     *  Status
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\SubStatus[]
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\Condition $condition
     */
    public function addToCondition(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\Condition $condition)
    {
     ...
     *  Condition
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\Condition[]
     */
