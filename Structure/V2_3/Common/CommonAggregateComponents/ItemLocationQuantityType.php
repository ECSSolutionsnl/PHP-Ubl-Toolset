...
class ItemLocationQuantityType
{
     ...
     *  2 days , 24 hours
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\LeadTimeMeasure $leadTimeMeasure
     */
     ...
     *  not for export
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\TradingRestrictions[] $tradingRestrictions
     */
     ...
     *  Dependent Price Reference
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\DependentPriceReference $dependentPriceReference
     */
     ...
     *  2 days , 24 hours
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\LeadTimeMeasure
     */
     ...
     *  2 days , 24 hours
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\LeadTimeMeasure $leadTimeMeasure
     * @return self
     */
    public function setLeadTimeMeasure(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\LeadTimeMeasure $leadTimeMeasure = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\TradingRestrictions $tradingRestrictions
     */
    public function addToTradingRestrictions(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\TradingRestrictions $tradingRestrictions)
    {
     ...
     *  not for export
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\TradingRestrictions[]
     */
     ...
     * @return self
     */
    public function setPackage(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\Package $package = null)
    {
     ...
     *  Dependent Price Reference
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\DependentPriceReference
     */
     ...
     *  Dependent Price Reference
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\DependentPriceReference $dependentPriceReference
     * @return self
     */
    public function setDependentPriceReference(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\DependentPriceReference $dependentPriceReference = null)
    {
