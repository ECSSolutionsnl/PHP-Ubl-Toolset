...
class ConsumptionLineType
{
     ...
     *  Consumption
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\ParentDocumentLineReferenceID $parentDocumentLineReferenceID
     */
     ...
     *  Quantity. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\InvoicedQuantity $invoicedQuantity
     */
    ...
    /**
     * BBIE
     *  Consumption Line. Tax Inclusive_ Line Extension Amount. Amount
     ...
     *  Utility Item
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\UtilityItem $utilityItem
     */
     ...
     *  Unstructured Price
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\UnstructuredPrice $unstructuredPrice
     */
     ...
     *  Consumption
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\ParentDocumentLineReferenceID
     */
     ...
     *  Consumption
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\ParentDocumentLineReferenceID $parentDocumentLineReferenceID
     * @return self
     */
    public function setParentDocumentLineReferenceID(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\ParentDocumentLineReferenceID $parentDocumentLineReferenceID = null)
    {
     ...
     *  Quantity. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\InvoicedQuantity
     */
     ...
     *  Quantity. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\InvoicedQuantity $invoicedQuantity
     * @return self
     */
    public function setInvoicedQuantity(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\InvoicedQuantity $invoicedQuantity)
    {
     ...
     * @return self
     */
    public function setLineExtensionAmount(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\LineExtensionAmount $lineExtensionAmount)
    {
     ...
     *  Utility Item
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\UtilityItem
     */
     ...
     *  Utility Item
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\UtilityItem $utilityItem
     * @return self
     */
    public function setUtilityItem(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\UtilityItem $utilityItem)
    {
     ...
     *  Unstructured Price
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\UnstructuredPrice
     */
     ...
     *  Unstructured Price
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\UnstructuredPrice $unstructuredPrice
     * @return self
     */
    public function setUnstructuredPrice(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\UnstructuredPrice $unstructuredPrice = null)
    {
