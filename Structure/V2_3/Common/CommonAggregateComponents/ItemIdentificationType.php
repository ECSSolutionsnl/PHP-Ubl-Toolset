...
class ItemIdentificationType
{
     ...
     *  Identifier. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\ExtendedID $extendedID
     */
     ...
     *  Identifier. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\BarcodeSymbologyID $barcodeSymbologyID
     */
    private $barcodeSymbologyID = null;

    /**
     * BBIE
     *  Item Identification. Issuer_ Scope Identifier. Identifier
     ...
     *  Physical Attribute
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\PhysicalAttribute[] $physicalAttribute
     */
     ...
     *  Identifier. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\ExtendedID
     */
     ...
     *  Identifier. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\ExtendedID $extendedID
     * @return self
     */
    public function setExtendedID(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\ExtendedID $extendedID = null)
    {
     ...
     *  Identifier. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\BarcodeSymbologyID
     */
     ...
     *  Identifier. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\BarcodeSymbologyID $barcodeSymbologyID
     * @return self
     */
    public function setBarcodeSymbologyID(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\BarcodeSymbologyID $barcodeSymbologyID = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\PhysicalAttribute $physicalAttribute
     */
    public function addToPhysicalAttribute(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\PhysicalAttribute $physicalAttribute)
    {
     ...
     *  Physical Attribute
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\PhysicalAttribute[]
     */
