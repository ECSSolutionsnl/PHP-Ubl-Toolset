...
class GoodsItemType
{
     ...
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\PreferenceCriterionCode $preferenceCriterionCode
     */
     ...
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\RequiredCustomsID $requiredCustomsID
     */
     ...
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\CustomsStatusCode $customsStatusCode
     */
    private $customsStatusCode = null;

    /**
     * BBIE
     *  Goods Item. Customs Procedure Code. Code
     ...
     *  Code. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\CustomsProcedureCode $customsProcedureCode
     */
     ...
     *  Quantity. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\CustomsTariffQuantity $customsTariffQuantity
     */
     ...
     *  Quantity. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\ChargeableQuantity $chargeableQuantity
     */
     ...
     *  Quantity. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\ReturnableQuantity $returnableQuantity
     */
     ...
     *  Goods Item Container
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\GoodsItemContainer[] $goodsItemContainer
     */
     ...
     *  Invoice Line
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\InvoiceLine[] $invoiceLine
     */
    private $invoiceLine = [
    ...
    /**
     * ASBIE
     *  Goods Item. Order Line Reference
     ...
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\Temperature[] $temperature
     */
    private $temperature = [
     ...
     *  Goods Item
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ContainedGoodsItem[] $containedGoodsItem
     */
     ...
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\OriginAddress $originAddress
     */
     ...
     *  Package
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ContainingPackage[] $containingPackage
     */
     ...
     * @return self
     */
    public function setSequenceNumberID(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\SequenceNumberID $sequenceNumberID = null)
    {
     ...
     *  Preference Criterion is used in the following manner in the paper CO of another country (e.g.): A - The good is wholly obtained or produced entirely in the territory of one or more of the NAFTA countries as reference in Article 415. Note: The purchase of a good in the territory does not necessarily render it wholly obtained or produced . If the good is an agricultural good, see also criterion F and Annex 703.2. (Reference: Article 401(a), 415). B - ... C - ... D - ... E - ... F - The good is an originating agricultural good under preference criterion A,B, or C above and is not subjected to quantitative restriction in the importing NAFTA country because.... Thus, the column Preference Criterion will indicate either A, B, C,...
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\PreferenceCriterionCode
     */
     ...
     *  Preference Criterion is used in the following manner in the paper CO of another country (e.g.): A - The good is wholly obtained or produced entirely in the territory of one or more of the NAFTA countries as reference in Article 415. Note: The purchase of a good in the territory does not necessarily render it wholly obtained or produced . If the good is an agricultural good, see also criterion F and Annex 703.2. (Reference: Article 401(a), 415). B - ... C - ... D - ... E - ... F - The good is an originating agricultural good under preference criterion A,B, or C above and is not subjected to quantitative restriction in the importing NAFTA country because.... Thus, the column Preference Criterion will indicate either A, B, C,...
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\PreferenceCriterionCode $preferenceCriterionCode
     * @return self
     */
    public function setPreferenceCriterionCode(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\PreferenceCriterionCode $preferenceCriterionCode = null)
    {
     ...
     *  Tariff code extensions (WCO ID 255)
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\RequiredCustomsID
     */
     ...
     *  Tariff code extensions (WCO ID 255)
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\RequiredCustomsID $requiredCustomsID
     * @return self
     */
    public function setRequiredCustomsID(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\RequiredCustomsID $requiredCustomsID = null)
    {
     ...
     *  Customs status of goods (WCO ID 094)
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\CustomsStatusCode
     */
     ...
     *  Customs status of goods (WCO ID 094)
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\CustomsStatusCode $customsStatusCode
     * @return self
     */
    public function setCustomsStatusCode(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\CustomsStatusCode $customsStatusCode = null)
    {
     ...
     *  Code. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\CustomsProcedureCode
     */
    public function getCustomsProcedureCode()
    {
        return $this->customsProcedureCode;
    }

    /**
     * Sets a new customsProcedureCode
     *
     * BBIE
     *  Goods Item. Customs Procedure Code. Code
     *  A code assigned by customs to signifying the customs procedure applied to this Goods Item.
     ...
     *  Code. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\CustomsProcedureCode $customsProcedureCode
     * @return self
     */
    public function setCustomsProcedureCode(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\CustomsProcedureCode $customsProcedureCode = null)
    {
     ...
     *  Quantity. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\CustomsTariffQuantity
     */
     ...
     *  Quantity. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\CustomsTariffQuantity $customsTariffQuantity
     * @return self
     */
    public function setCustomsTariffQuantity(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\CustomsTariffQuantity $customsTariffQuantity = null)
    {
     ...
     *  Quantity. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\ChargeableQuantity
     */
     ...
     *  Quantity. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\ChargeableQuantity $chargeableQuantity
     * @return self
     */
    public function setChargeableQuantity(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\ChargeableQuantity $chargeableQuantity = null)
    {
     ...
     *  Quantity. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\ReturnableQuantity
     */
     ...
     *  Quantity. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\ReturnableQuantity $returnableQuantity
     * @return self
     */
    public function setReturnableQuantity(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\ReturnableQuantity $returnableQuantity = null)
    {
     ...
     */
    public function addToItem(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\Item $item)
    {
        $this->item[] = $item;
        return $this;
    }
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\GoodsItemContainer $goodsItemContainer
     */
    public function addToGoodsItemContainer(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\GoodsItemContainer $goodsItemContainer)
    {
     ...
     *  Goods Item Container
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\GoodsItemContainer[]
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\InvoiceLine $invoiceLine
     */
    public function addToInvoiceLine(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\InvoiceLine $invoiceLine)
    {
     ...
     *  Invoice Line
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\InvoiceLine[]
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\Temperature $temperature
     */
    public function addToTemperature(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\Temperature $temperature)
    {
     ...
     *  maximum, storage, minimum
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\Temperature[]
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ContainedGoodsItem $containedGoodsItem
     */
    public function addToContainedGoodsItem(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ContainedGoodsItem $containedGoodsItem)
    {
     ...
     *  Goods Item
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ContainedGoodsItem[]
     */
     ...
     *  Region of origin (WCO ID 066)
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\OriginAddress
     */
     ...
     *  Region of origin (WCO ID 066)
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\OriginAddress $originAddress
     * @return self
     */
    public function setOriginAddress(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\OriginAddress $originAddress = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ContainingPackage $containingPackage
     */
    public function addToContainingPackage(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ContainingPackage $containingPackage)
    {
     ...
     *  Package
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ContainingPackage[]
     */
     ...
     * @return self
     */
    public function setShipmentDocumentReference(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ShipmentDocumentReference $shipmentDocumentReference = null)
    {
