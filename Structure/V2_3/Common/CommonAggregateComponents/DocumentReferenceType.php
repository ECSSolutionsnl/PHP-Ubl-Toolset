...
class DocumentReferenceType
{
     ...
     *  Text. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\XPath[] $xPath
     */
    private $xPath = [
    ...
    /**
     * BBIE
     *  Document Reference. Referenced_ Document Internal Address. Text
     *  A pointer to a location within the document being referenced
     *  0..1
     *  Document Reference
     *  Referenced
     *  Document Internal Address
     *  Text
     *  Text. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\ReferencedDocumentInternalAddress $referencedDocumentInternalAddress
     */
    private $referencedDocumentInternalAddress = null;
     ...
     *  Identifier. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\LanguageID $languageID
     */
     ...
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\DocumentDescription[] $documentDescription
     */
     ...
     *  Result Of Verification
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ResultOfVerification $resultOfVerification
     */
     ...
     */
    public function addToDocumentType(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\DocumentType $documentType)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\XPath $xPath
     */
    public function addToXPath(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\XPath $xPath)
    {
        $this->xPath[] = $xPath;
        return $this;
    }
     ...
     *  Text. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\XPath[]
     */
    ...
    /**
     * Gets as referencedDocumentInternalAddress
     *
     * BBIE
     *  Document Reference. Referenced_ Document Internal Address. Text
     *  A pointer to a location within the document being referenced
     ...
     *  Text. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\ReferencedDocumentInternalAddress
     */
    public function getReferencedDocumentInternalAddress()
    {
        return $this->referencedDocumentInternalAddress;
    }

    /**
     * Sets a new referencedDocumentInternalAddress
     *
     * BBIE
     *  Document Reference. Referenced_ Document Internal Address. Text
     *  A pointer to a location within the document being referenced
     ...
     *  Text. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\ReferencedDocumentInternalAddress $referencedDocumentInternalAddress
     * @return self
     */
    public function setReferencedDocumentInternalAddress(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\ReferencedDocumentInternalAddress $referencedDocumentInternalAddress = null)
    {
     ...
     *  Identifier. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\LanguageID
     */
     ...
     *  Identifier. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\LanguageID $languageID
     * @return self
     */
    public function setLanguageID(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\LanguageID $languageID = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\DocumentDescription $documentDescription
     */
    public function addToDocumentDescription(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\DocumentDescription $documentDescription)
    {
     ...
     *  stock no longer provided
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\DocumentDescription[]
     */
     ...
     * @return self
     */
    public function setAttachment(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\Attachment $attachment = null)
    {
     ...
     *  Result Of Verification
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ResultOfVerification
     */
     ...
     *  Result Of Verification
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ResultOfVerification $resultOfVerification
     * @return self
     */
    public function setResultOfVerification(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ResultOfVerification $resultOfVerification = null)
    {
