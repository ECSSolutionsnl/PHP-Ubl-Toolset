...
class ShipmentStageType
{
    ...
    /**
     * BBIE
     *  Shipment Stage. Shipment Stage Type Code. Code
     *  The type of shipment stage, expressed as a code.
     *  0..1
     *  Shipment Stage
     *  Shipment Stage Type Code
     *  Code
     *  Code. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\ShipmentStageTypeCode $shipmentStageTypeCode
     */
    private $shipmentStageTypeCode = null;

    /**
     * BBIE
     *  Shipment Stage. Shipment Stage Type. Text
     ...
     *  Text
     *  Text. Type
     *  Intra European, entering Europe, exiting Europe
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\ShipmentStageType[] $shipmentStageType
     */
    private $shipmentStageType = [
     ...
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\TransportModeCode $transportModeCode
     */
     ...
     *  Code. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\TransitDirectionCode $transitDirectionCode
     */
    ...
    /**
     * BBIE
     *  Shipment Stage. Cabotage_ Indicator. Indicator
     ...
     *  Indicator. Type
     *
     * @var bool $cabotageIndicator
     */
    private $cabotageIndicator = null;

    /**
     * BBIE
     *  Shipment Stage. Hazardous Risk_ Indicator. Indicator
     ...
     *  Identifier. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\SuccessiveSequenceID $successiveSequenceID
     */
     ...
     *  Text. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\Instructions[] $instructions
     */
     ...
     *  Text. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\DemurrageInstructions[] $demurrageInstructions
     */
     ...
     *  Quantity. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\CrewQuantity $crewQuantity
     */
     ...
     *  Quantity. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\PassengerQuantity $passengerQuantity
     */
     ...
     *  Period
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\TransitPeriod $transitPeriod
     */
     ...
     *  Location
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\LoadingPortLocation $loadingPortLocation
     */
     ...
     *  Location
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\UnloadingPortLocation $unloadingPortLocation
     */
     ...
     *  Location
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\TransshipPortLocation $transshipPortLocation
     */
     ...
     *  Transport Event
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\LoadingTransportEvent $loadingTransportEvent
     */
     ...
     *  Transport Event
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ExaminationTransportEvent $examinationTransportEvent
     */
     ...
     *  Transport Event
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\AvailabilityTransportEvent $availabilityTransportEvent
     */
     ...
     *  Transport Event
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ExportationTransportEvent $exportationTransportEvent
     */
     ...
     *  Transport Event
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\DischargeTransportEvent $dischargeTransportEvent
     */
     ...
     *  Transport Event
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\WarehousingTransportEvent $warehousingTransportEvent
     */
     ...
     *  Transport Event
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\TakeoverTransportEvent $takeoverTransportEvent
     */
     ...
     *  Transport Event
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\OptionalTakeoverTransportEvent $optionalTakeoverTransportEvent
     */
     ...
     *  Transport Event
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\DropoffTransportEvent $dropoffTransportEvent
     */
     ...
     *  Transport Event
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\DeliveryTransportEvent $deliveryTransportEvent
     */
     ...
     *  Transport Event
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ReceiptTransportEvent $receiptTransportEvent
     */
     ...
     *  Transport Event
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\StorageTransportEvent $storageTransportEvent
     */
     ...
     *  Transport Event
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\AcceptanceTransportEvent $acceptanceTransportEvent
     */
     ...
     *  Party
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\TerminalOperatorParty $terminalOperatorParty
     */
     ...
     *  Party
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\CustomsAgentParty $customsAgentParty
     */
     ...
     *  Period
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\EstimatedTransitPeriod $estimatedTransitPeriod
     */
     ...
     *  Location
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\FreightChargeLocation $freightChargeLocation
     */
     ...
     *  Transport Event
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\DetentionTransportEvent[] $detentionTransportEvent
     */
     ...
     *  Transport Event
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\RequestedDepartureTransportEvent $requestedDepartureTransportEvent
     */
     ...
     *  Transport Event
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\RequestedArrivalTransportEvent $requestedArrivalTransportEvent
     */
     ...
     *  Transport Event
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\RequestedWaypointTransportEvent[] $requestedWaypointTransportEvent
     */
     ...
     *  Transport Event
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\PlannedWaypointTransportEvent[] $plannedWaypointTransportEvent
     */
     ...
     *  Transport Event
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ActualWaypointTransportEvent $actualWaypointTransportEvent
     */
     ...
     *  Person
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\DriverPerson[] $driverPerson
     */
     ...
     *  Person
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ReportingPerson $reportingPerson
     */
     ...
     *  Person
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\CrewMemberPerson[] $crewMemberPerson
     */
     ...
     *  Person
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\MasterPerson $masterPerson
     */
     ...
     *  Person
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ShipsSurgeonPerson $shipsSurgeonPerson
     */
    private $shipsSurgeonPerson = null;

    /**
     * ASBIE
     *  Shipment Stage. Destination_ Port Call. Port Call
     ...
     *  Port Call
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\DestinationPortCall $destinationPortCall
     */
    private $destinationPortCall = null;

    /**
     * ASBIE
     *  Shipment Stage. Ship Store Article
     ...
     *  Ship Store Article
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ShipStoreArticle[] $shipStoreArticle
     */
    private $shipStoreArticle = [
        
    ];

    /**
     * ASBIE
     *  Shipment Stage. Crew Person Effect
     ...
     *  Crew Person Effect
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\CrewPersonEffect[] $crewPersonEffect
     */
    private $crewPersonEffect = [
        
    ];

    /**
     * ASBIE
     *  Shipment Stage. Maritime Waste
     ...
     *  Maritime Waste
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\MaritimeWaste[] $maritimeWaste
     */
    private $maritimeWaste = [
        
    ];

    /**
     * ASBIE
     *  Shipment Stage. Ballast Water Summary
     ...
     *  Ballast Water Summary
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\BallastWaterSummary $ballastWaterSummary
     */
    private $ballastWaterSummary = null;

    /**
     * ASBIE
     *  Shipment Stage. ISPS Requirements
     ...
     *  ISPS Requirements
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ISPSRequirements $iSPSRequirements
     */
    private $iSPSRequirements = null;

    /**
     * ASBIE
     *  Shipment Stage. Maritime Health Declaration
     ...
     *  Maritime Health Declaration
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\MaritimeHealthDeclaration $maritimeHealthDeclaration
     */
    private $maritimeHealthDeclaration = null;
     ...
     *  Code. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\ShipmentStageTypeCode
     */
    public function getShipmentStageTypeCode()
    {
        return $this->shipmentStageTypeCode;
    }

    /**
     * Sets a new shipmentStageTypeCode
     *
     * BBIE
     *  Shipment Stage. Shipment Stage Type Code. Code
     *  The type of shipment stage, expressed as a code.
     ...
     *  Code. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\ShipmentStageTypeCode $shipmentStageTypeCode
     * @return self
     */
    public function setShipmentStageTypeCode(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\ShipmentStageTypeCode $shipmentStageTypeCode = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\ShipmentStageType $shipmentStageType
     */
    public function addToShipmentStageType(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\ShipmentStageType $shipmentStageType)
    {
        $this->shipmentStageType[] = $shipmentStageType;
        return $this;
    }

    /**
     * isset shipmentStageType
     *
     * BBIE
     *  Shipment Stage. Shipment Stage Type. Text
     *  The type of shipment stage, expressed as text.
     ...
     * @return bool
     */
    public function issetShipmentStageType($index)
    {
        return isset($this->shipmentStageType[$index]);
    }

    /**
     * unset shipmentStageType
     *
     * BBIE
     *  Shipment Stage. Shipment Stage Type. Text
     *  The type of shipment stage, expressed as text.
     ...
     * @return void
     */
    public function unsetShipmentStageType($index)
    {
        unset($this->shipmentStageType[$index]);
    }

    /**
     * Gets as shipmentStageType
     *
     * BBIE
     *  Shipment Stage. Shipment Stage Type. Text
     *  The type of shipment stage, expressed as text.
     ...
     *  Intra European, entering Europe, exiting Europe
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\ShipmentStageType[]
     */
    public function getShipmentStageType()
    {
        return $this->shipmentStageType;
    }

    /**
     * Sets a new shipmentStageType
     *
     * BBIE
     *  Shipment Stage. Shipment Stage Type. Text
     *  The type of shipment stage, expressed as text.
     ...
     * @return self
     */
    public function setShipmentStageType(?array $shipmentStageType = null)
    {
        $this->shipmentStageType = $shipmentStageType;
        return $this;
    }
     ...
     *  Transport Mode_ Code. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\TransportModeCode
     */
     ...
     *  Transport Mode_ Code. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\TransportModeCode $transportModeCode
     * @return self
     */
    public function setTransportModeCode(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\TransportModeCode $transportModeCode = null)
    {
     ...
     *  Code. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\TransitDirectionCode
     */
     ...
     *  Code. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\TransitDirectionCode $transitDirectionCode
     * @return self
     */
    public function setTransitDirectionCode(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\TransitDirectionCode $transitDirectionCode = null)
    {
     ...
     * @return bool
     */
    public function getCabotageIndicator()
    {
        return $this->cabotageIndicator;
    }

    /**
     * Sets a new cabotageIndicator
     *
     * BBIE
     *  Shipment Stage. Cabotage_ Indicator. Indicator
     *  An indicator that cabotage applies for this shipment stage (true) or not (false).
     ...
     *  Indicator. Type
     *
     * @param bool $cabotageIndicator
     * @return self
     */
    public function setCabotageIndicator($cabotageIndicator)
    {
     ...
     *  Identifier. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\SuccessiveSequenceID
     */
     ...
     *  Identifier. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\SuccessiveSequenceID $successiveSequenceID
     * @return self
     */
    public function setSuccessiveSequenceID(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\SuccessiveSequenceID $successiveSequenceID = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\Instructions $instructions
     */
    public function addToInstructions(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\Instructions $instructions)
    {
     ...
     *  Text. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\Instructions[]
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\DemurrageInstructions $demurrageInstructions
     */
    public function addToDemurrageInstructions(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\DemurrageInstructions $demurrageInstructions)
    {
     ...
     *  Text. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\DemurrageInstructions[]
     */
     ...
     *  Quantity. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\CrewQuantity
     */
     ...
     *  Quantity. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\CrewQuantity $crewQuantity
     * @return self
     */
    public function setCrewQuantity(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\CrewQuantity $crewQuantity = null)
    {
     ...
     *  Quantity. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\PassengerQuantity
     */
     ...
     *  Quantity. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\PassengerQuantity $passengerQuantity
     * @return self
     */
    public function setPassengerQuantity(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\PassengerQuantity $passengerQuantity = null)
    {
     ...
     *  Period
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\TransitPeriod
     */
     ...
     *  Period
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\TransitPeriod $transitPeriod
     * @return self
     */
    public function setTransitPeriod(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\TransitPeriod $transitPeriod = null)
    {
     ...
     */
    public function addToCarrierParty(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\CarrierParty $carrierParty)
    {
     ...
     * @return self
     */
    public function setTransportMeans(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\TransportMeans $transportMeans = null)
    {
     ...
     *  Location
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\LoadingPortLocation
     */
     ...
     *  Location
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\LoadingPortLocation $loadingPortLocation
     * @return self
     */
    public function setLoadingPortLocation(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\LoadingPortLocation $loadingPortLocation = null)
    {
     ...
     *  Location
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\UnloadingPortLocation
     */
     ...
     *  Location
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\UnloadingPortLocation $unloadingPortLocation
     * @return self
     */
    public function setUnloadingPortLocation(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\UnloadingPortLocation $unloadingPortLocation = null)
    {
     ...
     *  Location
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\TransshipPortLocation
     */
     ...
     *  Location
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\TransshipPortLocation $transshipPortLocation
     * @return self
     */
    public function setTransshipPortLocation(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\TransshipPortLocation $transshipPortLocation = null)
    {
     ...
     *  Transport Event
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\LoadingTransportEvent
     */
     ...
     *  Transport Event
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\LoadingTransportEvent $loadingTransportEvent
     * @return self
     */
    public function setLoadingTransportEvent(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\LoadingTransportEvent $loadingTransportEvent = null)
    {
     ...
     *  Transport Event
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ExaminationTransportEvent
     */
     ...
     *  Transport Event
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ExaminationTransportEvent $examinationTransportEvent
     * @return self
     */
    public function setExaminationTransportEvent(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ExaminationTransportEvent $examinationTransportEvent = null)
    {
     ...
     *  Transport Event
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\AvailabilityTransportEvent
     */
     ...
     *  Transport Event
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\AvailabilityTransportEvent $availabilityTransportEvent
     * @return self
     */
    public function setAvailabilityTransportEvent(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\AvailabilityTransportEvent $availabilityTransportEvent = null)
    {
     ...
     *  Transport Event
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ExportationTransportEvent
     */
     ...
     *  Transport Event
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ExportationTransportEvent $exportationTransportEvent
     * @return self
     */
    public function setExportationTransportEvent(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ExportationTransportEvent $exportationTransportEvent = null)
    {
     ...
     *  Transport Event
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\DischargeTransportEvent
     */
     ...
     *  Transport Event
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\DischargeTransportEvent $dischargeTransportEvent
     * @return self
     */
    public function setDischargeTransportEvent(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\DischargeTransportEvent $dischargeTransportEvent = null)
    {
     ...
     *  Transport Event
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\WarehousingTransportEvent
     */
     ...
     *  Transport Event
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\WarehousingTransportEvent $warehousingTransportEvent
     * @return self
     */
    public function setWarehousingTransportEvent(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\WarehousingTransportEvent $warehousingTransportEvent = null)
    {
     ...
     *  Transport Event
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\TakeoverTransportEvent
     */
     ...
     *  Transport Event
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\TakeoverTransportEvent $takeoverTransportEvent
     * @return self
     */
    public function setTakeoverTransportEvent(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\TakeoverTransportEvent $takeoverTransportEvent = null)
    {
     ...
     *  Transport Event
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\OptionalTakeoverTransportEvent
     */
     ...
     *  Transport Event
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\OptionalTakeoverTransportEvent $optionalTakeoverTransportEvent
     * @return self
     */
    public function setOptionalTakeoverTransportEvent(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\OptionalTakeoverTransportEvent $optionalTakeoverTransportEvent = null)
    {
     ...
     *  Transport Event
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\DropoffTransportEvent
     */
     ...
     *  Transport Event
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\DropoffTransportEvent $dropoffTransportEvent
     * @return self
     */
    public function setDropoffTransportEvent(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\DropoffTransportEvent $dropoffTransportEvent = null)
    {
     ...
     *  Transport Event
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\DeliveryTransportEvent
     */
     ...
     *  Transport Event
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\DeliveryTransportEvent $deliveryTransportEvent
     * @return self
     */
    public function setDeliveryTransportEvent(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\DeliveryTransportEvent $deliveryTransportEvent = null)
    {
     ...
     *  Transport Event
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ReceiptTransportEvent
     */
     ...
     *  Transport Event
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ReceiptTransportEvent $receiptTransportEvent
     * @return self
     */
    public function setReceiptTransportEvent(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ReceiptTransportEvent $receiptTransportEvent = null)
    {
     ...
     *  Transport Event
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\StorageTransportEvent
     */
     ...
     *  Transport Event
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\StorageTransportEvent $storageTransportEvent
     * @return self
     */
    public function setStorageTransportEvent(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\StorageTransportEvent $storageTransportEvent = null)
    {
     ...
     *  Transport Event
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\AcceptanceTransportEvent
     */
     ...
     *  Transport Event
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\AcceptanceTransportEvent $acceptanceTransportEvent
     * @return self
     */
    public function setAcceptanceTransportEvent(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\AcceptanceTransportEvent $acceptanceTransportEvent = null)
    {
     ...
     *  Party
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\TerminalOperatorParty
     */
     ...
     *  Party
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\TerminalOperatorParty $terminalOperatorParty
     * @return self
     */
    public function setTerminalOperatorParty(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\TerminalOperatorParty $terminalOperatorParty = null)
    {
     ...
     *  Party
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\CustomsAgentParty
     */
     ...
     *  Party
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\CustomsAgentParty $customsAgentParty
     * @return self
     */
    public function setCustomsAgentParty(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\CustomsAgentParty $customsAgentParty = null)
    {
     ...
     *  Period
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\EstimatedTransitPeriod
     */
     ...
     *  Period
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\EstimatedTransitPeriod $estimatedTransitPeriod
     * @return self
     */
    public function setEstimatedTransitPeriod(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\EstimatedTransitPeriod $estimatedTransitPeriod = null)
    {
     ...
     *  Location
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\FreightChargeLocation
     */
     ...
     *  Location
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\FreightChargeLocation $freightChargeLocation
     * @return self
     */
    public function setFreightChargeLocation(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\FreightChargeLocation $freightChargeLocation = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\DetentionTransportEvent $detentionTransportEvent
     */
    public function addToDetentionTransportEvent(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\DetentionTransportEvent $detentionTransportEvent)
    {
     ...
     *  Transport Event
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\DetentionTransportEvent[]
     */
     ...
     *  Transport Event
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\RequestedDepartureTransportEvent
     */
     ...
     *  Transport Event
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\RequestedDepartureTransportEvent $requestedDepartureTransportEvent
     * @return self
     */
    public function setRequestedDepartureTransportEvent(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\RequestedDepartureTransportEvent $requestedDepartureTransportEvent = null)
    {
     ...
     *  Transport Event
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\RequestedArrivalTransportEvent
     */
     ...
     *  Transport Event
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\RequestedArrivalTransportEvent $requestedArrivalTransportEvent
     * @return self
     */
    public function setRequestedArrivalTransportEvent(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\RequestedArrivalTransportEvent $requestedArrivalTransportEvent = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\RequestedWaypointTransportEvent $requestedWaypointTransportEvent
     */
    public function addToRequestedWaypointTransportEvent(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\RequestedWaypointTransportEvent $requestedWaypointTransportEvent)
    {
     ...
     *  Transport Event
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\RequestedWaypointTransportEvent[]
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\PlannedWaypointTransportEvent $plannedWaypointTransportEvent
     */
    public function addToPlannedWaypointTransportEvent(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\PlannedWaypointTransportEvent $plannedWaypointTransportEvent)
    {
     ...
     *  Transport Event
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\PlannedWaypointTransportEvent[]
     */
     ...
     *  Transport Event
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ActualWaypointTransportEvent
     */
     ...
     *  Transport Event
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ActualWaypointTransportEvent $actualWaypointTransportEvent
     * @return self
     */
    public function setActualWaypointTransportEvent(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ActualWaypointTransportEvent $actualWaypointTransportEvent = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\DriverPerson $driverPerson
     */
    public function addToDriverPerson(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\DriverPerson $driverPerson)
    {
     ...
     *  Person
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\DriverPerson[]
     */
     ...
     *  Person
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ReportingPerson
     */
     ...
     *  Person
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ReportingPerson $reportingPerson
     * @return self
     */
    public function setReportingPerson(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ReportingPerson $reportingPerson = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\CrewMemberPerson $crewMemberPerson
     */
    public function addToCrewMemberPerson(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\CrewMemberPerson $crewMemberPerson)
    {
     ...
     *  Person
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\CrewMemberPerson[]
     */
     ...
     *  Person
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\MasterPerson
     */
     ...
     *  Person
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\MasterPerson $masterPerson
     * @return self
     */
    public function setMasterPerson(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\MasterPerson $masterPerson = null)
    {
     ...
     *  Person
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ShipsSurgeonPerson
     */
     ...
     *  Person
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ShipsSurgeonPerson $shipsSurgeonPerson
     * @return self
     */
    public function setShipsSurgeonPerson(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ShipsSurgeonPerson $shipsSurgeonPerson = null)
    {
     ...
     *  Port Call
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\DestinationPortCall
     */
    public function getDestinationPortCall()
    {
        return $this->destinationPortCall;
    }

    /**
     * Sets a new destinationPortCall
     *
     * ASBIE
     *  Shipment Stage. Destination_ Port Call. Port Call
     *  A destination port call for this shipment stage.
     ...
     *  Port Call
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\DestinationPortCall $destinationPortCall
     * @return self
     */
    public function setDestinationPortCall(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\DestinationPortCall $destinationPortCall = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ShipStoreArticle $shipStoreArticle
     */
    public function addToShipStoreArticle(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ShipStoreArticle $shipStoreArticle)
    {
        $this->shipStoreArticle[] = $shipStoreArticle;
        return $this;
    }

    /**
     * isset shipStoreArticle
     *
     * ASBIE
     *  Shipment Stage. Ship Store Article
     *  The ship store articles for this shipment stage.
     ...
     * @return bool
     */
    public function issetShipStoreArticle($index)
    {
        return isset($this->shipStoreArticle[$index]);
    }

    /**
     * unset shipStoreArticle
     *
     * ASBIE
     *  Shipment Stage. Ship Store Article
     *  The ship store articles for this shipment stage.
     ...
     * @return void
     */
    public function unsetShipStoreArticle($index)
    {
        unset($this->shipStoreArticle[$index]);
    }

    /**
     * Gets as shipStoreArticle
     *
     * ASBIE
     *  Shipment Stage. Ship Store Article
     *  The ship store articles for this shipment stage.
     ...
     *  Ship Store Article
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ShipStoreArticle[]
     */
    public function getShipStoreArticle()
    {
        return $this->shipStoreArticle;
    }

    /**
     * Sets a new shipStoreArticle
     *
     * ASBIE
     *  Shipment Stage. Ship Store Article
     *  The ship store articles for this shipment stage.
     ...
     * @return self
     */
    public function setShipStoreArticle(?array $shipStoreArticle = null)
    {
        $this->shipStoreArticle = $shipStoreArticle;
        return $this;
    }
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\CrewPersonEffect $crewPersonEffect
     */
    public function addToCrewPersonEffect(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\CrewPersonEffect $crewPersonEffect)
    {
        $this->crewPersonEffect[] = $crewPersonEffect;
        return $this;
    }

    /**
     * isset crewPersonEffect
     *
     * ASBIE
     *  Shipment Stage. Crew Person Effect
     *  The crew person effects for this shipment stage.
     ...
     * @return bool
     */
    public function issetCrewPersonEffect($index)
    {
        return isset($this->crewPersonEffect[$index]);
    }

    /**
     * unset crewPersonEffect
     *
     * ASBIE
     *  Shipment Stage. Crew Person Effect
     *  The crew person effects for this shipment stage.
     ...
     * @return void
     */
    public function unsetCrewPersonEffect($index)
    {
        unset($this->crewPersonEffect[$index]);
    }

    /**
     * Gets as crewPersonEffect
     *
     * ASBIE
     *  Shipment Stage. Crew Person Effect
     *  The crew person effects for this shipment stage.
     ...
     *  Crew Person Effect
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\CrewPersonEffect[]
     */
    public function getCrewPersonEffect()
    {
        return $this->crewPersonEffect;
    }

    /**
     * Sets a new crewPersonEffect
     *
     * ASBIE
     *  Shipment Stage. Crew Person Effect
     *  The crew person effects for this shipment stage.
     ...
     * @return self
     */
    public function setCrewPersonEffect(?array $crewPersonEffect = null)
    {
        $this->crewPersonEffect = $crewPersonEffect;
        return $this;
    }
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\MaritimeWaste $maritimeWaste
     */
    public function addToMaritimeWaste(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\MaritimeWaste $maritimeWaste)
    {
        $this->maritimeWaste[] = $maritimeWaste;
        return $this;
    }
     ...
     * @return bool
     */
    public function issetMaritimeWaste($index)
    {
        return isset($this->maritimeWaste[$index]);
    }
     ...
     * @return void
     */
    public function unsetMaritimeWaste($index)
    {
        unset($this->maritimeWaste[$index]);
    }

    /**
     * Gets as maritimeWaste
     *
     * ASBIE
     *  Shipment Stage. Maritime Waste
     *  The maritime waste for this shipment stage.
     ...
     *  Maritime Waste
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\MaritimeWaste[]
     */
    public function getMaritimeWaste()
    {
        return $this->maritimeWaste;
    }

    /**
     * Sets a new maritimeWaste
     *
     * ASBIE
     *  Shipment Stage. Maritime Waste
     *  The maritime waste for this shipment stage.
     ...
     * @return self
     */
    public function setMaritimeWaste(?array $maritimeWaste = null)
    {
        $this->maritimeWaste = $maritimeWaste;
        return $this;
    }
     ...
     *  Ballast Water Summary
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\BallastWaterSummary
     */
    public function getBallastWaterSummary()
    {
        return $this->ballastWaterSummary;
    }

    /**
     * Sets a new ballastWaterSummary
     *
     * ASBIE
     *  Shipment Stage. Ballast Water Summary
     *  A ballast water summary for this shipment stage.
     ...
     *  Ballast Water Summary
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\BallastWaterSummary $ballastWaterSummary
     * @return self
     */
    public function setBallastWaterSummary(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\BallastWaterSummary $ballastWaterSummary = null)
    {
     ...
     *  ISPS Requirements
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ISPSRequirements
     */
    public function getISPSRequirements()
    {
        return $this->iSPSRequirements;
    }

    /**
     * Sets a new iSPSRequirements
     *
     * ASBIE
     *  Shipment Stage. ISPS Requirements
     *  The ISPS (International Ship and Port Facility Security Code) requirements for this shipment stage.
     ...
     *  ISPS Requirements
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ISPSRequirements $iSPSRequirements
     * @return self
     */
    public function setISPSRequirements(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ISPSRequirements $iSPSRequirements = null)
    {
    ...
    /**
     * Gets as maritimeHealthDeclaration
     *
     * ASBIE
     *  Shipment Stage. Maritime Health Declaration
     *  A maritime declaration of health for this shipment stage.
     ...
     *  Maritime Health Declaration
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\MaritimeHealthDeclaration
     */
    public function getMaritimeHealthDeclaration()
    {
        return $this->maritimeHealthDeclaration;
    }

    /**
     * Sets a new maritimeHealthDeclaration
     *
     * ASBIE
     *  Shipment Stage. Maritime Health Declaration
     *  A maritime declaration of health for this shipment stage.
     ...
     *  Maritime Health Declaration
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\MaritimeHealthDeclaration $maritimeHealthDeclaration
     * @return self
     */
    public function setMaritimeHealthDeclaration(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\MaritimeHealthDeclaration $maritimeHealthDeclaration = null)
    {
