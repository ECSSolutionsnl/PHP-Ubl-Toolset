...
class QualificationResolutionType
{
     ...
     *  Code. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\AdmissionCode $admissionCode
     */
     ...
     *  Text. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\ExclusionReason[] $exclusionReason
     */
     ...
     *  Text. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\Resolution[] $resolution
     */
    private $resolution = [
     ...
     *  Code. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\AdmissionCode
     */
     ...
     *  Code. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\AdmissionCode $admissionCode
     * @return self
     */
    public function setAdmissionCode(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\AdmissionCode $admissionCode)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\ExclusionReason $exclusionReason
     */
    public function addToExclusionReason(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\ExclusionReason $exclusionReason)
    {
     ...
     *  Text. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\ExclusionReason[]
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\Resolution $resolution
     */
    public function addToResolution(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\Resolution $resolution)
    {
     ...
     *  Text. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\Resolution[]
     */
     ...
     * @return self
     */
    public function setProcurementProjectLot(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ProcurementProjectLot $procurementProjectLot = null)
    {
