...
class TendererQualificationRequestType
{
     ...
     *  Code. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\CompanyLegalFormCode $companyLegalFormCode
     */
     ...
     *  Text. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\CompanyLegalForm[] $companyLegalForm
     */
     ...
     *  Classification Scheme
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\RequiredBusinessClassificationScheme[] $requiredBusinessClassificationScheme
     */
     ...
     *  Evaluation Criterion
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\TechnicalEvaluationCriterion[] $technicalEvaluationCriterion
     */
     ...
     *  Evaluation Criterion
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\FinancialEvaluationCriterion[] $financialEvaluationCriterion
     */
     ...
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\SpecificTendererRequirement[] $specificTendererRequirement
     */
     ...
     *  Code. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\CompanyLegalFormCode
     */
     ...
     *  Code. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\CompanyLegalFormCode $companyLegalFormCode
     * @return self
     */
    public function setCompanyLegalFormCode(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\CompanyLegalFormCode $companyLegalFormCode = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\CompanyLegalForm $companyLegalForm
     */
    public function addToCompanyLegalForm(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\CompanyLegalForm $companyLegalForm)
    {
     ...
     * @return bool
     */
    public function issetCompanyLegalForm($index)
    {
        return isset($this->companyLegalForm[$index]);
    }

    /**
     * unset companyLegalForm
     *
     * BBIE
     *  Tenderer Qualification Request. Company Legal Form. Text
     *  The legal status requested for potential tenderers, expressed as text
     ...
     * @return void
     */
    public function unsetCompanyLegalForm($index)
    {
        unset($this->companyLegalForm[$index]);
    }
     ...
     *  Text. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\CompanyLegalForm[]
     */
     ...
     * @return self
     */
    public function setCompanyLegalForm(?array $companyLegalForm = null)
    {
        $this->companyLegalForm = $companyLegalForm;
        return $this;
    }
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\RequiredBusinessClassificationScheme $requiredBusinessClassificationScheme
     */
    public function addToRequiredBusinessClassificationScheme(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\RequiredBusinessClassificationScheme $requiredBusinessClassificationScheme)
    {
     ...
     *  Classification Scheme
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\RequiredBusinessClassificationScheme[]
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\TechnicalEvaluationCriterion $technicalEvaluationCriterion
     */
    public function addToTechnicalEvaluationCriterion(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\TechnicalEvaluationCriterion $technicalEvaluationCriterion)
    {
     ...
     *  Evaluation Criterion
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\TechnicalEvaluationCriterion[]
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\FinancialEvaluationCriterion $financialEvaluationCriterion
     */
    public function addToFinancialEvaluationCriterion(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\FinancialEvaluationCriterion $financialEvaluationCriterion)
    {
     ...
     *  Evaluation Criterion
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\FinancialEvaluationCriterion[]
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\SpecificTendererRequirement $specificTendererRequirement
     */
    public function addToSpecificTendererRequirement(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\SpecificTendererRequirement $specificTendererRequirement)
    {
     ...
     *  Preregistration in a Business Registry
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\SpecificTendererRequirement[]
     */
     ...
     */
    public function addToEconomicOperatorRole(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\EconomicOperatorRole $economicOperatorRole)
    {
