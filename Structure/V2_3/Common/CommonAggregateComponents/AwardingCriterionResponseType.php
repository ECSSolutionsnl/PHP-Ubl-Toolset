...
class AwardingCriterionResponseType
{
     ...
     *  Identifier. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\AwardingCriterionID $awardingCriterionID
     */
     ...
     *  Text. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\AwardingCriterionDescription[] $awardingCriterionDescription
     */
     ...
     *  Awarding Criterion Response
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\SubordinateAwardingCriterionResponse[] $subordinateAwardingCriterionResponse
     */
     ...
     *  Identifier. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\AwardingCriterionID
     */
     ...
     *  Identifier. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\AwardingCriterionID $awardingCriterionID
     * @return self
     */
    public function setAwardingCriterionID(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\AwardingCriterionID $awardingCriterionID = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\AwardingCriterionDescription $awardingCriterionDescription
     */
    public function addToAwardingCriterionDescription(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\AwardingCriterionDescription $awardingCriterionDescription)
    {
     ...
     *  Text. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\AwardingCriterionDescription[]
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\SubordinateAwardingCriterionResponse $subordinateAwardingCriterionResponse
     */
    public function addToSubordinateAwardingCriterionResponse(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\SubordinateAwardingCriterionResponse $subordinateAwardingCriterionResponse)
    {
     ...
     *  Awarding Criterion Response
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\SubordinateAwardingCriterionResponse[]
     */
