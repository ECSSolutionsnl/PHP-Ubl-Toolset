...
class FinancialAccountType
{
     ...
     *  Name. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\AliasName $aliasName
     */
     ...
     *  Code. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\AccountTypeCode $accountTypeCode
     */
     ...
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\AccountFormatCode $accountFormatCode
     */
     ...
     *  Currency_ Code. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\CurrencyCode $currencyCode
     */
     ...
     *  Text. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\PaymentNote[] $paymentNote
     */
    private $paymentNote = [
     ...
     *  Branch
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\FinancialInstitutionBranch $financialInstitutionBranch
     */
     ...
     *  Name. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\AliasName
     */
     ...
     *  Name. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\AliasName $aliasName
     * @return self
     */
    public function setAliasName(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\AliasName $aliasName = null)
    {
     ...
     *  Code. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\AccountTypeCode
     */
     ...
     *  Code. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\AccountTypeCode $accountTypeCode
     * @return self
     */
    public function setAccountTypeCode(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\AccountTypeCode $accountTypeCode = null)
    {
     ...
     *  ISO20022 Clearing System Identification Code
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\AccountFormatCode
     */
     ...
     *  ISO20022 Clearing System Identification Code
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\AccountFormatCode $accountFormatCode
     * @return self
     */
    public function setAccountFormatCode(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\AccountFormatCode $accountFormatCode = null)
    {
     ...
     *  Currency_ Code. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\CurrencyCode
     */
     ...
     *  Currency_ Code. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\CurrencyCode $currencyCode
     * @return self
     */
    public function setCurrencyCode(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\CurrencyCode $currencyCode = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\PaymentNote $paymentNote
     */
    public function addToPaymentNote(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\PaymentNote $paymentNote)
    {
     ...
     *  Text. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\PaymentNote[]
     */
     ...
     *  Branch
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\FinancialInstitutionBranch
     */
     ...
     *  Branch
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\FinancialInstitutionBranch $financialInstitutionBranch
     * @return self
     */
    public function setFinancialInstitutionBranch(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\FinancialInstitutionBranch $financialInstitutionBranch = null)
    {
