...
class DocumentResponseType
{
     ...
     *  Party
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\RecipientParty $recipientParty
     */
     ...
     *  Line Response
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\LineResponse[] $lineResponse
     */
     ...
     * @return self
     */
    public function setResponse(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\Response $response)
    {
     ...
     *  Party
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\RecipientParty
     */
     ...
     *  Party
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\RecipientParty $recipientParty
     * @return self
     */
    public function setRecipientParty(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\RecipientParty $recipientParty = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\LineResponse $lineResponse
     */
    public function addToLineResponse(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\LineResponse $lineResponse)
    {
     ...
     *  Line Response
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\LineResponse[]
     */
