...
class DespatchLineType
{
     ...
     *  Quantity. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\BackorderQuantity $backorderQuantity
     */
     ...
     *  Text. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\BackorderReason[] $backorderReason
     */
     ...
     *  Quantity. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\OutstandingQuantity $outstandingQuantity
     */
     ...
     *  Text. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\OutstandingReason[] $outstandingReason
     */
    ...
    /**
     * ASBIE
     *  Despatch Line. Sub_ Despatch Line. Despatch Line
     ...
     *  Despatch Line
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\SubDespatchLine[] $subDespatchLine
     */
    private $subDespatchLine = [
     ...
     * @return self
     */
    public function setDeliveredQuantity(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\DeliveredQuantity $deliveredQuantity = null)
    {
     ...
     *  Quantity. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\BackorderQuantity
     */
     ...
     *  Quantity. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\BackorderQuantity $backorderQuantity
     * @return self
     */
    public function setBackorderQuantity(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\BackorderQuantity $backorderQuantity = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\BackorderReason $backorderReason
     */
    public function addToBackorderReason(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\BackorderReason $backorderReason)
    {
     ...
     *  Text. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\BackorderReason[]
     */
     ...
     *  Quantity. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\OutstandingQuantity
     */
     ...
     *  Quantity. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\OutstandingQuantity $outstandingQuantity
     * @return self
     */
    public function setOutstandingQuantity(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\OutstandingQuantity $outstandingQuantity = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\OutstandingReason $outstandingReason
     */
    public function addToOutstandingReason(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\OutstandingReason $outstandingReason)
    {
     ...
     *  Text. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\OutstandingReason[]
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\SubDespatchLine $subDespatchLine
     */
    public function addToSubDespatchLine(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\SubDespatchLine $subDespatchLine)
    {
        $this->subDespatchLine[] = $subDespatchLine;
        return $this;
    }

    /**
     * isset subDespatchLine
     *
     * ASBIE
     *  Despatch Line. Sub_ Despatch Line. Despatch Line
     *  A despatch line subsidiary to this despatch line.
     ...
     * @return bool
     */
    public function issetSubDespatchLine($index)
    {
        return isset($this->subDespatchLine[$index]);
    }

    /**
     * unset subDespatchLine
     *
     * ASBIE
     *  Despatch Line. Sub_ Despatch Line. Despatch Line
     *  A despatch line subsidiary to this despatch line.
     ...
     * @return void
     */
    public function unsetSubDespatchLine($index)
    {
        unset($this->subDespatchLine[$index]);
    }

    /**
     * Gets as subDespatchLine
     *
     * ASBIE
     *  Despatch Line. Sub_ Despatch Line. Despatch Line
     *  A despatch line subsidiary to this despatch line.
     ...
     *  Despatch Line
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\SubDespatchLine[]
     */
    public function getSubDespatchLine()
    {
        return $this->subDespatchLine;
    }

    /**
     * Sets a new subDespatchLine
     *
     * ASBIE
     *  Despatch Line. Sub_ Despatch Line. Despatch Line
     *  A despatch line subsidiary to this despatch line.
     ...
     * @return self
     */
    public function setSubDespatchLine(?array $subDespatchLine = null)
    {
        $this->subDespatchLine = $subDespatchLine;
        return $this;
    }
