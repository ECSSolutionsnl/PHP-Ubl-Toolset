...
class EndorsementType
{
     ...
     *  Identifier. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\DocumentID $documentID
     */
     ...
     *  Authentication Code
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\ApprovalStatus $approvalStatus
     */
     ...
     *  Identifier. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\DocumentID
     */
     ...
     *  Identifier. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\DocumentID $documentID
     * @return self
     */
    public function setDocumentID(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\DocumentID $documentID)
    {
     ...
     *  Authentication Code
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\ApprovalStatus
     */
     ...
     *  Authentication Code
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\ApprovalStatus $approvalStatus
     * @return self
     */
    public function setApprovalStatus(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\ApprovalStatus $approvalStatus)
    {
     ...
     * @return self
     */
    public function setEndorserParty(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\EndorserParty $endorserParty)
    {
