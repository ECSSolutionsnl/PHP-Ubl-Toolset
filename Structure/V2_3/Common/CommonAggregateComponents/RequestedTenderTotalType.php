...
class RequestedTenderTotalType
{
     ...
     *  Amount. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\EstimatedOverallContractAmount $estimatedOverallContractAmount
     */
    private $estimatedOverallContractAmount = null;

    /**
     * BBIE
     *  Requested Tender Total. Estimated_ Overall Framework Contracts. Amount
     *  The estimated overall monetary amount of subsequent framework contracts.
     *  0..1
     *  Requested Tender Total
     *  Estimated
     *  Overall Framework Contracts
     *  Amount
     *  Amount. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\EstimatedOverallFrameworkContractsAmount $estimatedOverallFrameworkContractsAmount
     */
    private $estimatedOverallFrameworkContractsAmount = null;
     ...
     *  Amount. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\TotalAmount $totalAmount
     */
     ...
     *  Text. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\MonetaryScope[] $monetaryScope
     */
     ...
     *  Amount. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\AverageSubsequentContractAmount $averageSubsequentContractAmount
     */
     ...
     *  Tax Category
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ApplicableTaxCategory[] $applicableTaxCategory
     */
     ...
     *  Amount. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\EstimatedOverallContractAmount
     */
     ...
     *  Amount. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\EstimatedOverallContractAmount $estimatedOverallContractAmount
     * @return self
     */
    public function setEstimatedOverallContractAmount(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\EstimatedOverallContractAmount $estimatedOverallContractAmount = null)
    {
    ...
    /**
     * Gets as estimatedOverallFrameworkContractsAmount
     *
     * BBIE
     *  Requested Tender Total. Estimated_ Overall Framework Contracts. Amount
     *  The estimated overall monetary amount of subsequent framework contracts.
     ...
     *  Amount. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\EstimatedOverallFrameworkContractsAmount
     */
    public function getEstimatedOverallFrameworkContractsAmount()
    {
        return $this->estimatedOverallFrameworkContractsAmount;
    }

    /**
     * Sets a new estimatedOverallFrameworkContractsAmount
     *
     * BBIE
     *  Requested Tender Total. Estimated_ Overall Framework Contracts. Amount
     *  The estimated overall monetary amount of subsequent framework contracts.
     ...
     *  Amount. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\EstimatedOverallFrameworkContractsAmount $estimatedOverallFrameworkContractsAmount
     * @return self
     */
    public function setEstimatedOverallFrameworkContractsAmount(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\EstimatedOverallFrameworkContractsAmount $estimatedOverallFrameworkContractsAmount = null)
    {
     ...
     *  Amount. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\TotalAmount
     */
     ...
     *  Amount. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\TotalAmount $totalAmount
     * @return self
     */
    public function setTotalAmount(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\TotalAmount $totalAmount = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\MonetaryScope $monetaryScope
     */
    public function addToMonetaryScope(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\MonetaryScope $monetaryScope)
    {
     ...
     *  Text. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\MonetaryScope[]
     */
     ...
     *  Amount. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\AverageSubsequentContractAmount
     */
     ...
     *  Amount. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\AverageSubsequentContractAmount $averageSubsequentContractAmount
     * @return self
     */
    public function setAverageSubsequentContractAmount(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\AverageSubsequentContractAmount $averageSubsequentContractAmount = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ApplicableTaxCategory $applicableTaxCategory
     */
    public function addToApplicableTaxCategory(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ApplicableTaxCategory $applicableTaxCategory)
    {
     ...
     *  Tax Category
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ApplicableTaxCategory[]
     */
