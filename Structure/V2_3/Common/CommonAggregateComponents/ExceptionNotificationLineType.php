...
class ExceptionNotificationLineType
{
     ...
     *  Code. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\ResolutionCode $resolutionCode
     */
     ...
     *  Measure. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\ComparedValueMeasure $comparedValueMeasure
     */
     ...
     *  Measure. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\SourceValueMeasure $sourceValueMeasure
     */
     ...
     *  Quantity. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\VarianceQuantity $varianceQuantity
     */
     ...
     *  Forecast Exception
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ForecastException $forecastException
     */
     ...
     *  Code. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\ResolutionCode
     */
     ...
     *  Code. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\ResolutionCode $resolutionCode
     * @return self
     */
    public function setResolutionCode(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\ResolutionCode $resolutionCode = null)
    {
     ...
     *  Measure. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\ComparedValueMeasure
     */
     ...
     *  Measure. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\ComparedValueMeasure $comparedValueMeasure
     * @return self
     */
    public function setComparedValueMeasure(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\ComparedValueMeasure $comparedValueMeasure)
    {
     ...
     *  Measure. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\SourceValueMeasure
     */
     ...
     *  Measure. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\SourceValueMeasure $sourceValueMeasure
     * @return self
     */
    public function setSourceValueMeasure(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\SourceValueMeasure $sourceValueMeasure)
    {
     ...
     *  Quantity. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\VarianceQuantity
     */
     ...
     *  Quantity. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\VarianceQuantity $varianceQuantity
     * @return self
     */
    public function setVarianceQuantity(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\VarianceQuantity $varianceQuantity = null)
    {
     ...
     * @return self
     */
    public function setExceptionObservationPeriod(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ExceptionObservationPeriod $exceptionObservationPeriod = null)
    {
     ...
     *  Forecast Exception
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ForecastException
     */
     ...
     *  Forecast Exception
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ForecastException $forecastException
     * @return self
     */
    public function setForecastException(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ForecastException $forecastException = null)
    {
