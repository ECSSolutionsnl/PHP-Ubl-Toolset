...
class QualifyingPartyType
{
     ...
     *  Percent. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\ParticipationPercent $participationPercent
     */
     ...
     *  Text. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\PersonalSituation[] $personalSituation
     */
     ...
     *  Quantity. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\OperatingYearsQuantity $operatingYearsQuantity
     */
     ...
     *  Quantity. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\EmployeeQuantity $employeeQuantity
     */
     ...
     *  Identifier. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\BusinessClassificationEvidenceID $businessClassificationEvidenceID
     */
     ...
     *  Identifier. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\BusinessIdentityEvidenceID $businessIdentityEvidenceID
     */
     ...
     *  Code. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\TendererRoleCode $tendererRoleCode
     */
     ...
     *  Classification Scheme
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\BusinessClassificationScheme $businessClassificationScheme
     */
     ...
     *  Capability
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\TechnicalCapability[] $technicalCapability
     */
     ...
     *  Capability
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\FinancialCapability[] $financialCapability
     */
     ...
     *  Completed Task
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\CompletedTask[] $completedTask
     */
     ...
     *  Declaration
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\Declaration[] $declaration
     */
    private $declaration = [
     ...
     *  Percent. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\ParticipationPercent
     */
     ...
     *  Percent. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\ParticipationPercent $participationPercent
     * @return self
     */
    public function setParticipationPercent(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\ParticipationPercent $participationPercent = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\PersonalSituation $personalSituation
     */
    public function addToPersonalSituation(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\PersonalSituation $personalSituation)
    {
     ...
     *  Text. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\PersonalSituation[]
     */
     ...
     *  Quantity. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\OperatingYearsQuantity
     */
     ...
     *  Quantity. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\OperatingYearsQuantity $operatingYearsQuantity
     * @return self
     */
    public function setOperatingYearsQuantity(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\OperatingYearsQuantity $operatingYearsQuantity = null)
    {
     ...
     *  Quantity. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\EmployeeQuantity
     */
     ...
     *  Quantity. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\EmployeeQuantity $employeeQuantity
     * @return self
     */
    public function setEmployeeQuantity(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\EmployeeQuantity $employeeQuantity = null)
    {
     ...
     *  Identifier. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\BusinessClassificationEvidenceID
     */
     ...
     *  Identifier. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\BusinessClassificationEvidenceID $businessClassificationEvidenceID
     * @return self
     */
    public function setBusinessClassificationEvidenceID(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\BusinessClassificationEvidenceID $businessClassificationEvidenceID = null)
    {
     ...
     *  Identifier. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\BusinessIdentityEvidenceID
     */
     ...
     *  Identifier. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\BusinessIdentityEvidenceID $businessIdentityEvidenceID
     * @return self
     */
    public function setBusinessIdentityEvidenceID(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\BusinessIdentityEvidenceID $businessIdentityEvidenceID = null)
    {
     ...
     *  Code. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\TendererRoleCode
     */
     ...
     *  Code. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\TendererRoleCode $tendererRoleCode
     * @return self
     */
    public function setTendererRoleCode(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\TendererRoleCode $tendererRoleCode = null)
    {
     ...
     *  Classification Scheme
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\BusinessClassificationScheme
     */
     ...
     *  Classification Scheme
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\BusinessClassificationScheme $businessClassificationScheme
     * @return self
     */
    public function setBusinessClassificationScheme(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\BusinessClassificationScheme $businessClassificationScheme = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\TechnicalCapability $technicalCapability
     */
    public function addToTechnicalCapability(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\TechnicalCapability $technicalCapability)
    {
     ...
     *  Capability
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\TechnicalCapability[]
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\FinancialCapability $financialCapability
     */
    public function addToFinancialCapability(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\FinancialCapability $financialCapability)
    {
     ...
     *  Capability
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\FinancialCapability[]
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\CompletedTask $completedTask
     */
    public function addToCompletedTask(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\CompletedTask $completedTask)
    {
     ...
     *  Completed Task
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\CompletedTask[]
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\Declaration $declaration
     */
    public function addToDeclaration(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\Declaration $declaration)
    {
     ...
     *  Declaration
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\Declaration[]
     */
