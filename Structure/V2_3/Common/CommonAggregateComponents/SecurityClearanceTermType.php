...
/**
 * Class representing SecurityClearanceTermType
 *
 * ABIE
 *  Security Clearance Term. Details
 *  A class to specify security clearance terms.
 *  Security Clearance Term
 * XSD Type: SecurityClearanceTermType
 */
class SecurityClearanceTermType
{
    /**
     ...
     *  Code. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\Code $code
     */
    private $code = null;

    /**
     * BBIE
     *  Security Clearance Term. Description. Text
     ...
     *  Code. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\Code
     */
     ...
     *  Code. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\Code $code
     * @return self
     */
    public function setCode(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\Code $code = null)
    {
        $this->code = $code;
        return $this;
    }
