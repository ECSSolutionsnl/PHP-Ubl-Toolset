...
class HazardousGoodsTransitType
{
     ...
     *  TREM card
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\TransportEmergencyCardCode $transportEmergencyCardCode
     */
     ...
     *  Packing Group
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\PackingCriteriaCode $packingCriteriaCode
     */
     ...
     *  Code. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\HazardousRegulationCode $hazardousRegulationCode
     */
     ...
     *  Code. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\InhalationToxicityZoneCode $inhalationToxicityZoneCode
     */
     ...
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\TransportAuthorizationCode $transportAuthorizationCode
     */
    private $transportAuthorizationCode = null;

    /**
     * BBIE
     *  Hazardous Goods Transit. Transit Description. Text
     ...
     *  Munic via A7
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\TransitDescription[] $transitDescription
     */
    private $transitDescription = [
     ...
     *  TREM card
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\TransportEmergencyCardCode
     */
     ...
     *  TREM card
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\TransportEmergencyCardCode $transportEmergencyCardCode
     * @return self
     */
    public function setTransportEmergencyCardCode(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\TransportEmergencyCardCode $transportEmergencyCardCode = null)
    {
     ...
     *  Packing Group
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\PackingCriteriaCode
     */
     ...
     *  Packing Group
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\PackingCriteriaCode $packingCriteriaCode
     * @return self
     */
    public function setPackingCriteriaCode(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\PackingCriteriaCode $packingCriteriaCode = null)
    {
     ...
     *  Code. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\HazardousRegulationCode
     */
     ...
     *  Code. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\HazardousRegulationCode $hazardousRegulationCode
     * @return self
     */
    public function setHazardousRegulationCode(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\HazardousRegulationCode $hazardousRegulationCode = null)
    {
     ...
     *  Code. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\InhalationToxicityZoneCode
     */
     ...
     *  Code. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\InhalationToxicityZoneCode $inhalationToxicityZoneCode
     * @return self
     */
    public function setInhalationToxicityZoneCode(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\InhalationToxicityZoneCode $inhalationToxicityZoneCode = null)
    {
     ...
     *  Permission for Transport
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\TransportAuthorizationCode
     */
     ...
     *  Permission for Transport
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\TransportAuthorizationCode $transportAuthorizationCode
     * @return self
     */
    public function setTransportAuthorizationCode(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\TransportAuthorizationCode $transportAuthorizationCode = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\TransitDescription $transitDescription
     */
    public function addToTransitDescription(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\TransitDescription $transitDescription)
    {
     ...
     * @return bool
     */
    public function issetTransitDescription($index)
    {
        return isset($this->transitDescription[$index]);
    }

    /**
     * unset transitDescription
     *
     * BBIE
     *  Hazardous Goods Transit. Transit Description. Text
     *  A textual description of this hazardous goods transit.
     ...
     * @return void
     */
    public function unsetTransitDescription($index)
    {
        unset($this->transitDescription[$index]);
    }

    /**
     * Gets as transitDescription
     *
     * BBIE
     *  Hazardous Goods Transit. Transit Description. Text
     *  A textual description of this hazardous goods transit.
     ...
     *  Munic via A7
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\TransitDescription[]
     */
    public function getTransitDescription()
    {
        return $this->transitDescription;
    }

    /**
     * Sets a new transitDescription
     *
     * BBIE
     *  Hazardous Goods Transit. Transit Description. Text
     *  A textual description of this hazardous goods transit.
     ...
     * @return self
     */
    public function setTransitDescription(?array $transitDescription = null)
    {
        $this->transitDescription = $transitDescription;
        return $this;
    }
