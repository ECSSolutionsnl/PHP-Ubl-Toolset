...
class ShipmentType
{
     ...
     *  Shipment Stage
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ShipmentStage[] $shipmentStage
     */
     ...
     *  Address
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ReturnAddress $returnAddress
     */
     ...
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ExportCountry $exportCountry
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ShipmentStage $shipmentStage
     */
    public function addToShipmentStage(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ShipmentStage $shipmentStage)
    {
     ...
     *  Shipment Stage
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ShipmentStage[]
     */
     ...
     *  Address
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ReturnAddress
     */
     ...
     *  Address
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ReturnAddress $returnAddress
     * @return self
     */
    public function setReturnAddress(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ReturnAddress $returnAddress = null)
    {
     ...
     *  Country of exportation (WCO ID 062)
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ExportCountry
     */
     ...
     *  Country of exportation (WCO ID 062)
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ExportCountry $exportCountry
     * @return self
     */
    public function setExportCountry(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ExportCountry $exportCountry = null)
    {
