...
class TransportEventType
{
     ...
     *  Identifier. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\IdentificationID $identificationID
     */
     ...
     *  Code. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\TransportEventTypeCode $transportEventTypeCode
     */
     ...
     *  Shipment
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ReportedShipment $reportedShipment
     */
     ...
     *  Status
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\CurrentStatus[] $currentStatus
     */
     ...
     *  Identifier. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\IdentificationID
     */
     ...
     *  Identifier. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\IdentificationID $identificationID
     * @return self
     */
    public function setIdentificationID(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\IdentificationID $identificationID = null)
    {
     ...
     *  Code. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\TransportEventTypeCode
     */
     ...
     *  Code. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\TransportEventTypeCode $transportEventTypeCode
     * @return self
     */
    public function setTransportEventTypeCode(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\TransportEventTypeCode $transportEventTypeCode = null)
    {
     ...
     *  Shipment
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ReportedShipment
     */
     ...
     *  Shipment
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ReportedShipment $reportedShipment
     * @return self
     */
    public function setReportedShipment(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ReportedShipment $reportedShipment = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\CurrentStatus $currentStatus
     */
    public function addToCurrentStatus(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\CurrentStatus $currentStatus)
    {
     ...
     *  Status
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\CurrentStatus[]
     */
     ...
     */
    public function addToContact(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\Contact $contact)
    {
     ...
     * @return self
     */
    public function setSignature(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\Signature $signature = null)
    {
     ...
     */
    public function addToPeriod(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\Period $period)
    {
        $this->period[] = $period;
        return $this;
    }
