...
namespace ECSSolutions\UblToolset\Structure\V2_3\Maindoc\DespatchAdvice;
...
class DespatchAdviceType
{
     ...
     *  Code. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\DespatchAdviceTypeCode $despatchAdviceTypeCode
     */
     ...
     *  Despatch Line
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\DespatchLine[] $despatchLine
     */
     ...
     *  Code. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\DespatchAdviceTypeCode
     */
     ...
     *  Code. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\DespatchAdviceTypeCode $despatchAdviceTypeCode
     * @return self
     */
    public function setDespatchAdviceTypeCode(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\DespatchAdviceTypeCode $despatchAdviceTypeCode = null)
    {
     ...
     * @return self
     */
    public function setDespatchSupplierParty(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\DespatchSupplierParty $despatchSupplierParty)
    {
     ...
     * @return self
     */
    public function setDeliveryCustomerParty(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\DeliveryCustomerParty $deliveryCustomerParty)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\DespatchLine $despatchLine
     */
    public function addToDespatchLine(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\DespatchLine $despatchLine)
    {
     ...
     *  Despatch Line
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\DespatchLine[]
     */
