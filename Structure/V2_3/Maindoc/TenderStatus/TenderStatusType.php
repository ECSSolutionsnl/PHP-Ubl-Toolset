...
namespace ECSSolutions\UblToolset\Structure\V2_3\Maindoc\TenderStatus;

/**
 * Class representing TenderStatusType
 *
 * ABIE
 ...
 *  Tender Status
 * XSD Type: TenderStatusType
 */
class TenderStatusType
{
    /**
    ...
    /**
     * BBIE
     *  Tender Status. UBL Version Identifier. Identifier
    ...
    /**
     * BBIE
     *  Tender Status. Customization Identifier. Identifier
    ...
    /**
     * BBIE
     *  Tender Status. Profile Identifier. Identifier
    ...
    /**
     * BBIE
     *  Tender Status. Profile Execution Identifier. Identifier
    ...
    /**
     * BBIE
     *  Tender Status. Copy_ Indicator. Indicator
    ...
    /**
     * BBIE
     *  Tender Status. Contract Folder Identifier. Identifier
    ...
    /**
     * BBIE
     *  Tender Status. Contract Name. Name
    ...
    /**
     * BBIE
     *  Tender Status. Procedure Code. Code
    ...
    /**
     * ASBIE
     *  Tender Status. Tender Submission Deadline_ Period. Period
    ...
    /**
     * ASBIE
     *  Tender Status. Invitation Submission_ Period. Period
    ...
    /**
     * ASBIE
     *  Tender Status. Participation Request Reception_ Period. Period
    ...
    /**
     * ASBIE
     *  Tender Status. Procurement Legislation_ Document Reference. Document Reference
    ...
    /**
     * ASBIE
     *  Tender Status. Fiscal Legislation_ Document Reference. Document Reference
    ...
    /**
     * ASBIE
     *  Tender Status. Environmental Legislation_ Document Reference. Document Reference
    ...
    /**
     * ASBIE
     *  Tender Status. Employment Legislation_ Document Reference. Document Reference
    ...
    /**
     * ASBIE
     *  Tender Status. Tender Status Inquiry_ Document Reference. Document Reference
     ...
     *  Document Reference
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\TenderStatusInquiryDocumentReference[] $tenderStatusInquiryDocumentReference
     */
    private $tenderStatusInquiryDocumentReference = [
        
    ];

    /**
     * ASBIE
     *  Tender Status. Signature
    ...
    /**
     * ASBIE
     *  Tender Status. Contracting Party
    ...
    /**
     * ASBIE
     *  Tender Status. Economic Operator Party
    ...
    /**
     * ASBIE
     *  Tender Status. Document Provider_ Party. Party
    ...
    /**
     * ASBIE
     *  Tender Status. Tender Recipient_ Party. Party
    ...
    /**
     * ASBIE
     *  Tender Status. Procurement Project
    ...
    /**
     * ASBIE
     *  Tender Status. Procurement Project Lot
     ...
     * @return self
     */
    public function setProcurementLegislationDocumentReference(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ProcurementLegislationDocumentReference $procurementLegislationDocumentReference = null)
    {
     ...
     * @return self
     */
    public function setFiscalLegislationDocumentReference(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\FiscalLegislationDocumentReference $fiscalLegislationDocumentReference = null)
    {
     ...
     * @return self
     */
    public function setEnvironmentalLegislationDocumentReference(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\EnvironmentalLegislationDocumentReference $environmentalLegislationDocumentReference = null)
    {
     ...
     * @return self
     */
    public function setEmploymentLegislationDocumentReference(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\EmploymentLegislationDocumentReference $employmentLegislationDocumentReference = null)
    {
    ...
    /**
     * Adds as tenderStatusInquiryDocumentReference
     *
     * ASBIE
     *  Tender Status. Tender Status Inquiry_ Document Reference. Document Reference
     *  A reference to a received Tender status inquiry.
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\TenderStatusInquiryDocumentReference $tenderStatusInquiryDocumentReference
     */
    public function addToTenderStatusInquiryDocumentReference(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\TenderStatusInquiryDocumentReference $tenderStatusInquiryDocumentReference)
    {
        $this->tenderStatusInquiryDocumentReference[] = $tenderStatusInquiryDocumentReference;
        return $this;
    }

    /**
     * isset tenderStatusInquiryDocumentReference
     *
     * ASBIE
     *  Tender Status. Tender Status Inquiry_ Document Reference. Document Reference
     *  A reference to a received Tender status inquiry.
     ...
     * @return bool
     */
    public function issetTenderStatusInquiryDocumentReference($index)
    {
        return isset($this->tenderStatusInquiryDocumentReference[$index]);
    }

    /**
     * unset tenderStatusInquiryDocumentReference
     *
     * ASBIE
     *  Tender Status. Tender Status Inquiry_ Document Reference. Document Reference
     *  A reference to a received Tender status inquiry.
     ...
     * @return void
     */
    public function unsetTenderStatusInquiryDocumentReference($index)
    {
        unset($this->tenderStatusInquiryDocumentReference[$index]);
    }

    /**
     * Gets as tenderStatusInquiryDocumentReference
     *
     * ASBIE
     *  Tender Status. Tender Status Inquiry_ Document Reference. Document Reference
     *  A reference to a received Tender status inquiry.
     ...
     *  Document Reference
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\TenderStatusInquiryDocumentReference[]
     */
    public function getTenderStatusInquiryDocumentReference()
    {
        return $this->tenderStatusInquiryDocumentReference;
    }

    /**
     * Sets a new tenderStatusInquiryDocumentReference
     *
     * ASBIE
     *  Tender Status. Tender Status Inquiry_ Document Reference. Document Reference
     *  A reference to a received Tender status inquiry.
     ...
     * @return self
     */
    public function setTenderStatusInquiryDocumentReference(?array $tenderStatusInquiryDocumentReference = null)
    {
        $this->tenderStatusInquiryDocumentReference = $tenderStatusInquiryDocumentReference;
        return $this;
    }
