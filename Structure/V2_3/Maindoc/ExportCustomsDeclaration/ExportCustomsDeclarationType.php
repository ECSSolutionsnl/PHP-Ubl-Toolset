...
namespace ECSSolutions\UblToolset\Structure\V2_3\Maindoc\ExportCustomsDeclaration;

/**
 * Class representing ExportCustomsDeclarationType
 *
 * ABIE
 *  Export Customs Declaration. Details
 *  A customs declaration document for exporting goods
 *  Export Customs Declaration
 * XSD Type: ExportCustomsDeclarationType
 */
class ExportCustomsDeclarationType
{
    /**
    ...
    /**
     * BBIE
     *  Export Customs Declaration. UBL Version Identifier. Identifier
    ...
    /**
     * BBIE
     *  Export Customs Declaration. Customization Identifier. Identifier
    ...
    /**
     * BBIE
     *  Export Customs Declaration. Profile Identifier. Identifier
    ...
    /**
     * BBIE
     *  Export Customs Declaration. Profile Execution Identifier. Identifier
    ...
    /**
     * BBIE
     *  Export Customs Declaration. Identifier
    ...
    /**
     * BBIE
     *  Export Customs Declaration. UUID. Identifier
    ...
    /**
     * BBIE
     *  Export Customs Declaration. Issue Date. Date
    ...
    /**
     * BBIE
     *  Export Customs Declaration. Issue Time. Time
    ...
    /**
     * BBIE
     *  Export Customs Declaration. Export_ Type Code. Code
     ...
     *  Code. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\ExportTypeCode $exportTypeCode
     */
    private $exportTypeCode = null;

    /**
     * BBIE
     *  Export Customs Declaration. Export_ Reason Code. Code
    ...
    /**
     * BBIE
     *  Export Customs Declaration. Note. Text
    ...
    /**
     * BBIE
     *  Export Customs Declaration. Version. Identifier
    ...
    /**
     * ASBIE
     *  Export Customs Declaration. Exporter_ Party. Party
    ...
    /**
     * ASBIE
     *  Export Customs Declaration. Signature
     ...
     *  Code. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\ExportTypeCode
     */
    public function getExportTypeCode()
    {
        return $this->exportTypeCode;
    }

    /**
     * Sets a new exportTypeCode
     *
     * BBIE
     *  Export Customs Declaration. Export_ Type Code. Code
     *  A code specifying the type of export
     ...
     *  Code. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\ExportTypeCode $exportTypeCode
     * @return self
     */
    public function setExportTypeCode(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\ExportTypeCode $exportTypeCode = null)
    {
     ...
     * @return self
     */
    public function setExporterParty(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ExporterParty $exporterParty)
    {
     ...
     * @return self
     */
    public function setCustomsDeclaration(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\CustomsDeclaration $customsDeclaration)
    {
