...
namespace ECSSolutions\UblToolset\Structure\V2_3\Maindoc\AwardedNotification;

/**
 * Class representing AwardedNotificationType
 *
 * ABIE
 *  Awarded Notification. Details
 *  The document used to communicate a contract award to the winner.
 *  Awarded Notification
 * XSD Type: AwardedNotificationType
 */
class AwardedNotificationType
{
    ...
    /**
     * BBIE
     *  Awarded Notification. UBL Version Identifier. Identifier
    ...
    /**
     * BBIE
     *  Awarded Notification. Customization Identifier. Identifier
    ...
    /**
     * BBIE
     *  Awarded Notification. Profile Identifier. Identifier
    ...
    /**
     * BBIE
     *  Awarded Notification. Profile Execution Identifier. Identifier
    ...
    /**
     * BBIE
     *  Awarded Notification. Identifier
    ...
    /**
     * BBIE
     *  Awarded Notification. UUID. Identifier
    ...
    /**
     * BBIE
     *  Awarded Notification. Contract Folder Identifier. Identifier
    ...
    /**
     * BBIE
     *  Awarded Notification. Issue Date. Date
    ...
    /**
     * BBIE
     *  Awarded Notification. Issue Time. Time
    ...
    /**
     * BBIE
     *  Awarded Notification. Contract Name. Name
    ...
    /**
     * BBIE
     *  Awarded Notification. Note. Text
    ...
    /**
     * ASBIE
     *  Awarded Notification. Sender_ Party. Party
    ...
    /**
     * ASBIE
     *  Awarded Notification. Receiver_ Party. Party
    ...
    /**
     * ASBIE
     *  Awarded Notification. Minutes_ Document Reference. Document Reference
     ...
     *  Document Reference
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\MinutesDocumentReference $minutesDocumentReference
     */
    private $minutesDocumentReference = null;

    /**
     * ASBIE
     *  Awarded Notification. Additional_ Document Reference. Document Reference
    ...
    /**
     * ASBIE
     *  Awarded Notification. Tender Result
    ...
    /**
     * ASBIE
     *  Awarded Notification. Final_ Financial Guarantee. Financial Guarantee
     ...
     *  Financial Guarantee
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\FinalFinancialGuarantee[] $finalFinancialGuarantee
     */
    private $finalFinancialGuarantee = [
        
    ];

    /**
     * ASBIE
     *  Awarded Notification. Signature
     ...
     *  Document Reference
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\MinutesDocumentReference
     */
     ...
     *  Document Reference
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\MinutesDocumentReference $minutesDocumentReference
     * @return self
     */
    public function setMinutesDocumentReference(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\MinutesDocumentReference $minutesDocumentReference = null)
    {
    ...
    /**
     * Adds as finalFinancialGuarantee
     *
     * ASBIE
     *  Awarded Notification. Final_ Financial Guarantee. Financial Guarantee
     *  A bond guarantee by the submitter of a tender or bid, required of the tender winner.
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\FinalFinancialGuarantee $finalFinancialGuarantee
     */
    public function addToFinalFinancialGuarantee(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\FinalFinancialGuarantee $finalFinancialGuarantee)
    {
     ...
     * @return bool
     */
    public function issetFinalFinancialGuarantee($index)
    {
        return isset($this->finalFinancialGuarantee[$index]);
    }

    /**
     * unset finalFinancialGuarantee
     *
     * ASBIE
     *  Awarded Notification. Final_ Financial Guarantee. Financial Guarantee
     *  A bond guarantee by the submitter of a tender or bid, required of the tender winner.
     ...
     * @return void
     */
    public function unsetFinalFinancialGuarantee($index)
    {
        unset($this->finalFinancialGuarantee[$index]);
    }

    /**
     * Gets as finalFinancialGuarantee
     *
     * ASBIE
     *  Awarded Notification. Final_ Financial Guarantee. Financial Guarantee
     *  A bond guarantee by the submitter of a tender or bid, required of the tender winner.
     ...
     *  Financial Guarantee
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\FinalFinancialGuarantee[]
     */
    public function getFinalFinancialGuarantee()
    {
        return $this->finalFinancialGuarantee;
    }

    /**
     * Sets a new finalFinancialGuarantee
     *
     * ASBIE
     *  Awarded Notification. Final_ Financial Guarantee. Financial Guarantee
     *  A bond guarantee by the submitter of a tender or bid, required of the tender winner.
     ...
     * @return self
     */
    public function setFinalFinancialGuarantee(?array $finalFinancialGuarantee = null)
    {
        $this->finalFinancialGuarantee = $finalFinancialGuarantee;
        return $this;
    }
