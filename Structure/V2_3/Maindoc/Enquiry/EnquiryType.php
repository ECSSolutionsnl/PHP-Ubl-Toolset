...
namespace ECSSolutions\UblToolset\Structure\V2_3\Maindoc\Enquiry;
...
class EnquiryType
{
     ...
     *  Date. Type
     *
     * @var \DateTime $latestReplyDate
     */
    private $latestReplyDate = null;
     ...
     *  Time. Type
     *
     * @var \DateTime $latestReplyTime
     */
    private $latestReplyTime = null;
    ...
    /**
     * ASBIE
     *  Enquiry. Requestor_ Party. Party
    ...
    /**
     * ASBIE
     *  Enquiry. Responder_ Party. Party
     ...
     * @return \DateTime
     */
    public function getLatestReplyDate()
    {
        return $this->latestReplyDate;
    }

    /**
     * Sets a new latestReplyDate
     *
     * BBIE
     *  Enquiry. Latest_ Reply Date. Date
     *  The date, assigned by the requestor, by which this enquiry shall be replied.
     ...
     *  Date. Type
     *
     * @param \DateTime $latestReplyDate
     * @return self
     */
    public function setLatestReplyDate(?\DateTime $latestReplyDate = null)
    {
     ...
     *  Time. Type
     *
     * @param \DateTime $latestReplyTime
     * @return self
     */
    public function setLatestReplyTime(?\DateTime $latestReplyTime = null)
    {
