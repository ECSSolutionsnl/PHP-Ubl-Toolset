...
namespace ECSSolutions\UblToolset\Structure\V2_3\Maindoc\TendererQualification;
...
class TendererQualificationType
{
     ...
     *  Tenderer Party Qualification
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\TendererPartyQualification[] $tendererPartyQualification
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\TendererPartyQualification $tendererPartyQualification
     */
    public function addToTendererPartyQualification(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\TendererPartyQualification $tendererPartyQualification)
    {
     ...
     *  Tenderer Party Qualification
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\TendererPartyQualification[]
     */
     ...
     * @return self
     */
    public function setContractingParty(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ContractingParty $contractingParty = null)
    {
