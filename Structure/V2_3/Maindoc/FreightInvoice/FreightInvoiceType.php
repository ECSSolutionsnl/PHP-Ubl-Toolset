...
namespace ECSSolutions\UblToolset\Structure\V2_3\Maindoc\FreightInvoice;

/**
 * Class representing FreightInvoiceType
 *
 * ABIE
 *  Freight Invoice. Details
 *  A document stating the charges incurred for a logistics service.
 *  Freight Invoice
 * XSD Type: FreightInvoiceType
 */
class FreightInvoiceType
{
    ...
    /**
     * BBIE
     *  Freight Invoice. UBL Version Identifier. Identifier
    ...
    /**
     * BBIE
     *  Freight Invoice. Customization Identifier. Identifier
    ...
    /**
     * BBIE
     *  Freight Invoice. Profile Identifier. Identifier
    ...
    /**
     * BBIE
     *  Freight Invoice. Profile Execution Identifier. Identifier
    ...
    /**
     * BBIE
     *  Freight Invoice. UUID. Identifier
    ...
    /**
     * BBIE
     *  Freight Invoice. Issue Date. Date
    ...
    /**
     * BBIE
     *  Freight Invoice. Issue Time. Time
    ...
    /**
     * BBIE
     *  Freight Invoice. Invoice Type Code. Code
    ...
    /**
     * BBIE
     *  Freight Invoice. Tax Point Date. Date
    ...
    /**
     * BBIE
     *  Freight Invoice. Tax_ Currency Code. Code
    ...
    /**
     * BBIE
     *  Freight Invoice. Pricing_ Currency Code. Code
    ...
    /**
     * BBIE
     *  Freight Invoice. Payment_ Currency Code. Code
    ...
    /**
     * BBIE
     *  Freight Invoice. Payment Alternative_ Currency Code. Code
    ...
    /**
     * BBIE
     *  Freight Invoice. Accounting Cost Code. Code
    ...
    /**
     * BBIE
     *  Freight Invoice. Line Count. Numeric
    ...
    /**
     * ASBIE
     *  Freight Invoice. Invoice_ Period. Period
    ...
    /**
     * ASBIE
     *  Freight Invoice. Order Reference
    ...
    /**
     * ASBIE
     *  Freight Invoice. Billing Reference
    ...
    /**
     * ASBIE
     *  Freight Invoice. Despatch_ Document Reference. Document Reference
    ...
    /**
     * ASBIE
     *  Freight Invoice. Receipt_ Document Reference. Document Reference
    ...
    /**
     * ASBIE
     *  Freight Invoice. Originator_ Document Reference. Document Reference
    ...
    /**
     * ASBIE
     *  Freight Invoice. Contract_ Document Reference. Document Reference
    ...
    /**
     * ASBIE
     *  Freight Invoice. Additional_ Document Reference. Document Reference
    ...
    /**
     * ASBIE
     *  Freight Invoice. Project Reference
    ...
    /**
     * ASBIE
     *  Freight Invoice. Accounting_ Supplier Party. Supplier Party
    ...
    /**
     * ASBIE
     *  Freight Invoice. Accounting_ Customer Party. Customer Party
    ...
    /**
     * ASBIE
     *  Freight Invoice. Payee_ Party. Party
     *  The payee.
     *  0..1
     *  Freight Invoice
     *  Payee
    ...
    /**
     * ASBIE
     *  Freight Invoice. Tax Representative_ Party. Party
    ...
    /**
     * ASBIE
     *  Freight Invoice. Prepaid_ Payment. Payment
     *  A prepaid payment.
     *  0..n
     *  Freight Invoice
     *  Prepaid
    ...
    /**
     * ASBIE
     *  Freight Invoice. Allowance Charge
    ...
    /**
     * ASBIE
     *  Freight Invoice. Tax_ Exchange Rate. Exchange Rate
    ...
    /**
     * ASBIE
     *  Freight Invoice. Pricing_ Exchange Rate. Exchange Rate
    ...
    /**
     * ASBIE
     *  Freight Invoice. Payment_ Exchange Rate. Exchange Rate
    ...
    /**
     * ASBIE
     *  Freight Invoice. Payment Alternative_ Exchange Rate. Exchange Rate
    ...
    /**
     * ASBIE
     *  Freight Invoice. Withholding_ Tax Total. Tax Total
    ...
    /**
     * ASBIE
     *  Freight Invoice. Legal_ Monetary Total. Monetary Total
