...
namespace ECSSolutions\UblToolset\Structure\V2_3\Maindoc\ReceiptAdvice;
...
class ReceiptAdviceType
{
     ...
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\ReceiptAdviceTypeCode $receiptAdviceTypeCode
     */
     ...
     *  Receipt Line
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ReceiptLine[] $receiptLine
     */
    private $receiptLine = [
     ...
     *  Receipt Advice Type_ Code. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\ReceiptAdviceTypeCode
     */
     ...
     *  Receipt Advice Type_ Code. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\ReceiptAdviceTypeCode $receiptAdviceTypeCode
     * @return self
     */
    public function setReceiptAdviceTypeCode(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\ReceiptAdviceTypeCode $receiptAdviceTypeCode = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ReceiptLine $receiptLine
     */
    public function addToReceiptLine(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ReceiptLine $receiptLine)
    {
     ...
     *  Receipt Line
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ReceiptLine[]
     */
