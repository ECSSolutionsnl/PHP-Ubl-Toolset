...
namespace ECSSolutions\UblToolset\Structure\V2_3\Maindoc\RequestForQuotation;
...
class RequestForQuotationType
{
     ...
     *  Period
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\RequestedValidityPeriod $requestedValidityPeriod
     */
     ...
     *  Request For Quotation Line
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\RequestForQuotationLine[] $requestForQuotationLine
     */
     ...
     *  Period
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\RequestedValidityPeriod
     */
     ...
     *  Period
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\RequestedValidityPeriod $requestedValidityPeriod
     * @return self
     */
    public function setRequestedValidityPeriod(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\RequestedValidityPeriod $requestedValidityPeriod = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\RequestForQuotationLine $requestForQuotationLine
     */
    public function addToRequestForQuotationLine(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\RequestForQuotationLine $requestForQuotationLine)
    {
     ...
     *  Request For Quotation Line
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\RequestForQuotationLine[]
     */
