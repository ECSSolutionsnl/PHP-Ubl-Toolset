...
namespace ECSSolutions\UblToolset\Structure\V2_3\Maindoc\UtilityStatement;
...
class UtilityStatementType
{
     ...
     *  Electricity
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\UtilityStatementTypeCode $utilityStatementTypeCode
     */
     ...
     *  Customer Party
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\CustomerParty $customerParty
     */
     ...
     *  On Account Payment
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\MainOnAccountPayment[] $mainOnAccountPayment
     */
     ...
     *  Subscriber Consumption
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\SubscriberConsumption[] $subscriberConsumption
     */
     ...
     *  Electricity
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\UtilityStatementTypeCode
     */
     ...
     *  Electricity
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\UtilityStatementTypeCode $utilityStatementTypeCode
     * @return self
     */
    public function setUtilityStatementTypeCode(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\UtilityStatementTypeCode $utilityStatementTypeCode)
    {
     ...
     * @return self
     */
    public function setDocumentCurrencyCode(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonBasicComponents\DocumentCurrencyCode $documentCurrencyCode)
    {
     ...
     *  Customer Party
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\CustomerParty
     */
     ...
     *  Customer Party
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\CustomerParty $customerParty
     * @return self
     */
    public function setCustomerParty(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\CustomerParty $customerParty = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\MainOnAccountPayment $mainOnAccountPayment
     */
    public function addToMainOnAccountPayment(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\MainOnAccountPayment $mainOnAccountPayment)
    {
     ...
     *  On Account Payment
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\MainOnAccountPayment[]
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\SubscriberConsumption $subscriberConsumption
     */
    public function addToSubscriberConsumption(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\SubscriberConsumption $subscriberConsumption)
    {
     ...
     *  Subscriber Consumption
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\SubscriberConsumption[]
     */
