...
namespace ECSSolutions\UblToolset\Structure\V2_3\Maindoc\TransitCustomsDeclaration;

/**
 * Class representing TransitCustomsDeclarationType
 *
 * ABIE
 *  Transit Customs Declaration. Details
 *  A document that describes an import customs declaration.
 *  Transit Customs Declaration
 * XSD Type: TransitCustomsDeclarationType
 */
class TransitCustomsDeclarationType
{
    /**
    ...
    /**
     * BBIE
     *  Transit Customs Declaration. UBL Version Identifier. Identifier
    ...
    /**
     * BBIE
     *  Transit Customs Declaration. Customization Identifier. Identifier
    ...
    /**
     * BBIE
     *  Transit Customs Declaration. Profile Identifier. Identifier
    ...
    /**
     * BBIE
     *  Transit Customs Declaration. Profile Execution Identifier. Identifier
    ...
    /**
     * BBIE
     *  Transit Customs Declaration. Identifier
    ...
    /**
     * BBIE
     *  Transit Customs Declaration. UUID. Identifier
    ...
    /**
     * BBIE
     *  Transit Customs Declaration. Issue Date. Date
    ...
    /**
     * BBIE
     *  Transit Customs Declaration. Issue Time. Time
    ...
    /**
     * BBIE
     *  Transit Customs Declaration. Type Code. Code
    ...
    /**
     * BBIE
     *  Transit Customs Declaration. Sub_ Type Code. Code
    ...
    /**
     * BBIE
     *  Transit Customs Declaration. Nature Of_ Transaction Code. Code
    ...
    /**
     * BBIE
     *  Transit Customs Declaration. Note. Text
    ...
    /**
     * BBIE
     *  Transit Customs Declaration. Version. Identifier
    ...
    /**
     * ASBIE
     *  Transit Customs Declaration. Validity_ Period. Period
    ...
    /**
     * ASBIE
     *  Transit Customs Declaration. Export Customs Exit Office_ Location. Location
     *  Customs office of exit of the goods being declared for export.
     *  0..1
     *  Transit Customs Declaration
     *  Export Customs Exit Office
     *  Location
     *  Location
     *  Location
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ExportCustomsExitOfficeLocation $exportCustomsExitOfficeLocation
     */
    private $exportCustomsExitOfficeLocation = null;

    /**
     * ASBIE
     *  Transit Customs Declaration. Transit Customs Exit Office_ Location. Location
     *  Customs office of exit of the goods being declared for transit.
     *  0..1
     *  Transit Customs Declaration
     *  Transit Customs Exit Office
     *  Location
     *  Location
     *  Location
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\TransitCustomsExitOfficeLocation $transitCustomsExitOfficeLocation
     */
    private $transitCustomsExitOfficeLocation = null;

    /**
     * ASBIE
     *  Transit Customs Declaration. Import Customs Exit Office_ Location. Location
     *  Customs office of exit of the goods being declared for import.
     *  0..1
     *  Transit Customs Declaration
     *  Import Customs Exit Office
     *  Location
     *  Location
     *  Location
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ImportCustomsExitOfficeLocation $importCustomsExitOfficeLocation
     */
    private $importCustomsExitOfficeLocation = null;

    /**
     * ASBIE
     *  Transit Customs Declaration. Jurisdiction Region_ Address. Address
    ...
    /**
     * ASBIE
     *  Transit Customs Declaration. Transit Exporter_ Party. Party
     ...
     *  Party
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\TransitExporterParty $transitExporterParty
     */
    private $transitExporterParty = null;

    /**
     * ASBIE
     *  Transit Customs Declaration. Consignor_ Party. Party
    ...
    /**
     * ASBIE
     *  Transit Customs Declaration. Consignee_ Party. Party
    ...
    /**
     * ASBIE
     *  Transit Customs Declaration. Freight Forwarder_ Party. Party
    ...
    /**
     * ASBIE
     *  Transit Customs Declaration. Customs_ Party. Party
    ...
    /**
     * ASBIE
     *  Transit Customs Declaration. Notifier_ Party. Party
    ...
    /**
     * ASBIE
     *  Transit Customs Declaration. Shipment
    ...
    /**
     * ASBIE
     *  Transit Customs Declaration. Previous_ Customs Declaration. Customs Declaration
     ...
     */
    private $previousCustomsDeclaration = [
        
    ];

    /**
     * ASBIE
     *  Transit Customs Declaration. Additional_ Document Reference. Document Reference
    ...
    /**
     * ASBIE
     *  Transit Customs Declaration. Signature
    ...
    /**
     * Gets as exportCustomsExitOfficeLocation
     *
     * ASBIE
     *  Transit Customs Declaration. Export Customs Exit Office_ Location. Location
     *  Customs office of exit of the goods being declared for export.
     ...
     *  Location
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ExportCustomsExitOfficeLocation
     */
    public function getExportCustomsExitOfficeLocation()
    {
        return $this->exportCustomsExitOfficeLocation;
    }

    /**
     * Sets a new exportCustomsExitOfficeLocation
     *
     * ASBIE
     *  Transit Customs Declaration. Export Customs Exit Office_ Location. Location
     *  Customs office of exit of the goods being declared for export.
     ...
     *  Location
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ExportCustomsExitOfficeLocation $exportCustomsExitOfficeLocation
     * @return self
     */
    public function setExportCustomsExitOfficeLocation(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ExportCustomsExitOfficeLocation $exportCustomsExitOfficeLocation = null)
    {
        $this->exportCustomsExitOfficeLocation = $exportCustomsExitOfficeLocation;
        return $this;
    }

    /**
     * Gets as transitCustomsExitOfficeLocation
     *
     * ASBIE
     *  Transit Customs Declaration. Transit Customs Exit Office_ Location. Location
     *  Customs office of exit of the goods being declared for transit.
     ...
     *  Location
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\TransitCustomsExitOfficeLocation
     */
    public function getTransitCustomsExitOfficeLocation()
    {
        return $this->transitCustomsExitOfficeLocation;
    }

    /**
     * Sets a new transitCustomsExitOfficeLocation
     *
     * ASBIE
     *  Transit Customs Declaration. Transit Customs Exit Office_ Location. Location
     *  Customs office of exit of the goods being declared for transit.
     ...
     *  Location
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\TransitCustomsExitOfficeLocation $transitCustomsExitOfficeLocation
     * @return self
     */
    public function setTransitCustomsExitOfficeLocation(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\TransitCustomsExitOfficeLocation $transitCustomsExitOfficeLocation = null)
    {
        $this->transitCustomsExitOfficeLocation = $transitCustomsExitOfficeLocation;
        return $this;
    }

    /**
     * Gets as importCustomsExitOfficeLocation
     *
     * ASBIE
     *  Transit Customs Declaration. Import Customs Exit Office_ Location. Location
     *  Customs office of exit of the goods being declared for import.
     ...
     *  Location
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ImportCustomsExitOfficeLocation
     */
    public function getImportCustomsExitOfficeLocation()
    {
        return $this->importCustomsExitOfficeLocation;
    }

    /**
     * Sets a new importCustomsExitOfficeLocation
     *
     * ASBIE
     *  Transit Customs Declaration. Import Customs Exit Office_ Location. Location
     *  Customs office of exit of the goods being declared for import.
     ...
     *  Location
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ImportCustomsExitOfficeLocation $importCustomsExitOfficeLocation
     * @return self
     */
    public function setImportCustomsExitOfficeLocation(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\ImportCustomsExitOfficeLocation $importCustomsExitOfficeLocation = null)
    {
        $this->importCustomsExitOfficeLocation = $importCustomsExitOfficeLocation;
        return $this;
    }
     ...
     *  Party
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\TransitExporterParty
     */
    public function getTransitExporterParty()
    {
        return $this->transitExporterParty;
    }

    /**
     * Sets a new transitExporterParty
     *
     * ASBIE
     *  Transit Customs Declaration. Transit Exporter_ Party. Party
     *  The Party who makes the transit declaration, or on whose behalf the transit declaration is made, and who is the owner of the goods or has similar right of disposal over them at the time when the declaration is accepted.
     ...
     *  Party
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\TransitExporterParty $transitExporterParty
     * @return self
     */
    public function setTransitExporterParty(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\TransitExporterParty $transitExporterParty = null)
    {
        $this->transitExporterParty = $transitExporterParty;
        return $this;
    }
     ...
     * @return self
     */
    public function setCustomsParty(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\CustomsParty $customsParty)
    {
     ...
     */
    public function addToShipment(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\Shipment $shipment)
    {
    ...
    /**
     * Adds as previousCustomsDeclaration
     *
     * ASBIE
     *  Transit Customs Declaration. Previous_ Customs Declaration. Customs Declaration
     *  A reference to a previously sent transit customs declaration.
     ...
     */
    public function addToPreviousCustomsDeclaration(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\PreviousCustomsDeclaration $previousCustomsDeclaration)
    {
    ...
    /**
     * isset previousCustomsDeclaration
     *
     * ASBIE
     *  Transit Customs Declaration. Previous_ Customs Declaration. Customs Declaration
     *  A reference to a previously sent transit customs declaration.
     ...
     * @return bool
     */
    public function issetPreviousCustomsDeclaration($index)
    {
        return isset($this->previousCustomsDeclaration[$index]);
    }

    /**
     * unset previousCustomsDeclaration
     *
     * ASBIE
     *  Transit Customs Declaration. Previous_ Customs Declaration. Customs Declaration
     *  A reference to a previously sent transit customs declaration.
     ...
     * @return void
     */
    public function unsetPreviousCustomsDeclaration($index)
    {
        unset($this->previousCustomsDeclaration[$index]);
    }
     ...
     * @return self
     */
    public function setPreviousCustomsDeclaration(?array $previousCustomsDeclaration = null)
    {
        $this->previousCustomsDeclaration = $previousCustomsDeclaration;
        return $this;
    }
