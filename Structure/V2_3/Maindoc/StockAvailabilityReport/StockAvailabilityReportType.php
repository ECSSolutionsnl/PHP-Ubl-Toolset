...
namespace ECSSolutions\UblToolset\Structure\V2_3\Maindoc\StockAvailabilityReport;
...
class StockAvailabilityReportType
{
     ...
     *  Period
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\InventoryPeriod $inventoryPeriod
     */
     ...
     *  Party
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\InventoryReportingParty $inventoryReportingParty
     */
     ...
     *  Stock Availability Report Line
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\StockAvailabilityReportLine[] $stockAvailabilityReportLine
     */
     ...
     *  Period
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\InventoryPeriod
     */
     ...
     *  Period
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\InventoryPeriod $inventoryPeriod
     * @return self
     */
    public function setInventoryPeriod(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\InventoryPeriod $inventoryPeriod = null)
    {
     ...
     * @return self
     */
    public function setRetailerCustomerParty(?\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\RetailerCustomerParty $retailerCustomerParty = null)
    {
     ...
     *  Party
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\InventoryReportingParty
     */
     ...
     *  Party
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\InventoryReportingParty $inventoryReportingParty
     * @return self
     */
    public function setInventoryReportingParty(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\InventoryReportingParty $inventoryReportingParty)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\StockAvailabilityReportLine $stockAvailabilityReportLine
     */
    public function addToStockAvailabilityReportLine(\ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\StockAvailabilityReportLine $stockAvailabilityReportLine)
    {
     ...
     *  Stock Availability Report Line
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_3\Common\CommonAggregateComponents\StockAvailabilityReportLine[]
     */
