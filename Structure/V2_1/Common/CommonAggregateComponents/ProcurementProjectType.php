...
class ProcurementProjectType
{
     ...
     *  Code. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ProcurementTypeCode $procurementTypeCode
     */
     ...
     *  Code. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ProcurementSubTypeCode $procurementSubTypeCode
     */
     ...
     *  Code. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\QualityControlCode $qualityControlCode
     */
     ...
     *  Amount. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\RequiredFeeAmount $requiredFeeAmount
     */
     ...
     *  Text. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\FeeDescription[] $feeDescription
     */
     ...
     *  Quantity. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\EstimatedOverallContractQuantity $estimatedOverallContractQuantity
     */
     ...
     *  Requested Tender Total
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\RequestedTenderTotal $requestedTenderTotal
     */
     ...
     *  Commodity Classification
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\MainCommodityClassification $mainCommodityClassification
     */
     ...
     *  Commodity Classification
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\AdditionalCommodityClassification[] $additionalCommodityClassification
     */
     ...
     *  Location
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\RealizedLocation[] $realizedLocation
     */
     ...
     *  Period
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\PlannedPeriod $plannedPeriod
     */
     ...
     *  Contract Extension
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ContractExtension $contractExtension
     */
     ...
     *  Request For Tender Line
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\RequestForTenderLine[] $requestForTenderLine
     */
     ...
     */
    public function addToName(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\Name $name)
    {
        $this->name[] = $name;
        return $this;
    }
     ...
     *  Code. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ProcurementTypeCode
     */
     ...
     *  Code. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ProcurementTypeCode $procurementTypeCode
     * @return self
     */
    public function setProcurementTypeCode(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ProcurementTypeCode $procurementTypeCode = null)
    {
     ...
     *  Code. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ProcurementSubTypeCode
     */
     ...
     *  Code. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ProcurementSubTypeCode $procurementSubTypeCode
     * @return self
     */
    public function setProcurementSubTypeCode(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ProcurementSubTypeCode $procurementSubTypeCode = null)
    {
     ...
     *  Code. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\QualityControlCode
     */
     ...
     *  Code. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\QualityControlCode $qualityControlCode
     * @return self
     */
    public function setQualityControlCode(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\QualityControlCode $qualityControlCode = null)
    {
     ...
     *  Amount. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\RequiredFeeAmount
     */
     ...
     *  Amount. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\RequiredFeeAmount $requiredFeeAmount
     * @return self
     */
    public function setRequiredFeeAmount(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\RequiredFeeAmount $requiredFeeAmount = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\FeeDescription $feeDescription
     */
    public function addToFeeDescription(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\FeeDescription $feeDescription)
    {
     ...
     *  Text. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\FeeDescription[]
     */
     ...
     *  Quantity. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\EstimatedOverallContractQuantity
     */
     ...
     *  Quantity. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\EstimatedOverallContractQuantity $estimatedOverallContractQuantity
     * @return self
     */
    public function setEstimatedOverallContractQuantity(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\EstimatedOverallContractQuantity $estimatedOverallContractQuantity = null)
    {
     ...
     *  Requested Tender Total
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\RequestedTenderTotal
     */
     ...
     *  Requested Tender Total
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\RequestedTenderTotal $requestedTenderTotal
     * @return self
     */
    public function setRequestedTenderTotal(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\RequestedTenderTotal $requestedTenderTotal = null)
    {
     ...
     *  Commodity Classification
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\MainCommodityClassification
     */
     ...
     *  Commodity Classification
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\MainCommodityClassification $mainCommodityClassification
     * @return self
     */
    public function setMainCommodityClassification(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\MainCommodityClassification $mainCommodityClassification = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\AdditionalCommodityClassification $additionalCommodityClassification
     */
    public function addToAdditionalCommodityClassification(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\AdditionalCommodityClassification $additionalCommodityClassification)
    {
     ...
     *  Commodity Classification
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\AdditionalCommodityClassification[]
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\RealizedLocation $realizedLocation
     */
    public function addToRealizedLocation(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\RealizedLocation $realizedLocation)
    {
     ...
     *  Location
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\RealizedLocation[]
     */
     ...
     *  Period
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\PlannedPeriod
     */
     ...
     *  Period
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\PlannedPeriod $plannedPeriod
     * @return self
     */
    public function setPlannedPeriod(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\PlannedPeriod $plannedPeriod = null)
    {
     ...
     *  Contract Extension
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ContractExtension
     */
     ...
     *  Contract Extension
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ContractExtension $contractExtension
     * @return self
     */
    public function setContractExtension(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ContractExtension $contractExtension = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\RequestForTenderLine $requestForTenderLine
     */
    public function addToRequestForTenderLine(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\RequestForTenderLine $requestForTenderLine)
    {
     ...
     *  Request For Tender Line
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\RequestForTenderLine[]
     */
