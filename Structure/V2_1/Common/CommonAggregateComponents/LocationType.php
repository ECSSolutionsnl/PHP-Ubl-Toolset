...
class LocationType
{
     ...
     *  Text. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\Conditions[] $conditions
     */
    private $conditions = [
     ...
     *  Code. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\LocationTypeCode $locationTypeCode
     */
     ...
     *  Identifier. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\InformationURI $informationURI
     */
     ...
     *  Location
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\SubsidiaryLocation[] $subsidiaryLocation
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\Conditions $conditions
     */
    public function addToConditions(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\Conditions $conditions)
    {
     ...
     *  Text. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\Conditions[]
     */
     ...
     *  Code. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\LocationTypeCode
     */
     ...
     *  Code. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\LocationTypeCode $locationTypeCode
     * @return self
     */
    public function setLocationTypeCode(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\LocationTypeCode $locationTypeCode = null)
    {
     ...
     *  Identifier. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\InformationURI
     */
     ...
     *  Identifier. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\InformationURI $informationURI
     * @return self
     */
    public function setInformationURI(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\InformationURI $informationURI = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\SubsidiaryLocation $subsidiaryLocation
     */
    public function addToSubsidiaryLocation(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\SubsidiaryLocation $subsidiaryLocation)
    {
     ...
     *  Location
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\SubsidiaryLocation[]
     */
