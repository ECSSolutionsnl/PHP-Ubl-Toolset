...
class TransportExecutionTermsType
{
     ...
     *  Text. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\TransportUserSpecialTerms[] $transportUserSpecialTerms
     */
     ...
     *  Text. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\TransportServiceProviderSpecialTerms[] $transportServiceProviderSpecialTerms
     */
     ...
     *  Text. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ChangeConditions[] $changeConditions
     */
     ...
     *  Payment Terms
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\BonusPaymentTerms $bonusPaymentTerms
     */
     ...
     *  Payment Terms
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\CommissionPaymentTerms $commissionPaymentTerms
     */
     ...
     *  Payment Terms
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\PenaltyPaymentTerms $penaltyPaymentTerms
     */
     ...
     *  Notification Requirement
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\NotificationRequirement[] $notificationRequirement
     */
     ...
     *  Payment Terms
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ServiceChargePaymentTerms $serviceChargePaymentTerms
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\TransportUserSpecialTerms $transportUserSpecialTerms
     */
    public function addToTransportUserSpecialTerms(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\TransportUserSpecialTerms $transportUserSpecialTerms)
    {
     ...
     *  Text. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\TransportUserSpecialTerms[]
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\TransportServiceProviderSpecialTerms $transportServiceProviderSpecialTerms
     */
    public function addToTransportServiceProviderSpecialTerms(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\TransportServiceProviderSpecialTerms $transportServiceProviderSpecialTerms)
    {
     ...
     *  Text. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\TransportServiceProviderSpecialTerms[]
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ChangeConditions $changeConditions
     */
    public function addToChangeConditions(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ChangeConditions $changeConditions)
    {
     ...
     *  Text. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ChangeConditions[]
     */
     ...
     *  Payment Terms
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\BonusPaymentTerms
     */
     ...
     *  Payment Terms
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\BonusPaymentTerms $bonusPaymentTerms
     * @return self
     */
    public function setBonusPaymentTerms(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\BonusPaymentTerms $bonusPaymentTerms = null)
    {
     ...
     *  Payment Terms
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\CommissionPaymentTerms
     */
     ...
     *  Payment Terms
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\CommissionPaymentTerms $commissionPaymentTerms
     * @return self
     */
    public function setCommissionPaymentTerms(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\CommissionPaymentTerms $commissionPaymentTerms = null)
    {
     ...
     *  Payment Terms
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\PenaltyPaymentTerms
     */
     ...
     *  Payment Terms
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\PenaltyPaymentTerms $penaltyPaymentTerms
     * @return self
     */
    public function setPenaltyPaymentTerms(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\PenaltyPaymentTerms $penaltyPaymentTerms = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\NotificationRequirement $notificationRequirement
     */
    public function addToNotificationRequirement(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\NotificationRequirement $notificationRequirement)
    {
     ...
     *  Notification Requirement
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\NotificationRequirement[]
     */
     ...
     *  Payment Terms
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ServiceChargePaymentTerms
     */
     ...
     *  Payment Terms
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ServiceChargePaymentTerms $serviceChargePaymentTerms
     * @return self
     */
    public function setServiceChargePaymentTerms(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ServiceChargePaymentTerms $serviceChargePaymentTerms = null)
    {
