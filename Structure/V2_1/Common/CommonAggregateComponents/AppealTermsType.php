...
class AppealTermsType
{
     ...
     *  Period
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\PresentationPeriod $presentationPeriod
     */
     ...
     *  Party
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\AppealInformationParty $appealInformationParty
     */
     ...
     *  Party
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\AppealReceiverParty $appealReceiverParty
     */
     ...
     *  Party
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\MediationParty $mediationParty
     */
     ...
     *  Period
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\PresentationPeriod
     */
     ...
     *  Period
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\PresentationPeriod $presentationPeriod
     * @return self
     */
    public function setPresentationPeriod(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\PresentationPeriod $presentationPeriod = null)
    {
     ...
     *  Party
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\AppealInformationParty
     */
     ...
     *  Party
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\AppealInformationParty $appealInformationParty
     * @return self
     */
    public function setAppealInformationParty(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\AppealInformationParty $appealInformationParty = null)
    {
     ...
     *  Party
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\AppealReceiverParty
     */
     ...
     *  Party
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\AppealReceiverParty $appealReceiverParty
     * @return self
     */
    public function setAppealReceiverParty(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\AppealReceiverParty $appealReceiverParty = null)
    {
     ...
     *  Party
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\MediationParty
     */
     ...
     *  Party
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\MediationParty $mediationParty
     * @return self
     */
    public function setMediationParty(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\MediationParty $mediationParty = null)
    {
