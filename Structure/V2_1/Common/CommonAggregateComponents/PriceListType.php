...
class PriceListType
{
     ...
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\StatusCode $statusCode
     */
     ...
     *  Price List
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\PreviousPriceList $previousPriceList
     */
     ...
     *  new - announcement only , new and available , deleted - announcement only
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\StatusCode
     */
     ...
     *  new - announcement only , new and available , deleted - announcement only
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\StatusCode $statusCode
     * @return self
     */
    public function setStatusCode(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\StatusCode $statusCode = null)
    {
     ...
     *  Price List
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\PreviousPriceList
     */
     ...
     *  Price List
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\PreviousPriceList $previousPriceList
     * @return self
     */
    public function setPreviousPriceList(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\PreviousPriceList $previousPriceList = null)
    {
