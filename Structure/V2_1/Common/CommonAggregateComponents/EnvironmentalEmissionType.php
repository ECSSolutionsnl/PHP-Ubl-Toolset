...
class EnvironmentalEmissionType
{
     ...
     *  Code. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\EnvironmentalEmissionTypeCode $environmentalEmissionTypeCode
     */
     ...
     *  Measure. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ValueMeasure $valueMeasure
     */
     ...
     *  Emission Calculation Method
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\EmissionCalculationMethod[] $emissionCalculationMethod
     */
     ...
     *  Code. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\EnvironmentalEmissionTypeCode
     */
     ...
     *  Code. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\EnvironmentalEmissionTypeCode $environmentalEmissionTypeCode
     * @return self
     */
    public function setEnvironmentalEmissionTypeCode(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\EnvironmentalEmissionTypeCode $environmentalEmissionTypeCode)
    {
     ...
     *  Measure. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ValueMeasure
     */
     ...
     *  Measure. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ValueMeasure $valueMeasure
     * @return self
     */
    public function setValueMeasure(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ValueMeasure $valueMeasure)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\EmissionCalculationMethod $emissionCalculationMethod
     */
    public function addToEmissionCalculationMethod(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\EmissionCalculationMethod $emissionCalculationMethod)
    {
     ...
     *  Emission Calculation Method
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\EmissionCalculationMethod[]
     */
