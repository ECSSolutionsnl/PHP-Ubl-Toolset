...
class QuotationLineType
{
     ...
     *  Identifier. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\RequestForQuotationLineID $requestForQuotationLineID
     */
     ...
     *  Line Item
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\AlternativeLineItem[] $alternativeLineItem
     */
     ...
     *  Line Reference
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\RequestLineReference $requestLineReference
     */
     ...
     *  Identifier. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\RequestForQuotationLineID
     */
     ...
     *  Identifier. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\RequestForQuotationLineID $requestForQuotationLineID
     * @return self
     */
    public function setRequestForQuotationLineID(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\RequestForQuotationLineID $requestForQuotationLineID = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\AlternativeLineItem $alternativeLineItem
     */
    public function addToAlternativeLineItem(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\AlternativeLineItem $alternativeLineItem)
    {
     ...
     *  Line Item
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\AlternativeLineItem[]
     */
     ...
     *  Line Reference
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\RequestLineReference
     */
     ...
     *  Line Reference
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\RequestLineReference $requestLineReference
     * @return self
     */
    public function setRequestLineReference(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\RequestLineReference $requestLineReference = null)
    {
