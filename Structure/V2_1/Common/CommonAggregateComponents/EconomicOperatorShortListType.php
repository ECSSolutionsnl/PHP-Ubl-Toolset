...
class EconomicOperatorShortListType
{
     ...
     *  Text. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\LimitationDescription[] $limitationDescription
     */
     ...
     *  Quantity. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ExpectedQuantity $expectedQuantity
     */
     ...
     *  Party
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\PreSelectedParty[] $preSelectedParty
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\LimitationDescription $limitationDescription
     */
    public function addToLimitationDescription(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\LimitationDescription $limitationDescription)
    {
     ...
     *  Text. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\LimitationDescription[]
     */
     ...
     *  Quantity. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ExpectedQuantity
     */
     ...
     *  Quantity. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ExpectedQuantity $expectedQuantity
     * @return self
     */
    public function setExpectedQuantity(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ExpectedQuantity $expectedQuantity = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\PreSelectedParty $preSelectedParty
     */
    public function addToPreSelectedParty(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\PreSelectedParty $preSelectedParty)
    {
     ...
     *  Party
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\PreSelectedParty[]
     */
