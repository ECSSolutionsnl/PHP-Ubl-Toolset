...
class TransportHandlingUnitType
{
     ...
     *  Code. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\TransportHandlingUnitTypeCode $transportHandlingUnitTypeCode
     */
     ...
     *  Quantity. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\TotalPackageQuantity $totalPackageQuantity
     */
     ...
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ShippingMarks[] $shippingMarks
     */
     ...
     *  Despatch Line
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\HandlingUnitDespatchLine[] $handlingUnitDespatchLine
     */
     ...
     *  Package
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ActualPackage[] $actualPackage
     */
     ...
     *  Receipt Line
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ReceivedHandlingUnitReceiptLine[] $receivedHandlingUnitReceiptLine
     */
     ...
     *  Transport Equipment
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\TransportEquipment[] $transportEquipment
     */
     ...
     *  Dimension
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\FloorSpaceMeasurementDimension $floorSpaceMeasurementDimension
     */
     ...
     *  Dimension
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\PalletSpaceMeasurementDimension $palletSpaceMeasurementDimension
     */
     ...
     *  Shipment
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ReferencedShipment[] $referencedShipment
     */
     ...
     *  Code. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\TransportHandlingUnitTypeCode
     */
     ...
     *  Code. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\TransportHandlingUnitTypeCode $transportHandlingUnitTypeCode
     * @return self
     */
    public function setTransportHandlingUnitTypeCode(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\TransportHandlingUnitTypeCode $transportHandlingUnitTypeCode = null)
    {
     ...
     *  Quantity. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\TotalPackageQuantity
     */
     ...
     *  Quantity. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\TotalPackageQuantity $totalPackageQuantity
     * @return self
     */
    public function setTotalPackageQuantity(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\TotalPackageQuantity $totalPackageQuantity = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ShippingMarks $shippingMarks
     */
    public function addToShippingMarks(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ShippingMarks $shippingMarks)
    {
     ...
     *  Marks and Numbers, Shipping Marks
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ShippingMarks[]
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\HandlingUnitDespatchLine $handlingUnitDespatchLine
     */
    public function addToHandlingUnitDespatchLine(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\HandlingUnitDespatchLine $handlingUnitDespatchLine)
    {
     ...
     *  Despatch Line
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\HandlingUnitDespatchLine[]
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ActualPackage $actualPackage
     */
    public function addToActualPackage(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ActualPackage $actualPackage)
    {
     ...
     *  Package
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ActualPackage[]
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ReceivedHandlingUnitReceiptLine $receivedHandlingUnitReceiptLine
     */
    public function addToReceivedHandlingUnitReceiptLine(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ReceivedHandlingUnitReceiptLine $receivedHandlingUnitReceiptLine)
    {
     ...
     *  Receipt Line
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ReceivedHandlingUnitReceiptLine[]
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\TransportEquipment $transportEquipment
     */
    public function addToTransportEquipment(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\TransportEquipment $transportEquipment)
    {
     ...
     *  Transport Equipment
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\TransportEquipment[]
     */
     ...
     */
    public function addToTransportMeans(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\TransportMeans $transportMeans)
    {
     ...
     *  Dimension
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\FloorSpaceMeasurementDimension
     */
     ...
     *  Dimension
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\FloorSpaceMeasurementDimension $floorSpaceMeasurementDimension
     * @return self
     */
    public function setFloorSpaceMeasurementDimension(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\FloorSpaceMeasurementDimension $floorSpaceMeasurementDimension = null)
    {
     ...
     *  Dimension
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\PalletSpaceMeasurementDimension
     */
     ...
     *  Dimension
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\PalletSpaceMeasurementDimension $palletSpaceMeasurementDimension
     * @return self
     */
    public function setPalletSpaceMeasurementDimension(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\PalletSpaceMeasurementDimension $palletSpaceMeasurementDimension = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ReferencedShipment $referencedShipment
     */
    public function addToReferencedShipment(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ReferencedShipment $referencedShipment)
    {
     ...
     *  Shipment
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ReferencedShipment[]
     */
