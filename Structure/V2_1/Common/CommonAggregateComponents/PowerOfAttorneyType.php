...
class PowerOfAttorneyType
{
     ...
     *  Party
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\NotaryParty $notaryParty
     */
     ...
     *  Party
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\WitnessParty[] $witnessParty
     */
     ...
     *  Document Reference
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\MandateDocumentReference[] $mandateDocumentReference
     */
     ...
     *  Party
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\NotaryParty
     */
     ...
     *  Party
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\NotaryParty $notaryParty
     * @return self
     */
    public function setNotaryParty(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\NotaryParty $notaryParty = null)
    {
     ...
     * @return self
     */
    public function setAgentParty(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\AgentParty $agentParty)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\WitnessParty $witnessParty
     */
    public function addToWitnessParty(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\WitnessParty $witnessParty)
    {
     ...
     *  Party
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\WitnessParty[]
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\MandateDocumentReference $mandateDocumentReference
     */
    public function addToMandateDocumentReference(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\MandateDocumentReference $mandateDocumentReference)
    {
     ...
     *  Document Reference
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\MandateDocumentReference[]
     */
