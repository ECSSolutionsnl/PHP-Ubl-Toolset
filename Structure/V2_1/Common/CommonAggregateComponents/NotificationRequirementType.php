...
class NotificationRequirementType
{
     ...
     *  Code. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\NotificationTypeCode $notificationTypeCode
     */
     ...
     *  Measure. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\PostEventNotificationDurationMeasure $postEventNotificationDurationMeasure
     */
     ...
     *  Measure. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\PreEventNotificationDurationMeasure $preEventNotificationDurationMeasure
     */
     ...
     *  Period
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\NotificationPeriod[] $notificationPeriod
     */
     ...
     *  Location
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\NotificationLocation[] $notificationLocation
     */
     ...
     *  Code. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\NotificationTypeCode
     */
     ...
     *  Code. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\NotificationTypeCode $notificationTypeCode
     * @return self
     */
    public function setNotificationTypeCode(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\NotificationTypeCode $notificationTypeCode)
    {
     ...
     *  Measure. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\PostEventNotificationDurationMeasure
     */
     ...
     *  Measure. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\PostEventNotificationDurationMeasure $postEventNotificationDurationMeasure
     * @return self
     */
    public function setPostEventNotificationDurationMeasure(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\PostEventNotificationDurationMeasure $postEventNotificationDurationMeasure = null)
    {
     ...
     *  Measure. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\PreEventNotificationDurationMeasure
     */
     ...
     *  Measure. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\PreEventNotificationDurationMeasure $preEventNotificationDurationMeasure
     * @return self
     */
    public function setPreEventNotificationDurationMeasure(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\PreEventNotificationDurationMeasure $preEventNotificationDurationMeasure = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\NotificationPeriod $notificationPeriod
     */
    public function addToNotificationPeriod(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\NotificationPeriod $notificationPeriod)
    {
     ...
     *  Period
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\NotificationPeriod[]
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\NotificationLocation $notificationLocation
     */
    public function addToNotificationLocation(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\NotificationLocation $notificationLocation)
    {
     ...
     *  Location
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\NotificationLocation[]
     */
