...
class ExceptionNotificationLineType
{
     ...
     *  Code. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ExceptionStatusCode $exceptionStatusCode
     */
     ...
     *  Code. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\CollaborationPriorityCode $collaborationPriorityCode
     */
     ...
     *  Code. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ResolutionCode $resolutionCode
     */
     ...
     *  Measure. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ComparedValueMeasure $comparedValueMeasure
     */
     ...
     *  Measure. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\SourceValueMeasure $sourceValueMeasure
     */
     ...
     *  Quantity. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\VarianceQuantity $varianceQuantity
     */
     ...
     *  Code. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\SupplyChainActivityTypeCode $supplyChainActivityTypeCode
     */
     ...
     *  Period
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ExceptionObservationPeriod $exceptionObservationPeriod
     */
     ...
     *  Forecast Exception
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ForecastException $forecastException
     */
     ...
     *  Item
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\SupplyItem $supplyItem
     */
     ...
     *  Code. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ExceptionStatusCode
     */
     ...
     *  Code. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ExceptionStatusCode $exceptionStatusCode
     * @return self
     */
    public function setExceptionStatusCode(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ExceptionStatusCode $exceptionStatusCode = null)
    {
     ...
     *  Code. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\CollaborationPriorityCode
     */
     ...
     *  Code. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\CollaborationPriorityCode $collaborationPriorityCode
     * @return self
     */
    public function setCollaborationPriorityCode(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\CollaborationPriorityCode $collaborationPriorityCode = null)
    {
     ...
     *  Code. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ResolutionCode
     */
     ...
     *  Code. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ResolutionCode $resolutionCode
     * @return self
     */
    public function setResolutionCode(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ResolutionCode $resolutionCode = null)
    {
     ...
     *  Measure. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ComparedValueMeasure
     */
     ...
     *  Measure. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ComparedValueMeasure $comparedValueMeasure
     * @return self
     */
    public function setComparedValueMeasure(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ComparedValueMeasure $comparedValueMeasure)
    {
     ...
     *  Measure. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\SourceValueMeasure
     */
     ...
     *  Measure. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\SourceValueMeasure $sourceValueMeasure
     * @return self
     */
    public function setSourceValueMeasure(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\SourceValueMeasure $sourceValueMeasure)
    {
     ...
     *  Quantity. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\VarianceQuantity
     */
     ...
     *  Quantity. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\VarianceQuantity $varianceQuantity
     * @return self
     */
    public function setVarianceQuantity(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\VarianceQuantity $varianceQuantity = null)
    {
     ...
     *  Code. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\SupplyChainActivityTypeCode
     */
     ...
     *  Code. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\SupplyChainActivityTypeCode $supplyChainActivityTypeCode
     * @return self
     */
    public function setSupplyChainActivityTypeCode(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\SupplyChainActivityTypeCode $supplyChainActivityTypeCode = null)
    {
     ...
     * @return self
     */
    public function setPerformanceMetricTypeCode(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\PerformanceMetricTypeCode $performanceMetricTypeCode = null)
    {
     ...
     *  Period
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ExceptionObservationPeriod
     */
     ...
     *  Period
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ExceptionObservationPeriod $exceptionObservationPeriod
     * @return self
     */
    public function setExceptionObservationPeriod(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ExceptionObservationPeriod $exceptionObservationPeriod = null)
    {
     ...
     *  Forecast Exception
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ForecastException
     */
     ...
     *  Forecast Exception
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ForecastException $forecastException
     * @return self
     */
    public function setForecastException(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ForecastException $forecastException = null)
    {
     ...
     *  Item
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\SupplyItem
     */
     ...
     *  Item
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\SupplyItem $supplyItem
     * @return self
     */
    public function setSupplyItem(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\SupplyItem $supplyItem)
    {
