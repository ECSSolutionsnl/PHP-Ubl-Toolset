...
class DocumentDistributionType
{
     ...
     *  Text. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\PrintQualifier $printQualifier
     */
     ...
     *  Numeric. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\MaximumCopiesNumeric $maximumCopiesNumeric
     */
     ...
     *  Text. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\PrintQualifier
     */
     ...
     *  Text. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\PrintQualifier $printQualifier
     * @return self
     */
    public function setPrintQualifier(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\PrintQualifier $printQualifier)
    {
     ...
     *  Numeric. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\MaximumCopiesNumeric
     */
     ...
     *  Numeric. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\MaximumCopiesNumeric $maximumCopiesNumeric
     * @return self
     */
    public function setMaximumCopiesNumeric(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\MaximumCopiesNumeric $maximumCopiesNumeric)
    {
