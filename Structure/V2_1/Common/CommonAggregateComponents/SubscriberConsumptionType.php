...
class SubscriberConsumptionType
{
     ...
     *  Identifier. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ConsumptionID $consumptionID
     */
     ...
     *  Code. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\SpecificationTypeCode $specificationTypeCode
     */
     ...
     *  2000.0
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\TotalMeteredQuantity $totalMeteredQuantity
     */
     ...
     *  Consumption Point
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\UtilityConsumptionPoint $utilityConsumptionPoint
     */
     ...
     *  On Account Payment
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\OnAccountPayment[] $onAccountPayment
     */
     ...
     *  Consumption
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\Consumption $consumption
     */
     ...
     *  Supplier Consumption
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\SupplierConsumption[] $supplierConsumption
     */
     ...
     *  Identifier. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ConsumptionID
     */
     ...
     *  Identifier. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ConsumptionID $consumptionID
     * @return self
     */
    public function setConsumptionID(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ConsumptionID $consumptionID = null)
    {
     ...
     *  Code. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\SpecificationTypeCode
     */
     ...
     *  Code. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\SpecificationTypeCode $specificationTypeCode
     * @return self
     */
    public function setSpecificationTypeCode(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\SpecificationTypeCode $specificationTypeCode = null)
    {
     ...
     *  2000.0
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\TotalMeteredQuantity
     */
     ...
     *  2000.0
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\TotalMeteredQuantity $totalMeteredQuantity
     * @return self
     */
    public function setTotalMeteredQuantity(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\TotalMeteredQuantity $totalMeteredQuantity = null)
    {
     ...
     *  Consumption Point
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\UtilityConsumptionPoint
     */
     ...
     *  Consumption Point
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\UtilityConsumptionPoint $utilityConsumptionPoint
     * @return self
     */
    public function setUtilityConsumptionPoint(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\UtilityConsumptionPoint $utilityConsumptionPoint)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\OnAccountPayment $onAccountPayment
     */
    public function addToOnAccountPayment(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\OnAccountPayment $onAccountPayment)
    {
     ...
     *  On Account Payment
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\OnAccountPayment[]
     */
     ...
     *  Consumption
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\Consumption
     */
     ...
     *  Consumption
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\Consumption $consumption
     * @return self
     */
    public function setConsumption(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\Consumption $consumption = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\SupplierConsumption $supplierConsumption
     */
    public function addToSupplierConsumption(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\SupplierConsumption $supplierConsumption)
    {
     ...
     *  Supplier Consumption
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\SupplierConsumption[]
     */
