...
class TransportEquipmentType
{
     ...
     *  Identifier. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ReferencedConsignmentID[] $referencedConsignmentID
     */
     ...
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\TransportEquipmentTypeCode $transportEquipmentTypeCode
     */
     ...
     *  Code. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ProviderTypeCode $providerTypeCode
     */
     ...
     *  Code. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\OwnerTypeCode $ownerTypeCode
     */
     ...
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\SizeTypeCode $sizeTypeCode
     */
     ...
     *  Status
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\DispositionCode $dispositionCode
     */
     ...
     *  Code. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\FullnessIndicationCode $fullnessIndicationCode
     */
     ...
     *  Percent. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\AirFlowPercent $airFlowPercent
     */
     ...
     *  Percent. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\HumidityPercent $humidityPercent
     */
     ...
     *  Text. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\Characteristics $characteristics
     */
     ...
     *  Text. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\DamageRemarks[] $damageRemarks
     */
     ...
     *  Text. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\SpecialTransportRequirements[] $specialTransportRequirements
     */
     ...
     *  Measure. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\TareWeightMeasure $tareWeightMeasure
     */
     ...
     *  Code. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\TrackingDeviceCode $trackingDeviceCode
     */
     ...
     *  Identifier. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\TraceID $traceID
     */
     ...
     *  Dimension
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\MeasurementDimension[] $measurementDimension
     */
     ...
     *  Transport Equipment Seal
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\TransportEquipmentSeal[] $transportEquipmentSeal
     */
     ...
     *  Temperature
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\MinimumTemperature $minimumTemperature
     */
     ...
     *  Temperature
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\MaximumTemperature $maximumTemperature
     */
     ...
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\LoadingProofParty $loadingProofParty
     */
     ...
     *  Party responsible for proof of vanning (WCO ID 059)
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\SupplierParty $supplierParty
     */
     ...
     *  Party responsible for proof of vanning (WCO ID 059)
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\OwnerParty $ownerParty
     */
     ...
     *  Party responsible for proof of vanning (WCO ID 059)
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\OperatingParty $operatingParty
     */
     ...
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\LoadingLocation $loadingLocation
     */
     ...
     *  Location
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\UnloadingLocation $unloadingLocation
     */
     ...
     *  Location
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\StorageLocation $storageLocation
     */
     ...
     *  Transport Event
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\PositioningTransportEvent[] $positioningTransportEvent
     */
     ...
     *  Transport Event
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\QuarantineTransportEvent[] $quarantineTransportEvent
     */
     ...
     *  Transport Event
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\PickupTransportEvent[] $pickupTransportEvent
     */
     ...
     *  Transport Event
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\HandlingTransportEvent[] $handlingTransportEvent
     */
     ...
     *  Transport Means
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ApplicableTransportMeans $applicableTransportMeans
     */
     ...
     *  Trading Terms
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\HaulageTradingTerms[] $haulageTradingTerms
     */
     ...
     *  Hazardous Goods Transit
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\HazardousGoodsTransit[] $hazardousGoodsTransit
     */
     ...
     *  Transport Handling Unit
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\PackagedTransportHandlingUnit[] $packagedTransportHandlingUnit
     */
     ...
     *  Allowance Charge
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ServiceAllowanceCharge[] $serviceAllowanceCharge
     */
     ...
     *  Transport Equipment
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\AttachedTransportEquipment[] $attachedTransportEquipment
     */
     ...
     *  Pickup
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\Pickup $pickup
     */
    private $pickup = null;
     ...
     *  Despatch
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\Despatch $despatch
     */
     ...
     *  Document Reference
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ShipmentDocumentReference[] $shipmentDocumentReference
     */
     ...
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ContainedInTransportEquipment[] $containedInTransportEquipment
     */
     ...
     *  Package
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\Package[] $package
     */
    private $package = [
     ...
     *  Goods Item
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\GoodsItem[] $goodsItem
     */
    private $goodsItem = [
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ReferencedConsignmentID $referencedConsignmentID
     */
    public function addToReferencedConsignmentID(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ReferencedConsignmentID $referencedConsignmentID)
    {
     ...
     *  Identifier. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ReferencedConsignmentID[]
     */
     ...
     *  Transport Equipment Type_ Code. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\TransportEquipmentTypeCode
     */
     ...
     *  Transport Equipment Type_ Code. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\TransportEquipmentTypeCode $transportEquipmentTypeCode
     * @return self
     */
    public function setTransportEquipmentTypeCode(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\TransportEquipmentTypeCode $transportEquipmentTypeCode = null)
    {
     ...
     *  Code. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ProviderTypeCode
     */
     ...
     *  Code. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ProviderTypeCode $providerTypeCode
     * @return self
     */
    public function setProviderTypeCode(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ProviderTypeCode $providerTypeCode = null)
    {
     ...
     *  Code. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\OwnerTypeCode
     */
     ...
     *  Code. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\OwnerTypeCode $ownerTypeCode
     * @return self
     */
    public function setOwnerTypeCode(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\OwnerTypeCode $ownerTypeCode = null)
    {
     ...
     *  Container Size Type Code
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\SizeTypeCode
     */
     ...
     *  Container Size Type Code
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\SizeTypeCode $sizeTypeCode
     * @return self
     */
    public function setSizeTypeCode(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\SizeTypeCode $sizeTypeCode = null)
    {
     ...
     *  Status
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\DispositionCode
     */
     ...
     *  Status
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\DispositionCode $dispositionCode
     * @return self
     */
    public function setDispositionCode(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\DispositionCode $dispositionCode = null)
    {
     ...
     *  Code. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\FullnessIndicationCode
     */
     ...
     *  Code. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\FullnessIndicationCode $fullnessIndicationCode
     * @return self
     */
    public function setFullnessIndicationCode(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\FullnessIndicationCode $fullnessIndicationCode = null)
    {
     ...
     *  Percent. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\AirFlowPercent
     */
     ...
     *  Percent. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\AirFlowPercent $airFlowPercent
     * @return self
     */
    public function setAirFlowPercent(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\AirFlowPercent $airFlowPercent = null)
    {
     ...
     *  Percent. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\HumidityPercent
     */
     ...
     *  Percent. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\HumidityPercent $humidityPercent
     * @return self
     */
    public function setHumidityPercent(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\HumidityPercent $humidityPercent = null)
    {
     ...
     *  Text. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\Characteristics
     */
     ...
     *  Text. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\Characteristics $characteristics
     * @return self
     */
    public function setCharacteristics(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\Characteristics $characteristics = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\DamageRemarks $damageRemarks
     */
    public function addToDamageRemarks(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\DamageRemarks $damageRemarks)
    {
     ...
     *  Text. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\DamageRemarks[]
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\SpecialTransportRequirements $specialTransportRequirements
     */
    public function addToSpecialTransportRequirements(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\SpecialTransportRequirements $specialTransportRequirements)
    {
     ...
     *  Text. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\SpecialTransportRequirements[]
     */
     ...
     *  Measure. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\TareWeightMeasure
     */
     ...
     *  Measure. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\TareWeightMeasure $tareWeightMeasure
     * @return self
     */
    public function setTareWeightMeasure(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\TareWeightMeasure $tareWeightMeasure = null)
    {
     ...
     *  Code. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\TrackingDeviceCode
     */
     ...
     *  Code. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\TrackingDeviceCode $trackingDeviceCode
     * @return self
     */
    public function setTrackingDeviceCode(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\TrackingDeviceCode $trackingDeviceCode = null)
    {
     ...
     *  Identifier. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\TraceID
     */
     ...
     *  Identifier. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\TraceID $traceID
     * @return self
     */
    public function setTraceID(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\TraceID $traceID = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\MeasurementDimension $measurementDimension
     */
    public function addToMeasurementDimension(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\MeasurementDimension $measurementDimension)
    {
     ...
     *  Dimension
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\MeasurementDimension[]
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\TransportEquipmentSeal $transportEquipmentSeal
     */
    public function addToTransportEquipmentSeal(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\TransportEquipmentSeal $transportEquipmentSeal)
    {
     ...
     *  Transport Equipment Seal
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\TransportEquipmentSeal[]
     */
     ...
     *  Temperature
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\MinimumTemperature
     */
     ...
     *  Temperature
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\MinimumTemperature $minimumTemperature
     * @return self
     */
    public function setMinimumTemperature(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\MinimumTemperature $minimumTemperature = null)
    {
     ...
     *  Temperature
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\MaximumTemperature
     */
     ...
     *  Temperature
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\MaximumTemperature $maximumTemperature
     * @return self
     */
    public function setMaximumTemperature(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\MaximumTemperature $maximumTemperature = null)
    {
     ...
     * @return self
     */
    public function setProviderParty(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ProviderParty $providerParty = null)
    {
     ...
     *  Party responsible for proof of vanning (WCO ID 059)
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\LoadingProofParty
     */
     ...
     *  Party responsible for proof of vanning (WCO ID 059)
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\LoadingProofParty $loadingProofParty
     * @return self
     */
    public function setLoadingProofParty(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\LoadingProofParty $loadingProofParty = null)
    {
     ...
     *  Party responsible for proof of vanning (WCO ID 059)
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\SupplierParty
     */
     ...
     *  Party responsible for proof of vanning (WCO ID 059)
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\SupplierParty $supplierParty
     * @return self
     */
    public function setSupplierParty(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\SupplierParty $supplierParty = null)
    {
     ...
     *  Party responsible for proof of vanning (WCO ID 059)
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\OwnerParty
     */
     ...
     *  Party responsible for proof of vanning (WCO ID 059)
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\OwnerParty $ownerParty
     * @return self
     */
    public function setOwnerParty(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\OwnerParty $ownerParty = null)
    {
     ...
     *  Party responsible for proof of vanning (WCO ID 059)
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\OperatingParty
     */
     ...
     *  Party responsible for proof of vanning (WCO ID 059)
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\OperatingParty $operatingParty
     * @return self
     */
    public function setOperatingParty(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\OperatingParty $operatingParty = null)
    {
     ...
     *  Vanning address (WCO ID 068), Stuffing location
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\LoadingLocation
     */
     ...
     *  Vanning address (WCO ID 068), Stuffing location
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\LoadingLocation $loadingLocation
     * @return self
     */
    public function setLoadingLocation(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\LoadingLocation $loadingLocation = null)
    {
     ...
     *  Location
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\UnloadingLocation
     */
     ...
     *  Location
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\UnloadingLocation $unloadingLocation
     * @return self
     */
    public function setUnloadingLocation(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\UnloadingLocation $unloadingLocation = null)
    {
     ...
     *  Location
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\StorageLocation
     */
     ...
     *  Location
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\StorageLocation $storageLocation
     * @return self
     */
    public function setStorageLocation(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\StorageLocation $storageLocation = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\PositioningTransportEvent $positioningTransportEvent
     */
    public function addToPositioningTransportEvent(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\PositioningTransportEvent $positioningTransportEvent)
    {
     ...
     *  Transport Event
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\PositioningTransportEvent[]
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\QuarantineTransportEvent $quarantineTransportEvent
     */
    public function addToQuarantineTransportEvent(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\QuarantineTransportEvent $quarantineTransportEvent)
    {
     ...
     *  Transport Event
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\QuarantineTransportEvent[]
     */
     ...
     */
    public function addToDeliveryTransportEvent(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\DeliveryTransportEvent $deliveryTransportEvent)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\PickupTransportEvent $pickupTransportEvent
     */
    public function addToPickupTransportEvent(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\PickupTransportEvent $pickupTransportEvent)
    {
     ...
     *  Transport Event
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\PickupTransportEvent[]
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\HandlingTransportEvent $handlingTransportEvent
     */
    public function addToHandlingTransportEvent(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\HandlingTransportEvent $handlingTransportEvent)
    {
     ...
     *  Transport Event
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\HandlingTransportEvent[]
     */
     ...
     */
    public function addToLoadingTransportEvent(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\LoadingTransportEvent $loadingTransportEvent)
    {
     ...
     *  Transport Means
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ApplicableTransportMeans
     */
     ...
     *  Transport Means
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ApplicableTransportMeans $applicableTransportMeans
     * @return self
     */
    public function setApplicableTransportMeans(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ApplicableTransportMeans $applicableTransportMeans = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\HaulageTradingTerms $haulageTradingTerms
     */
    public function addToHaulageTradingTerms(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\HaulageTradingTerms $haulageTradingTerms)
    {
     ...
     *  Trading Terms
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\HaulageTradingTerms[]
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\HazardousGoodsTransit $hazardousGoodsTransit
     */
    public function addToHazardousGoodsTransit(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\HazardousGoodsTransit $hazardousGoodsTransit)
    {
     ...
     *  Hazardous Goods Transit
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\HazardousGoodsTransit[]
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\PackagedTransportHandlingUnit $packagedTransportHandlingUnit
     */
    public function addToPackagedTransportHandlingUnit(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\PackagedTransportHandlingUnit $packagedTransportHandlingUnit)
    {
     ...
     *  Transport Handling Unit
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\PackagedTransportHandlingUnit[]
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ServiceAllowanceCharge $serviceAllowanceCharge
     */
    public function addToServiceAllowanceCharge(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ServiceAllowanceCharge $serviceAllowanceCharge)
    {
     ...
     *  Allowance Charge
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ServiceAllowanceCharge[]
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\AttachedTransportEquipment $attachedTransportEquipment
     */
    public function addToAttachedTransportEquipment(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\AttachedTransportEquipment $attachedTransportEquipment)
    {
     ...
     *  Transport Equipment
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\AttachedTransportEquipment[]
     */
     ...
     * @return self
     */
    public function setDelivery(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\Delivery $delivery = null)
    {
     ...
     *  Pickup
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\Pickup
     */
     ...
     *  Pickup
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\Pickup $pickup
     * @return self
     */
    public function setPickup(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\Pickup $pickup = null)
    {
        $this->pickup = $pickup;
        return $this;
    }
     ...
     *  Despatch
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\Despatch
     */
     ...
     *  Despatch
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\Despatch $despatch
     * @return self
     */
    public function setDespatch(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\Despatch $despatch = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ShipmentDocumentReference $shipmentDocumentReference
     */
    public function addToShipmentDocumentReference(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ShipmentDocumentReference $shipmentDocumentReference)
    {
     ...
     *  Document Reference
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ShipmentDocumentReference[]
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ContainedInTransportEquipment $containedInTransportEquipment
     */
    public function addToContainedInTransportEquipment(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ContainedInTransportEquipment $containedInTransportEquipment)
    {
     ...
     *  e.g. pallets inside containers
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ContainedInTransportEquipment[]
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\Package $package
     */
    public function addToPackage(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\Package $package)
    {
     ...
     *  Package
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\Package[]
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\GoodsItem $goodsItem
     */
    public function addToGoodsItem(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\GoodsItem $goodsItem)
    {
     ...
     *  Goods Item
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\GoodsItem[]
     */
