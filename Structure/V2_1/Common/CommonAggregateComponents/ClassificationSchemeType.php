...
class ClassificationSchemeType
{
     ...
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\AgencyID $agencyID
     */
     ...
     *  Text. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\AgencyName $agencyName
     */
     ...
     *  Identifier. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\SchemeURI $schemeURI
     */
     ...
     *  Classification Category
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ClassificationCategory[] $classificationCategory
     */
     ...
     *  Defaults to the UN/EDIFACT data element 3055 code list.
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\AgencyID
     */
     ...
     *  Defaults to the UN/EDIFACT data element 3055 code list.
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\AgencyID $agencyID
     * @return self
     */
    public function setAgencyID(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\AgencyID $agencyID = null)
    {
     ...
     *  Text. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\AgencyName
     */
     ...
     *  Text. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\AgencyName $agencyName
     * @return self
     */
    public function setAgencyName(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\AgencyName $agencyName = null)
    {
     ...
     *  Identifier. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\SchemeURI
     */
     ...
     *  Identifier. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\SchemeURI $schemeURI
     * @return self
     */
    public function setSchemeURI(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\SchemeURI $schemeURI = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ClassificationCategory $classificationCategory
     */
    public function addToClassificationCategory(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ClassificationCategory $classificationCategory)
    {
     ...
     *  Classification Category
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ClassificationCategory[]
     */
