...
class TaxTotalType
{
     ...
     *  Amount. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\RoundingAmount $roundingAmount
     */
     ...
     *  Tax Subtotal
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\TaxSubtotal[] $taxSubtotal
     */
    private $taxSubtotal = [
     ...
     *  Amount. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\RoundingAmount
     */
     ...
     *  Amount. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\RoundingAmount $roundingAmount
     * @return self
     */
    public function setRoundingAmount(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\RoundingAmount $roundingAmount = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\TaxSubtotal $taxSubtotal
     */
    public function addToTaxSubtotal(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\TaxSubtotal $taxSubtotal)
    {
     ...
     *  Tax Subtotal
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\TaxSubtotal[]
     */
