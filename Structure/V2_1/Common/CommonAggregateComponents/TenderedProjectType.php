...
class TenderedProjectType
{
     ...
     *  Identifier. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\VariantID $variantID
     */
     ...
     *  Amount. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\FeeAmount $feeAmount
     */
     ...
     *  Identifier. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\TenderEnvelopeID $tenderEnvelopeID
     */
     ...
     *  Code. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\TenderEnvelopeTypeCode $tenderEnvelopeTypeCode
     */
     ...
     *  Document Reference
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\EvidenceDocumentReference[] $evidenceDocumentReference
     */
     ...
     *  Tender Line
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\TenderLine[] $tenderLine
     */
    private $tenderLine = [
     ...
     *  Awarding Criterion Response
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\AwardingCriterionResponse[] $awardingCriterionResponse
     */
     ...
     *  Identifier. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\VariantID
     */
     ...
     *  Identifier. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\VariantID $variantID
     * @return self
     */
    public function setVariantID(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\VariantID $variantID = null)
    {
     ...
     *  Amount. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\FeeAmount
     */
     ...
     *  Amount. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\FeeAmount $feeAmount
     * @return self
     */
    public function setFeeAmount(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\FeeAmount $feeAmount = null)
    {
     ...
     *  Identifier. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\TenderEnvelopeID
     */
     ...
     *  Identifier. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\TenderEnvelopeID $tenderEnvelopeID
     * @return self
     */
    public function setTenderEnvelopeID(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\TenderEnvelopeID $tenderEnvelopeID = null)
    {
     ...
     *  Code. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\TenderEnvelopeTypeCode
     */
     ...
     *  Code. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\TenderEnvelopeTypeCode $tenderEnvelopeTypeCode
     * @return self
     */
    public function setTenderEnvelopeTypeCode(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\TenderEnvelopeTypeCode $tenderEnvelopeTypeCode = null)
    {
     ...
     * @return self
     */
    public function setProcurementProjectLot(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ProcurementProjectLot $procurementProjectLot = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\EvidenceDocumentReference $evidenceDocumentReference
     */
    public function addToEvidenceDocumentReference(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\EvidenceDocumentReference $evidenceDocumentReference)
    {
     ...
     *  Document Reference
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\EvidenceDocumentReference[]
     */
     ...
     * @return self
     */
    public function setLegalMonetaryTotal(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\LegalMonetaryTotal $legalMonetaryTotal = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\TenderLine $tenderLine
     */
    public function addToTenderLine(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\TenderLine $tenderLine)
    {
     ...
     *  Tender Line
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\TenderLine[]
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\AwardingCriterionResponse $awardingCriterionResponse
     */
    public function addToAwardingCriterionResponse(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\AwardingCriterionResponse $awardingCriterionResponse)
    {
     ...
     *  Awarding Criterion Response
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\AwardingCriterionResponse[]
     */
