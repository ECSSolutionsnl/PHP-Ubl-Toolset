...
class PriceType
{
     ...
     *  Quantity. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\BaseQuantity $baseQuantity
     */
     ...
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\PriceChangeReason[] $priceChangeReason
     */
     ...
     *  Code. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\PriceTypeCode $priceTypeCode
     */
     ...
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\PriceType $priceType
     */
     ...
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\OrderableUnitFactorRate $orderableUnitFactorRate
     */
     ...
     *  Price List
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\PriceList $priceList
     */
     ...
     * @return self
     */
    public function setPriceAmount(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\PriceAmount $priceAmount)
    {
     ...
     *  Quantity. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\BaseQuantity
     */
     ...
     *  Quantity. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\BaseQuantity $baseQuantity
     * @return self
     */
    public function setBaseQuantity(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\BaseQuantity $baseQuantity = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\PriceChangeReason $priceChangeReason
     */
    public function addToPriceChangeReason(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\PriceChangeReason $priceChangeReason)
    {
     ...
     *  Clearance of old stock , New contract applies
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\PriceChangeReason[]
     */
     ...
     *  Code. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\PriceTypeCode
     */
     ...
     *  Code. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\PriceTypeCode $priceTypeCode
     * @return self
     */
    public function setPriceTypeCode(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\PriceTypeCode $priceTypeCode = null)
    {
     ...
     *  retail, wholesale, discount, contract
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\PriceType
     */
     ...
     *  retail, wholesale, discount, contract
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\PriceType $priceType
     * @return self
     */
    public function setPriceType(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\PriceType $priceType = null)
    {
     ...
     *  Nails are priced by weight but ordered by quantity. So this would say how many nails per kilo
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\OrderableUnitFactorRate
     */
     ...
     *  Nails are priced by weight but ordered by quantity. So this would say how many nails per kilo
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\OrderableUnitFactorRate $orderableUnitFactorRate
     * @return self
     */
    public function setOrderableUnitFactorRate(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\OrderableUnitFactorRate $orderableUnitFactorRate = null)
    {
     ...
     *  Price List
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\PriceList
     */
     ...
     *  Price List
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\PriceList $priceList
     * @return self
     */
    public function setPriceList(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\PriceList $priceList = null)
    {
