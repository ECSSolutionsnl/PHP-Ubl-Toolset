...
class DeliveryTermsType
{
     ...
     *  Text. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\SpecialTerms[] $specialTerms
     */
     ...
     *  Code. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\LossRiskResponsibilityCode $lossRiskResponsibilityCode
     */
     ...
     *  Text. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\LossRisk[] $lossRisk
     */
    private $lossRisk = [
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\SpecialTerms $specialTerms
     */
    public function addToSpecialTerms(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\SpecialTerms $specialTerms)
    {
     ...
     *  Text. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\SpecialTerms[]
     */
     ...
     *  Code. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\LossRiskResponsibilityCode
     */
     ...
     *  Code. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\LossRiskResponsibilityCode $lossRiskResponsibilityCode
     * @return self
     */
    public function setLossRiskResponsibilityCode(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\LossRiskResponsibilityCode $lossRiskResponsibilityCode = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\LossRisk $lossRisk
     */
    public function addToLossRisk(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\LossRisk $lossRisk)
    {
     ...
     *  Text. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\LossRisk[]
     */
     ...
     * @return self
     */
    public function setAllowanceCharge(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\AllowanceCharge $allowanceCharge = null)
    {
