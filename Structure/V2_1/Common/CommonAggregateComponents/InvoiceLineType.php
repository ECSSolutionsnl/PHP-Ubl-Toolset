...
class InvoiceLineType
{
     ...
     *  Quantity. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\InvoicedQuantity $invoicedQuantity
     */
     ...
     *  Code. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\PaymentPurposeCode $paymentPurposeCode
     */
     ...
     *  Line Reference
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ReceiptLineReference[] $receiptLineReference
     */
     ...
     *  Tax Total
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\WithholdingTaxTotal[] $withholdingTaxTotal
     */
     ...
     *  Invoice Line
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\SubInvoiceLine[] $subInvoiceLine
     */
     ...
     *  Quantity. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\InvoicedQuantity
     */
     ...
     *  Quantity. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\InvoicedQuantity $invoicedQuantity
     * @return self
     */
    public function setInvoicedQuantity(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\InvoicedQuantity $invoicedQuantity = null)
    {
     ...
     * @return self
     */
    public function setLineExtensionAmount(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\LineExtensionAmount $lineExtensionAmount)
    {
     ...
     *  Code. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\PaymentPurposeCode
     */
     ...
     *  Code. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\PaymentPurposeCode $paymentPurposeCode
     * @return self
     */
    public function setPaymentPurposeCode(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\PaymentPurposeCode $paymentPurposeCode = null)
    {
     ...
     */
    public function addToOrderLineReference(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\OrderLineReference $orderLineReference)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ReceiptLineReference $receiptLineReference
     */
    public function addToReceiptLineReference(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ReceiptLineReference $receiptLineReference)
    {
     ...
     *  Line Reference
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ReceiptLineReference[]
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\WithholdingTaxTotal $withholdingTaxTotal
     */
    public function addToWithholdingTaxTotal(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\WithholdingTaxTotal $withholdingTaxTotal)
    {
     ...
     *  Tax Total
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\WithholdingTaxTotal[]
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\SubInvoiceLine $subInvoiceLine
     */
    public function addToSubInvoiceLine(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\SubInvoiceLine $subInvoiceLine)
    {
     ...
     *  Invoice Line
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\SubInvoiceLine[]
     */
