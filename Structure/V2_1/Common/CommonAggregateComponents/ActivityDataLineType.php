...
class ActivityDataLineType
{
     ...
     *  Period
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ActivityPeriod $activityPeriod
     */
     ...
     *  Location
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ActivityOriginLocation $activityOriginLocation
     */
     ...
     *  Location
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ActivityFinalLocation $activityFinalLocation
     */
     ...
     *  Sales Item
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\SalesItem[] $salesItem
     */
    private $salesItem = [
     ...
     * @return self
     */
    public function setSupplyChainActivityTypeCode(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\SupplyChainActivityTypeCode $supplyChainActivityTypeCode)
    {
     ...
     *  Period
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ActivityPeriod
     */
     ...
     *  Period
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ActivityPeriod $activityPeriod
     * @return self
     */
    public function setActivityPeriod(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ActivityPeriod $activityPeriod = null)
    {
     ...
     *  Location
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ActivityOriginLocation
     */
     ...
     *  Location
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ActivityOriginLocation $activityOriginLocation
     * @return self
     */
    public function setActivityOriginLocation(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ActivityOriginLocation $activityOriginLocation)
    {
     ...
     *  Location
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ActivityFinalLocation
     */
     ...
     *  Location
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ActivityFinalLocation $activityFinalLocation
     * @return self
     */
    public function setActivityFinalLocation(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ActivityFinalLocation $activityFinalLocation = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\SalesItem $salesItem
     */
    public function addToSalesItem(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\SalesItem $salesItem)
    {
     ...
     *  Sales Item
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\SalesItem[]
     */
