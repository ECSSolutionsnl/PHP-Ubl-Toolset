...
class RequestForTenderLineType
{
     ...
     *  Amount. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\EstimatedAmount $estimatedAmount
     */
     ...
     *  Period
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\DeliveryPeriod[] $deliveryPeriod
     */
     ...
     *  Request For Tender Line
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\SubRequestForTenderLine[] $subRequestForTenderLine
     */
     ...
     *  Amount. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\EstimatedAmount
     */
     ...
     *  Amount. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\EstimatedAmount $estimatedAmount
     * @return self
     */
    public function setEstimatedAmount(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\EstimatedAmount $estimatedAmount = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\DeliveryPeriod $deliveryPeriod
     */
    public function addToDeliveryPeriod(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\DeliveryPeriod $deliveryPeriod)
    {
     ...
     *  Period
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\DeliveryPeriod[]
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\SubRequestForTenderLine $subRequestForTenderLine
     */
    public function addToSubRequestForTenderLine(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\SubRequestForTenderLine $subRequestForTenderLine)
    {
     ...
     *  Request For Tender Line
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\SubRequestForTenderLine[]
     */
