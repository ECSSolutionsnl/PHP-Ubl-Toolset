...
class SignatureType
{
     ...
     *  Identifier. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ValidatorID $validatorID
     */
     ...
     *  Text. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\CanonicalizationMethod $canonicalizationMethod
     */
     ...
     *  Text. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\SignatureMethod $signatureMethod
     */
     ...
     *  Party
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\SignatoryParty $signatoryParty
     */
     ...
     *  Attachment
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\DigitalSignatureAttachment $digitalSignatureAttachment
     */
     ...
     *  Identifier. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ValidatorID
     */
     ...
     *  Identifier. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ValidatorID $validatorID
     * @return self
     */
    public function setValidatorID(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ValidatorID $validatorID = null)
    {
     ...
     *  Text. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\CanonicalizationMethod
     */
     ...
     *  Text. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\CanonicalizationMethod $canonicalizationMethod
     * @return self
     */
    public function setCanonicalizationMethod(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\CanonicalizationMethod $canonicalizationMethod = null)
    {
     ...
     *  Text. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\SignatureMethod
     */
     ...
     *  Text. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\SignatureMethod $signatureMethod
     * @return self
     */
    public function setSignatureMethod(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\SignatureMethod $signatureMethod = null)
    {
     ...
     *  Party
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\SignatoryParty
     */
     ...
     *  Party
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\SignatoryParty $signatoryParty
     * @return self
     */
    public function setSignatoryParty(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\SignatoryParty $signatoryParty = null)
    {
     ...
     *  Attachment
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\DigitalSignatureAttachment
     */
     ...
     *  Attachment
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\DigitalSignatureAttachment $digitalSignatureAttachment
     * @return self
     */
    public function setDigitalSignatureAttachment(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\DigitalSignatureAttachment $digitalSignatureAttachment = null)
    {
     ...
     * @return self
     */
    public function setOriginalDocumentReference(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\OriginalDocumentReference $originalDocumentReference = null)
    {
