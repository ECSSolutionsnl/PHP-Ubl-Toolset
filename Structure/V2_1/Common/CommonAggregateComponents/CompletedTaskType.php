...
class CompletedTaskType
{
     ...
     *  Amount. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\AnnualAverageAmount $annualAverageAmount
     */
     ...
     *  Amount. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\TotalTaskAmount $totalTaskAmount
     */
     ...
     *  Amount. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\PartyCapacityAmount $partyCapacityAmount
     */
     ...
     *  Evidence Supplied
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\EvidenceSupplied[] $evidenceSupplied
     */
     ...
     *  Customer Party
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\RecipientCustomerParty $recipientCustomerParty
     */
     ...
     *  Amount. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\AnnualAverageAmount
     */
     ...
     *  Amount. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\AnnualAverageAmount $annualAverageAmount
     * @return self
     */
    public function setAnnualAverageAmount(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\AnnualAverageAmount $annualAverageAmount = null)
    {
     ...
     *  Amount. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\TotalTaskAmount
     */
     ...
     *  Amount. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\TotalTaskAmount $totalTaskAmount
     * @return self
     */
    public function setTotalTaskAmount(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\TotalTaskAmount $totalTaskAmount = null)
    {
     ...
     *  Amount. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\PartyCapacityAmount
     */
     ...
     *  Amount. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\PartyCapacityAmount $partyCapacityAmount
     * @return self
     */
    public function setPartyCapacityAmount(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\PartyCapacityAmount $partyCapacityAmount = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\EvidenceSupplied $evidenceSupplied
     */
    public function addToEvidenceSupplied(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\EvidenceSupplied $evidenceSupplied)
    {
     ...
     *  Evidence Supplied
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\EvidenceSupplied[]
     */
     ...
     *  Customer Party
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\RecipientCustomerParty
     */
     ...
     *  Customer Party
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\RecipientCustomerParty $recipientCustomerParty
     * @return self
     */
    public function setRecipientCustomerParty(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\RecipientCustomerParty $recipientCustomerParty = null)
    {
