...
class TenderingProcessType
{
     ...
     *  Identifier. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\OriginalContractingSystemID $originalContractingSystemID
     */
     ...
     *  Text. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\NegotiationDescription[] $negotiationDescription
     */
     ...
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ProcedureCode $procedureCode
     */
     ...
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\UrgencyCode $urgencyCode
     */
     ...
     *  Normal, Anticipated
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ExpenseCode $expenseCode
     */
     ...
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\PartPresentationCode $partPresentationCode
     */
     ...
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ContractingSystemCode $contractingSystemCode
     */
     ...
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\SubmissionMethodCode $submissionMethodCode
     */
     ...
     *  Period
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\DocumentAvailabilityPeriod $documentAvailabilityPeriod
     */
     ...
     *  Period
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\TenderSubmissionDeadlinePeriod $tenderSubmissionDeadlinePeriod
     */
     ...
     *  Period
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\InvitationSubmissionPeriod $invitationSubmissionPeriod
     */
     ...
     *  Period
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ParticipationRequestReceptionPeriod $participationRequestReceptionPeriod
     */
     ...
     *  Document Reference
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\NoticeDocumentReference[] $noticeDocumentReference
     */
     ...
     *  Process Justification
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ProcessJustification[] $processJustification
     */
     ...
     *  Economic Operator Short List
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\EconomicOperatorShortList $economicOperatorShortList
     */
     ...
     *  Event
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\OpenTenderEvent[] $openTenderEvent
     */
     ...
     *  Auction Terms
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\AuctionTerms $auctionTerms
     */
     ...
     *  Framework Agreement
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\FrameworkAgreement $frameworkAgreement
     */
     ...
     *  Identifier. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\OriginalContractingSystemID
     */
     ...
     *  Identifier. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\OriginalContractingSystemID $originalContractingSystemID
     * @return self
     */
    public function setOriginalContractingSystemID(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\OriginalContractingSystemID $originalContractingSystemID = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\NegotiationDescription $negotiationDescription
     */
    public function addToNegotiationDescription(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\NegotiationDescription $negotiationDescription)
    {
     ...
     *  Text. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\NegotiationDescription[]
     */
     ...
     *  Open, Restricted, Negotiated
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ProcedureCode
     */
     ...
     *  Open, Restricted, Negotiated
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ProcedureCode $procedureCode
     * @return self
     */
    public function setProcedureCode(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ProcedureCode $procedureCode = null)
    {
     ...
     *  Urgent, Normal, Emergency
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\UrgencyCode
     */
     ...
     *  Urgent, Normal, Emergency
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\UrgencyCode $urgencyCode
     * @return self
     */
    public function setUrgencyCode(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\UrgencyCode $urgencyCode = null)
    {
     ...
     *  Normal, Anticipated
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ExpenseCode
     */
     ...
     *  Normal, Anticipated
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ExpenseCode $expenseCode
     * @return self
     */
    public function setExpenseCode(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ExpenseCode $expenseCode = null)
    {
     ...
     *  One Lot, Multiple Lots, All Lots
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\PartPresentationCode
     */
     ...
     *  One Lot, Multiple Lots, All Lots
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\PartPresentationCode $partPresentationCode
     * @return self
     */
    public function setPartPresentationCode(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\PartPresentationCode $partPresentationCode = null)
    {
     ...
     *  Framework Agreement, Dynamic Purchasing System
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ContractingSystemCode
     */
     ...
     *  Framework Agreement, Dynamic Purchasing System
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ContractingSystemCode $contractingSystemCode
     * @return self
     */
    public function setContractingSystemCode(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ContractingSystemCode $contractingSystemCode = null)
    {
     ...
     *  Manual, Electronically, etc.
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\SubmissionMethodCode
     */
     ...
     *  Manual, Electronically, etc.
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\SubmissionMethodCode $submissionMethodCode
     * @return self
     */
    public function setSubmissionMethodCode(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\SubmissionMethodCode $submissionMethodCode = null)
    {
     ...
     *  Period
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\DocumentAvailabilityPeriod
     */
     ...
     *  Period
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\DocumentAvailabilityPeriod $documentAvailabilityPeriod
     * @return self
     */
    public function setDocumentAvailabilityPeriod(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\DocumentAvailabilityPeriod $documentAvailabilityPeriod = null)
    {
     ...
     *  Period
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\TenderSubmissionDeadlinePeriod
     */
     ...
     *  Period
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\TenderSubmissionDeadlinePeriod $tenderSubmissionDeadlinePeriod
     * @return self
     */
    public function setTenderSubmissionDeadlinePeriod(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\TenderSubmissionDeadlinePeriod $tenderSubmissionDeadlinePeriod = null)
    {
     ...
     *  Period
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\InvitationSubmissionPeriod
     */
     ...
     *  Period
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\InvitationSubmissionPeriod $invitationSubmissionPeriod
     * @return self
     */
    public function setInvitationSubmissionPeriod(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\InvitationSubmissionPeriod $invitationSubmissionPeriod = null)
    {
     ...
     *  Period
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ParticipationRequestReceptionPeriod
     */
     ...
     *  Period
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ParticipationRequestReceptionPeriod $participationRequestReceptionPeriod
     * @return self
     */
    public function setParticipationRequestReceptionPeriod(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ParticipationRequestReceptionPeriod $participationRequestReceptionPeriod = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\NoticeDocumentReference $noticeDocumentReference
     */
    public function addToNoticeDocumentReference(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\NoticeDocumentReference $noticeDocumentReference)
    {
     ...
     *  Document Reference
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\NoticeDocumentReference[]
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ProcessJustification $processJustification
     */
    public function addToProcessJustification(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ProcessJustification $processJustification)
    {
     ...
     *  Process Justification
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ProcessJustification[]
     */
     ...
     *  Economic Operator Short List
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\EconomicOperatorShortList
     */
     ...
     *  Economic Operator Short List
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\EconomicOperatorShortList $economicOperatorShortList
     * @return self
     */
    public function setEconomicOperatorShortList(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\EconomicOperatorShortList $economicOperatorShortList = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\OpenTenderEvent $openTenderEvent
     */
    public function addToOpenTenderEvent(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\OpenTenderEvent $openTenderEvent)
    {
     ...
     *  Event
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\OpenTenderEvent[]
     */
     ...
     *  Auction Terms
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\AuctionTerms
     */
     ...
     *  Auction Terms
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\AuctionTerms $auctionTerms
     * @return self
     */
    public function setAuctionTerms(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\AuctionTerms $auctionTerms = null)
    {
     ...
     *  Framework Agreement
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\FrameworkAgreement
     */
     ...
     *  Framework Agreement
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\FrameworkAgreement $frameworkAgreement
     * @return self
     */
    public function setFrameworkAgreement(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\FrameworkAgreement $frameworkAgreement = null)
    {
