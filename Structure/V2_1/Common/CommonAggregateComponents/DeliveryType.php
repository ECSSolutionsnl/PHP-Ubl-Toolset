...
class DeliveryType
{
     ...
     *  Identifier. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ReleaseID $releaseID
     */
     ...
     *  Address
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\DeliveryAddress $deliveryAddress
     */
     ...
     *  Location
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\DeliveryLocation $deliveryLocation
     */
     ...
     *  Location
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\AlternativeDeliveryLocation $alternativeDeliveryLocation
     */
     ...
     *  Period
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\RequestedDeliveryPeriod $requestedDeliveryPeriod
     */
     ...
     *  Period
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\PromisedDeliveryPeriod $promisedDeliveryPeriod
     */
     ...
     *  Period
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\EstimatedDeliveryPeriod $estimatedDeliveryPeriod
     */
     ...
     *  Party
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\DeliveryParty $deliveryParty
     */
     ...
     *  Delivery Unit
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\MinimumDeliveryUnit $minimumDeliveryUnit
     */
     ...
     *  Delivery Unit
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\MaximumDeliveryUnit $maximumDeliveryUnit
     */
     ...
     *  Identifier. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ReleaseID
     */
     ...
     *  Identifier. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ReleaseID $releaseID
     * @return self
     */
    public function setReleaseID(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ReleaseID $releaseID = null)
    {
     ...
     *  Address
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\DeliveryAddress
     */
     ...
     *  Address
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\DeliveryAddress $deliveryAddress
     * @return self
     */
    public function setDeliveryAddress(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\DeliveryAddress $deliveryAddress = null)
    {
     ...
     *  Location
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\DeliveryLocation
     */
     ...
     *  Location
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\DeliveryLocation $deliveryLocation
     * @return self
     */
    public function setDeliveryLocation(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\DeliveryLocation $deliveryLocation = null)
    {
     ...
     *  Location
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\AlternativeDeliveryLocation
     */
     ...
     *  Location
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\AlternativeDeliveryLocation $alternativeDeliveryLocation
     * @return self
     */
    public function setAlternativeDeliveryLocation(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\AlternativeDeliveryLocation $alternativeDeliveryLocation = null)
    {
     ...
     *  Period
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\RequestedDeliveryPeriod
     */
     ...
     *  Period
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\RequestedDeliveryPeriod $requestedDeliveryPeriod
     * @return self
     */
    public function setRequestedDeliveryPeriod(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\RequestedDeliveryPeriod $requestedDeliveryPeriod = null)
    {
     ...
     *  Period
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\PromisedDeliveryPeriod
     */
     ...
     *  Period
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\PromisedDeliveryPeriod $promisedDeliveryPeriod
     * @return self
     */
    public function setPromisedDeliveryPeriod(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\PromisedDeliveryPeriod $promisedDeliveryPeriod = null)
    {
     ...
     *  Period
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\EstimatedDeliveryPeriod
     */
     ...
     *  Period
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\EstimatedDeliveryPeriod $estimatedDeliveryPeriod
     * @return self
     */
    public function setEstimatedDeliveryPeriod(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\EstimatedDeliveryPeriod $estimatedDeliveryPeriod = null)
    {
     ...
     *  Party
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\DeliveryParty
     */
     ...
     *  Party
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\DeliveryParty $deliveryParty
     * @return self
     */
    public function setDeliveryParty(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\DeliveryParty $deliveryParty = null)
    {
     ...
     */
    public function addToNotifyParty(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\NotifyParty $notifyParty)
    {
     ...
     *  Delivery Unit
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\MinimumDeliveryUnit
     */
     ...
     *  Delivery Unit
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\MinimumDeliveryUnit $minimumDeliveryUnit
     * @return self
     */
    public function setMinimumDeliveryUnit(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\MinimumDeliveryUnit $minimumDeliveryUnit = null)
    {
     ...
     *  Delivery Unit
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\MaximumDeliveryUnit
     */
     ...
     *  Delivery Unit
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\MaximumDeliveryUnit $maximumDeliveryUnit
     * @return self
     */
    public function setMaximumDeliveryUnit(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\MaximumDeliveryUnit $maximumDeliveryUnit = null)
    {
