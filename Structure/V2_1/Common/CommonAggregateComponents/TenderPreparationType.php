...
class TenderPreparationType
{
     ...
     *  Identifier. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\OpenTenderID $openTenderID
     */
     ...
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\DocumentTenderRequirement[] $documentTenderRequirement
     */
     ...
     * @return self
     */
    public function setTenderEnvelopeID(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\TenderEnvelopeID $tenderEnvelopeID)
    {
     ...
     *  Identifier. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\OpenTenderID
     */
     ...
     *  Identifier. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\OpenTenderID $openTenderID
     * @return self
     */
    public function setOpenTenderID(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\OpenTenderID $openTenderID = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\DocumentTenderRequirement $documentTenderRequirement
     */
    public function addToDocumentTenderRequirement(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\DocumentTenderRequirement $documentTenderRequirement)
    {
     ...
     *  Curricula required, Experience required, ....
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\DocumentTenderRequirement[]
     */
