...
class PromotionalSpecificationType
{
     ...
     *  Identifier. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\SpecificationID $specificationID
     */
     ...
     *  Promotional Event Line Item
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\PromotionalEventLineItem[] $promotionalEventLineItem
     */
     ...
     *  Event Tactic
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\EventTactic[] $eventTactic
     */
    private $eventTactic = [
     ...
     *  Identifier. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\SpecificationID
     */
     ...
     *  Identifier. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\SpecificationID $specificationID
     * @return self
     */
    public function setSpecificationID(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\SpecificationID $specificationID = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\PromotionalEventLineItem $promotionalEventLineItem
     */
    public function addToPromotionalEventLineItem(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\PromotionalEventLineItem $promotionalEventLineItem)
    {
     ...
     *  Promotional Event Line Item
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\PromotionalEventLineItem[]
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\EventTactic $eventTactic
     */
    public function addToEventTactic(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\EventTactic $eventTactic)
    {
     ...
     *  Event Tactic
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\EventTactic[]
     */
