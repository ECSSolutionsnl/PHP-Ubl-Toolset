...
class DeliveryUnitType
{
     ...
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\BatchQuantity $batchQuantity
     */
     ...
     *  packs of 10
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ConsumerUnitQuantity $consumerUnitQuantity
     */
     ...
     *  100 units , by the dozen
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\BatchQuantity
     */
     ...
     *  100 units , by the dozen
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\BatchQuantity $batchQuantity
     * @return self
     */
    public function setBatchQuantity(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\BatchQuantity $batchQuantity)
    {
     ...
     *  packs of 10
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ConsumerUnitQuantity
     */
     ...
     *  packs of 10
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ConsumerUnitQuantity $consumerUnitQuantity
     * @return self
     */
    public function setConsumerUnitQuantity(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ConsumerUnitQuantity $consumerUnitQuantity = null)
    {
