...
class OrderLineReferenceType
{
     ...
     *  Identifier. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\LineID $lineID
     */
    private $lineID = null;
     ...
     *  Identifier. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\SalesOrderLineID $salesOrderLineID
     */
     ...
     *  Identifier. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\LineID
     */
     ...
     *  Identifier. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\LineID $lineID
     * @return self
     */
    public function setLineID(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\LineID $lineID)
    {
        $this->lineID = $lineID;
        return $this;
    }
     ...
     *  Identifier. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\SalesOrderLineID
     */
     ...
     *  Identifier. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\SalesOrderLineID $salesOrderLineID
     * @return self
     */
    public function setSalesOrderLineID(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\SalesOrderLineID $salesOrderLineID = null)
    {
