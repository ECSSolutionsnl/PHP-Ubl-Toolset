...
class EventTacticType
{
     ...
     *  Text. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\Comment $comment
     */
     ...
     *  Event Tactic Enumeration
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\EventTacticEnumeration $eventTacticEnumeration
     */
     ...
     *  Text. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\Comment
     */
     ...
     *  Text. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\Comment $comment
     * @return self
     */
    public function setComment(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\Comment $comment = null)
    {
     ...
     *  Event Tactic Enumeration
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\EventTacticEnumeration
     */
     ...
     *  Event Tactic Enumeration
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\EventTacticEnumeration $eventTacticEnumeration
     * @return self
     */
    public function setEventTacticEnumeration(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\EventTacticEnumeration $eventTacticEnumeration)
    {
