...
class ClauseType
{
     ...
     *  Text. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\Content[] $content
     */
    private $content = [
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\Content $content
     */
    public function addToContent(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\Content $content)
    {
     ...
     *  Text. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\Content[]
     */
