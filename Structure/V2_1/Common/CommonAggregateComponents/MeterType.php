...
class MeterType
{
     ...
     *  Text. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\MeterName $meterName
     */
     ...
     *  1.000
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\MeterConstant $meterConstant
     */
     ...
     *  Factor
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\MeterConstantCode $meterConstantCode
     */
     ...
     *  Meter Reading
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\MeterReading[] $meterReading
     */
     ...
     *  Meter Property
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\MeterProperty[] $meterProperty
     */
     ...
     *  Text. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\MeterName
     */
     ...
     *  Text. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\MeterName $meterName
     * @return self
     */
    public function setMeterName(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\MeterName $meterName = null)
    {
     ...
     *  1.000
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\MeterConstant
     */
     ...
     *  1.000
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\MeterConstant $meterConstant
     * @return self
     */
    public function setMeterConstant(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\MeterConstant $meterConstant = null)
    {
     ...
     *  Factor
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\MeterConstantCode
     */
     ...
     *  Factor
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\MeterConstantCode $meterConstantCode
     * @return self
     */
    public function setMeterConstantCode(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\MeterConstantCode $meterConstantCode = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\MeterReading $meterReading
     */
    public function addToMeterReading(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\MeterReading $meterReading)
    {
     ...
     *  Meter Reading
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\MeterReading[]
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\MeterProperty $meterProperty
     */
    public function addToMeterProperty(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\MeterProperty $meterProperty)
    {
     ...
     *  Meter Property
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\MeterProperty[]
     */
