...
class PartyLegalEntityType
{
     ...
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\RegistrationName $registrationName
     */
     ...
     *  3556625
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\CompanyID $companyID
     */
     ...
     *  Code. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\CompanyLiquidationStatusCode $companyLiquidationStatusCode
     */
     ...
     *  Amount. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\CorporateStockAmount $corporateStockAmount
     */
     ...
     *  Address
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\RegistrationAddress $registrationAddress
     */
     ...
     *  Corporate Registration Scheme
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\CorporateRegistrationScheme $corporateRegistrationScheme
     */
     ...
     *  Party
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\HeadOfficeParty $headOfficeParty
     */
     ...
     *  Shareholder Party
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ShareholderParty[] $shareholderParty
     */
     ...
     *  Microsoft Corporation
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\RegistrationName
     */
     ...
     *  Microsoft Corporation
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\RegistrationName $registrationName
     * @return self
     */
    public function setRegistrationName(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\RegistrationName $registrationName = null)
    {
     ...
     *  3556625
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\CompanyID
     */
     ...
     *  3556625
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\CompanyID $companyID
     * @return self
     */
    public function setCompanyID(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\CompanyID $companyID = null)
    {
     ...
     *  Code. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\CompanyLiquidationStatusCode
     */
     ...
     *  Code. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\CompanyLiquidationStatusCode $companyLiquidationStatusCode
     * @return self
     */
    public function setCompanyLiquidationStatusCode(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\CompanyLiquidationStatusCode $companyLiquidationStatusCode = null)
    {
     ...
     *  Amount. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\CorporateStockAmount
     */
     ...
     *  Amount. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\CorporateStockAmount $corporateStockAmount
     * @return self
     */
    public function setCorporateStockAmount(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\CorporateStockAmount $corporateStockAmount = null)
    {
     ...
     *  Address
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\RegistrationAddress
     */
     ...
     *  Address
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\RegistrationAddress $registrationAddress
     * @return self
     */
    public function setRegistrationAddress(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\RegistrationAddress $registrationAddress = null)
    {
     ...
     *  Corporate Registration Scheme
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\CorporateRegistrationScheme
     */
     ...
     *  Corporate Registration Scheme
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\CorporateRegistrationScheme $corporateRegistrationScheme
     * @return self
     */
    public function setCorporateRegistrationScheme(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\CorporateRegistrationScheme $corporateRegistrationScheme = null)
    {
     ...
     *  Party
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\HeadOfficeParty
     */
     ...
     *  Party
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\HeadOfficeParty $headOfficeParty
     * @return self
     */
    public function setHeadOfficeParty(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\HeadOfficeParty $headOfficeParty = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ShareholderParty $shareholderParty
     */
    public function addToShareholderParty(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ShareholderParty $shareholderParty)
    {
     ...
     *  Shareholder Party
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ShareholderParty[]
     */
