...
class SubcontractTermsType
{
     ...
     *  Rate. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\Rate $rate
     */
    private $rate = null;
     ...
     *  Code. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\SubcontractingConditionsCode $subcontractingConditionsCode
     */
     ...
     *  Percent. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\MaximumPercent $maximumPercent
     */
     ...
     *  Percent. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\MinimumPercent $minimumPercent
     */
     ...
     *  Rate. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\Rate
     */
     ...
     *  Rate. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\Rate $rate
     * @return self
     */
    public function setRate(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\Rate $rate = null)
    {
        $this->rate = $rate;
        return $this;
    }
     ...
     *  Code. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\SubcontractingConditionsCode
     */
     ...
     *  Code. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\SubcontractingConditionsCode $subcontractingConditionsCode
     * @return self
     */
    public function setSubcontractingConditionsCode(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\SubcontractingConditionsCode $subcontractingConditionsCode = null)
    {
     ...
     *  Percent. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\MaximumPercent
     */
     ...
     *  Percent. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\MaximumPercent $maximumPercent
     * @return self
     */
    public function setMaximumPercent(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\MaximumPercent $maximumPercent = null)
    {
     ...
     *  Percent. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\MinimumPercent
     */
     ...
     *  Percent. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\MinimumPercent $minimumPercent
     * @return self
     */
    public function setMinimumPercent(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\MinimumPercent $minimumPercent = null)
    {
