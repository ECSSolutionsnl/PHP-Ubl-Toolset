...
class TradeFinancingType
{
     ...
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\FinancingInstrumentCode $financingInstrumentCode
     */
     ...
     *  Party
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\FinancingParty $financingParty
     */
     ...
     *  Financial Account
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\FinancingFinancialAccount $financingFinancialAccount
     */
     ...
     *  Factoring , Invoice Financing , Pre-shipment Financing , Letter of Credit , Irrevocable Letter of Credit .
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\FinancingInstrumentCode
     */
     ...
     *  Factoring , Invoice Financing , Pre-shipment Financing , Letter of Credit , Irrevocable Letter of Credit .
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\FinancingInstrumentCode $financingInstrumentCode
     * @return self
     */
    public function setFinancingInstrumentCode(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\FinancingInstrumentCode $financingInstrumentCode = null)
    {
     ...
     * @return self
     */
    public function setContractDocumentReference(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ContractDocumentReference $contractDocumentReference = null)
    {
     ...
     *  Party
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\FinancingParty
     */
     ...
     *  Party
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\FinancingParty $financingParty
     * @return self
     */
    public function setFinancingParty(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\FinancingParty $financingParty)
    {
     ...
     *  Financial Account
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\FinancingFinancialAccount
     */
     ...
     *  Financial Account
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\FinancingFinancialAccount $financingFinancialAccount
     * @return self
     */
    public function setFinancingFinancialAccount(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\FinancingFinancialAccount $financingFinancialAccount = null)
    {
