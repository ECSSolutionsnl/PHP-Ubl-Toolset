...
class PromotionalEventType
{
     ...
     *  Code. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\PromotionalEventTypeCode $promotionalEventTypeCode
     */
     ...
     *  Promotional Specification
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\PromotionalSpecification[] $promotionalSpecification
     */
     ...
     *  Code. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\PromotionalEventTypeCode
     */
     ...
     *  Code. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\PromotionalEventTypeCode $promotionalEventTypeCode
     * @return self
     */
    public function setPromotionalEventTypeCode(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\PromotionalEventTypeCode $promotionalEventTypeCode)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\PromotionalSpecification $promotionalSpecification
     */
    public function addToPromotionalSpecification(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\PromotionalSpecification $promotionalSpecification)
    {
     ...
     *  Promotional Specification
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\PromotionalSpecification[]
     */
