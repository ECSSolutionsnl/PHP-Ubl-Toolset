...
class CreditNoteLineType
{
     ...
     *  Quantity. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\CreditedQuantity $creditedQuantity
     */
     ...
     *  Credit Note Line
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\SubCreditNoteLine[] $subCreditNoteLine
     */
     ...
     *  Quantity. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\CreditedQuantity
     */
     ...
     *  Quantity. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\CreditedQuantity $creditedQuantity
     * @return self
     */
    public function setCreditedQuantity(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\CreditedQuantity $creditedQuantity = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\SubCreditNoteLine $subCreditNoteLine
     */
    public function addToSubCreditNoteLine(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\SubCreditNoteLine $subCreditNoteLine)
    {
     ...
     *  Credit Note Line
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\SubCreditNoteLine[]
     */
