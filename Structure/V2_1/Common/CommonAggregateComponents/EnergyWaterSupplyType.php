...
class EnergyWaterSupplyType
{
     ...
     *  Consumption Report
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ConsumptionReport[] $consumptionReport
     */
     ...
     *  Energy Tax Report
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\EnergyTaxReport[] $energyTaxReport
     */
     ...
     *  Consumption Average
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ConsumptionAverage[] $consumptionAverage
     */
     ...
     *  Consumption Correction
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\EnergyWaterConsumptionCorrection[] $energyWaterConsumptionCorrection
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ConsumptionReport $consumptionReport
     */
    public function addToConsumptionReport(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ConsumptionReport $consumptionReport)
    {
     ...
     *  Consumption Report
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ConsumptionReport[]
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\EnergyTaxReport $energyTaxReport
     */
    public function addToEnergyTaxReport(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\EnergyTaxReport $energyTaxReport)
    {
     ...
     *  Energy Tax Report
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\EnergyTaxReport[]
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ConsumptionAverage $consumptionAverage
     */
    public function addToConsumptionAverage(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ConsumptionAverage $consumptionAverage)
    {
     ...
     *  Consumption Average
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ConsumptionAverage[]
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\EnergyWaterConsumptionCorrection $energyWaterConsumptionCorrection
     */
    public function addToEnergyWaterConsumptionCorrection(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\EnergyWaterConsumptionCorrection $energyWaterConsumptionCorrection)
    {
     ...
     *  Consumption Correction
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\EnergyWaterConsumptionCorrection[]
     */
