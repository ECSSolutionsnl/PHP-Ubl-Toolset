...
class ItemPropertyType
{
     ...
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\TestMethod $testMethod
     */
     ...
     *  Text. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ListValue[] $listValue
     */
    private $listValue = [
     ...
     *  Period
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\UsabilityPeriod $usabilityPeriod
     */
     ...
     *  Item Property Group
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ItemPropertyGroup[] $itemPropertyGroup
     */
     ...
     *  Dimension
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\RangeDimension $rangeDimension
     */
     ...
     *  Item Property Range
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ItemPropertyRange $itemPropertyRange
     */
     ...
     *  100 watts , 15 European , 20% +/- 5%
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\TestMethod
     */
     ...
     *  100 watts , 15 European , 20% +/- 5%
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\TestMethod $testMethod
     * @return self
     */
    public function setTestMethod(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\TestMethod $testMethod = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ListValue $listValue
     */
    public function addToListValue(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ListValue $listValue)
    {
     ...
     *  Text. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ListValue[]
     */
     ...
     *  Period
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\UsabilityPeriod
     */
     ...
     *  Period
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\UsabilityPeriod $usabilityPeriod
     * @return self
     */
    public function setUsabilityPeriod(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\UsabilityPeriod $usabilityPeriod = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ItemPropertyGroup $itemPropertyGroup
     */
    public function addToItemPropertyGroup(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ItemPropertyGroup $itemPropertyGroup)
    {
     ...
     *  Item Property Group
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ItemPropertyGroup[]
     */
     ...
     *  Dimension
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\RangeDimension
     */
     ...
     *  Dimension
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\RangeDimension $rangeDimension
     * @return self
     */
    public function setRangeDimension(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\RangeDimension $rangeDimension = null)
    {
     ...
     *  Item Property Range
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ItemPropertyRange
     */
     ...
     *  Item Property Range
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ItemPropertyRange $itemPropertyRange
     * @return self
     */
    public function setItemPropertyRange(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ItemPropertyRange $itemPropertyRange = null)
    {
