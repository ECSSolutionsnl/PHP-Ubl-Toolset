...
class InventoryReportLineType
{
     ...
     *  Amount. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\InventoryValueAmount $inventoryValueAmount
     */
     ...
     *  Code. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\AvailabilityStatusCode $availabilityStatusCode
     */
     ...
     *  Location
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\InventoryLocation $inventoryLocation
     */
     ...
     *  Amount. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\InventoryValueAmount
     */
     ...
     *  Amount. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\InventoryValueAmount $inventoryValueAmount
     * @return self
     */
    public function setInventoryValueAmount(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\InventoryValueAmount $inventoryValueAmount = null)
    {
     ...
     *  Code. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\AvailabilityStatusCode
     */
     ...
     *  Code. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\AvailabilityStatusCode $availabilityStatusCode
     * @return self
     */
    public function setAvailabilityStatusCode(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\AvailabilityStatusCode $availabilityStatusCode = null)
    {
     ...
     *  Location
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\InventoryLocation
     */
     ...
     *  Location
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\InventoryLocation $inventoryLocation
     * @return self
     */
    public function setInventoryLocation(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\InventoryLocation $inventoryLocation = null)
    {
