...
class FinancialGuaranteeType
{
     ...
     *  Rate. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\AmountRate $amountRate
     */
     ...
     *  Period
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ConstitutionPeriod $constitutionPeriod
     */
     ...
     * @return self
     */
    public function setGuaranteeTypeCode(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\GuaranteeTypeCode $guaranteeTypeCode)
    {
     ...
     * @return self
     */
    public function setLiabilityAmount(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\LiabilityAmount $liabilityAmount = null)
    {
     ...
     *  Rate. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\AmountRate
     */
     ...
     *  Rate. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\AmountRate $amountRate
     * @return self
     */
    public function setAmountRate(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\AmountRate $amountRate = null)
    {
     ...
     *  Period
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ConstitutionPeriod
     */
     ...
     *  Period
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ConstitutionPeriod $constitutionPeriod
     * @return self
     */
    public function setConstitutionPeriod(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ConstitutionPeriod $constitutionPeriod = null)
    {
