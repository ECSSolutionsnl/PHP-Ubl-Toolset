...
class AwardingCriterionType
{
     ...
     *  Code. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\AwardingCriterionTypeCode $awardingCriterionTypeCode
     */
     ...
     *  Numeric. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\WeightNumeric $weightNumeric
     */
     ...
     *  Text. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\Weight[] $weight
     */
    private $weight = [
     ...
     *  Text. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\CalculationExpression[] $calculationExpression
     */
     ...
     *  Code. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\CalculationExpressionCode $calculationExpressionCode
     */
     ...
     *  Amount. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\MinimumAmount $minimumAmount
     */
     ...
     *  Amount. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\MaximumAmount $maximumAmount
     */
     ...
     *  Text. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\MinimumImprovementBid[] $minimumImprovementBid
     */
     ...
     *  Awarding Criterion
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\SubordinateAwardingCriterion[] $subordinateAwardingCriterion
     */
     ...
     *  Code. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\AwardingCriterionTypeCode
     */
     ...
     *  Code. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\AwardingCriterionTypeCode $awardingCriterionTypeCode
     * @return self
     */
    public function setAwardingCriterionTypeCode(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\AwardingCriterionTypeCode $awardingCriterionTypeCode = null)
    {
     ...
     *  Numeric. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\WeightNumeric
     */
     ...
     *  Numeric. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\WeightNumeric $weightNumeric
     * @return self
     */
    public function setWeightNumeric(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\WeightNumeric $weightNumeric = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\Weight $weight
     */
    public function addToWeight(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\Weight $weight)
    {
        $this->weight[] = $weight;
        return $this;
    }
     ...
     *  Text. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\Weight[]
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\CalculationExpression $calculationExpression
     */
    public function addToCalculationExpression(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\CalculationExpression $calculationExpression)
    {
     ...
     *  Text. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\CalculationExpression[]
     */
     ...
     *  Code. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\CalculationExpressionCode
     */
     ...
     *  Code. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\CalculationExpressionCode $calculationExpressionCode
     * @return self
     */
    public function setCalculationExpressionCode(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\CalculationExpressionCode $calculationExpressionCode = null)
    {
     ...
     *  Amount. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\MinimumAmount
     */
     ...
     *  Amount. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\MinimumAmount $minimumAmount
     * @return self
     */
    public function setMinimumAmount(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\MinimumAmount $minimumAmount = null)
    {
     ...
     *  Amount. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\MaximumAmount
     */
     ...
     *  Amount. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\MaximumAmount $maximumAmount
     * @return self
     */
    public function setMaximumAmount(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\MaximumAmount $maximumAmount = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\MinimumImprovementBid $minimumImprovementBid
     */
    public function addToMinimumImprovementBid(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\MinimumImprovementBid $minimumImprovementBid)
    {
     ...
     *  Text. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\MinimumImprovementBid[]
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\SubordinateAwardingCriterion $subordinateAwardingCriterion
     */
    public function addToSubordinateAwardingCriterion(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\SubordinateAwardingCriterion $subordinateAwardingCriterion)
    {
     ...
     *  Awarding Criterion
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\SubordinateAwardingCriterion[]
     */
