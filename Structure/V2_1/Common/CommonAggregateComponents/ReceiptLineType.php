...
class ReceiptLineType
{
     ...
     *  Quantity. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ReceivedQuantity $receivedQuantity
     */
     ...
     *  Quantity. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ShortQuantity $shortQuantity
     */
     ...
     *  Code. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ShortageActionCode $shortageActionCode
     */
     ...
     *  Quantity. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\RejectedQuantity $rejectedQuantity
     */
     ...
     *  Code. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\RejectReasonCode $rejectReasonCode
     */
     ...
     *  Text. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\RejectReason[] $rejectReason
     */
     ...
     *  Code. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\RejectActionCode $rejectActionCode
     */
     ...
     *  Code. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\QuantityDiscrepancyCode $quantityDiscrepancyCode
     */
     ...
     *  Quantity. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\OversupplyQuantity $oversupplyQuantity
     */
     ...
     *  Code. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\TimingComplaintCode $timingComplaintCode
     */
     ...
     *  Text. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\TimingComplaint $timingComplaint
     */
     ...
     *  Order Line Reference
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\OrderLineReference $orderLineReference
     */
     ...
     *  Line Reference
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\DespatchLineReference[] $despatchLineReference
     */
     ...
     *  Quantity. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ReceivedQuantity
     */
     ...
     *  Quantity. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ReceivedQuantity $receivedQuantity
     * @return self
     */
    public function setReceivedQuantity(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ReceivedQuantity $receivedQuantity = null)
    {
     ...
     *  Quantity. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ShortQuantity
     */
     ...
     *  Quantity. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ShortQuantity $shortQuantity
     * @return self
     */
    public function setShortQuantity(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ShortQuantity $shortQuantity = null)
    {
     ...
     *  Code. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ShortageActionCode
     */
     ...
     *  Code. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ShortageActionCode $shortageActionCode
     * @return self
     */
    public function setShortageActionCode(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ShortageActionCode $shortageActionCode = null)
    {
     ...
     *  Quantity. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\RejectedQuantity
     */
     ...
     *  Quantity. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\RejectedQuantity $rejectedQuantity
     * @return self
     */
    public function setRejectedQuantity(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\RejectedQuantity $rejectedQuantity = null)
    {
     ...
     *  Code. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\RejectReasonCode
     */
     ...
     *  Code. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\RejectReasonCode $rejectReasonCode
     * @return self
     */
    public function setRejectReasonCode(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\RejectReasonCode $rejectReasonCode = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\RejectReason $rejectReason
     */
    public function addToRejectReason(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\RejectReason $rejectReason)
    {
     ...
     *  Text. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\RejectReason[]
     */
     ...
     *  Code. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\RejectActionCode
     */
     ...
     *  Code. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\RejectActionCode $rejectActionCode
     * @return self
     */
    public function setRejectActionCode(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\RejectActionCode $rejectActionCode = null)
    {
     ...
     *  Code. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\QuantityDiscrepancyCode
     */
     ...
     *  Code. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\QuantityDiscrepancyCode $quantityDiscrepancyCode
     * @return self
     */
    public function setQuantityDiscrepancyCode(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\QuantityDiscrepancyCode $quantityDiscrepancyCode = null)
    {
     ...
     *  Quantity. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\OversupplyQuantity
     */
     ...
     *  Quantity. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\OversupplyQuantity $oversupplyQuantity
     * @return self
     */
    public function setOversupplyQuantity(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\OversupplyQuantity $oversupplyQuantity = null)
    {
     ...
     *  Code. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\TimingComplaintCode
     */
     ...
     *  Code. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\TimingComplaintCode $timingComplaintCode
     * @return self
     */
    public function setTimingComplaintCode(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\TimingComplaintCode $timingComplaintCode = null)
    {
     ...
     *  Text. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\TimingComplaint
     */
     ...
     *  Text. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\TimingComplaint $timingComplaint
     * @return self
     */
    public function setTimingComplaint(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\TimingComplaint $timingComplaint = null)
    {
     ...
     *  Order Line Reference
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\OrderLineReference
     */
     ...
     *  Order Line Reference
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\OrderLineReference $orderLineReference
     * @return self
     */
    public function setOrderLineReference(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\OrderLineReference $orderLineReference = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\DespatchLineReference $despatchLineReference
     */
    public function addToDespatchLineReference(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\DespatchLineReference $despatchLineReference)
    {
     ...
     *  Line Reference
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\DespatchLineReference[]
     */
     ...
     */
    public function addToShipment(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\Shipment $shipment)
    {
