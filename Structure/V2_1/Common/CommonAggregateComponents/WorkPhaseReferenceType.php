...
class WorkPhaseReferenceType
{
     ...
     *  Code. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\WorkPhaseCode $workPhaseCode
     */
     ...
     *  Text. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\WorkPhase[] $workPhase
     */
    private $workPhase = [
     ...
     *  Percent. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ProgressPercent $progressPercent
     */
     ...
     *  Document Reference
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\WorkOrderDocumentReference[] $workOrderDocumentReference
     */
     ...
     *  Code. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\WorkPhaseCode
     */
     ...
     *  Code. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\WorkPhaseCode $workPhaseCode
     * @return self
     */
    public function setWorkPhaseCode(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\WorkPhaseCode $workPhaseCode = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\WorkPhase $workPhase
     */
    public function addToWorkPhase(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\WorkPhase $workPhase)
    {
     ...
     *  Text. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\WorkPhase[]
     */
     ...
     *  Percent. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ProgressPercent
     */
     ...
     *  Percent. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ProgressPercent $progressPercent
     * @return self
     */
    public function setProgressPercent(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ProgressPercent $progressPercent = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\WorkOrderDocumentReference $workOrderDocumentReference
     */
    public function addToWorkOrderDocumentReference(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\WorkOrderDocumentReference $workOrderDocumentReference)
    {
     ...
     *  Document Reference
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\WorkOrderDocumentReference[]
     */
