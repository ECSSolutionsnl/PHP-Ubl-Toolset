...
class PricingReferenceType
{
     ...
     *  Item Location Quantity
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\OriginalItemLocationQuantity $originalItemLocationQuantity
     */
     ...
     *  Price
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\AlternativeConditionPrice[] $alternativeConditionPrice
     */
     ...
     *  Item Location Quantity
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\OriginalItemLocationQuantity
     */
     ...
     *  Item Location Quantity
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\OriginalItemLocationQuantity $originalItemLocationQuantity
     * @return self
     */
    public function setOriginalItemLocationQuantity(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\OriginalItemLocationQuantity $originalItemLocationQuantity = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\AlternativeConditionPrice $alternativeConditionPrice
     */
    public function addToAlternativeConditionPrice(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\AlternativeConditionPrice $alternativeConditionPrice)
    {
     ...
     *  Price
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\AlternativeConditionPrice[]
     */
