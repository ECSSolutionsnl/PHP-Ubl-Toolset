...
class EconomicOperatorRoleType
{
     ...
     *  Text. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\RoleDescription[] $roleDescription
     */
     ...
     * @return self
     */
    public function setRoleCode(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\RoleCode $roleCode = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\RoleDescription $roleDescription
     */
    public function addToRoleDescription(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\RoleDescription $roleDescription)
    {
     ...
     *  Text. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\RoleDescription[]
     */
