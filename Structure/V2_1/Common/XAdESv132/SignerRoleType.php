...
{
    /**
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\XAdESv132\AnyType[] $claimedRoles
     */
    private $claimedRoles = null;

    /**
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\XAdESv132\EncapsulatedPKIDataType[] $certifiedRoles
     */
     ...
     */
    public function addToClaimedRoles(\ECSSolutions\UblToolset\Structure\V2_1\Common\XAdESv132\AnyType $claimedRole)
    {
     ...
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\XAdESv132\AnyType[] $claimedRoles
     * @return self
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\XAdESv132\EncapsulatedPKIDataType $certifiedRole
     */
    public function addToCertifiedRoles(\ECSSolutions\UblToolset\Structure\V2_1\Common\XAdESv132\EncapsulatedPKIDataType $certifiedRole)
    {
     ...
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\XAdESv132\EncapsulatedPKIDataType[] $certifiedRoles
     * @return self
     */
