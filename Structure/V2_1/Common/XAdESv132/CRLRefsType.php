...
{
    /**
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\XAdESv132\CRLRefType[] $cRLRef
     */
    private $cRLRef = [
     ...
     */
    public function addToCRLRef(\ECSSolutions\UblToolset\Structure\V2_1\Common\XAdESv132\CRLRefType $cRLRef)
    {
        $this->cRLRef[] = $cRLRef;
        return $this;
    }
