...
class XAdESTimeStampType extends GenericTimeStampType
{
    ...
    /**
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\XAdESv132\IncludeXsd[] $include
     */
    private $include = [
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\XAdESv132\IncludeXsd $include
     */
    public function addToInclude(\ECSSolutions\UblToolset\Structure\V2_1\Common\XAdESv132\IncludeXsd $include)
    {
     ...
     * Gets as include
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\XAdESv132\IncludeXsd[]
     */
     ...
     */
    public function addToEncapsulatedTimeStamp(\ECSSolutions\UblToolset\Structure\V2_1\Common\XAdESv132\EncapsulatedPKIDataType $encapsulatedTimeStamp)
    {
     ...
     */
    public function addToXMLTimeStamp(\ECSSolutions\UblToolset\Structure\V2_1\Common\XAdESv132\AnyType $xMLTimeStamp)
    {
