...
class CompleteCertificateRefsType
{
    ...
    /**
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\XAdESv132\CertIDType[] $certRefs
     */
     ...
     */
    public function addToCertRefs(\ECSSolutions\UblToolset\Structure\V2_1\Common\XAdESv132\CertIDType $cert)
    {
        $this->certRefs[] = $cert;
        return $this;
    }
     ...
     * Sets a new certRefs
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\XAdESv132\CertIDType[] $certRefs
     * @return self
     */
