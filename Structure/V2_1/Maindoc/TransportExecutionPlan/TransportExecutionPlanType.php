...
namespace ECSSolutions\UblToolset\Structure\V2_1\Maindoc\TransportExecutionPlan;
...
class TransportExecutionPlanType
{
     ...
     *  Text. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\TransportServiceProviderRemarks[] $transportServiceProviderRemarks
     */
     ...
     *  Party
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\BillToParty $billToParty
     */
     ...
     *  Document Reference
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\TransportExecutionPlanRequestDocumentReference $transportExecutionPlanRequestDocumentReference
     */
     ...
     *  Period
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\TransportServiceProviderResponseRequiredPeriod $transportServiceProviderResponseRequiredPeriod
     */
     ...
     *  Period
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\TransportUserResponseRequiredPeriod[] $transportUserResponseRequiredPeriod
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\TransportServiceProviderRemarks $transportServiceProviderRemarks
     */
    public function addToTransportServiceProviderRemarks(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\TransportServiceProviderRemarks $transportServiceProviderRemarks)
    {
     ...
     *  Text. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\TransportServiceProviderRemarks[]
     */
     ...
     *  Party
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\BillToParty
     */
     ...
     *  Party
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\BillToParty $billToParty
     * @return self
     */
    public function setBillToParty(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\BillToParty $billToParty = null)
    {
     ...
     *  Document Reference
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\TransportExecutionPlanRequestDocumentReference
     */
     ...
     *  Document Reference
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\TransportExecutionPlanRequestDocumentReference $transportExecutionPlanRequestDocumentReference
     * @return self
     */
    public function setTransportExecutionPlanRequestDocumentReference(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\TransportExecutionPlanRequestDocumentReference $transportExecutionPlanRequestDocumentReference = null)
    {
     ...
     *  Period
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\TransportServiceProviderResponseRequiredPeriod
     */
     ...
     *  Period
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\TransportServiceProviderResponseRequiredPeriod $transportServiceProviderResponseRequiredPeriod
     * @return self
     */
    public function setTransportServiceProviderResponseRequiredPeriod(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\TransportServiceProviderResponseRequiredPeriod $transportServiceProviderResponseRequiredPeriod = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\TransportUserResponseRequiredPeriod $transportUserResponseRequiredPeriod
     */
    public function addToTransportUserResponseRequiredPeriod(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\TransportUserResponseRequiredPeriod $transportUserResponseRequiredPeriod)
    {
     ...
     *  Period
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\TransportUserResponseRequiredPeriod[]
     */
