...
namespace ECSSolutions\UblToolset\Structure\V2_1\Maindoc\TransportProgressStatus;

/**
 * Class representing TransportProgressStatusType
 *
 * ABIE
 *  Transport Progress Status. Details
 ...
 * XSD Type: TransportProgressStatusType
 */
class TransportProgressStatusType
{
    ...
    /**
     * BBIE
     *  Transport Progress Status. UBL Version Identifier. Identifier
    ...
    /**
     * BBIE
     *  Transport Progress Status. Customization Identifier. Identifier
    ...
    /**
     * BBIE
     *  Transport Progress Status. Profile Identifier. Identifier
    ...
    /**
     * BBIE
     *  Transport Progress Status. Profile Execution Identifier. Identifier
    ...
    /**
     * BBIE
     *  Transport Progress Status. Identifier
    ...
    /**
     * BBIE
     *  Transport Progress Status. Copy_ Indicator. Indicator
    ...
    /**
     * BBIE
     *  Transport Progress Status. UUID. Identifier
    ...
    /**
     * BBIE
     *  Transport Progress Status. Issue Date. Date
    ...
    /**
     * BBIE
     *  Transport Progress Status. Issue Time. Time
    ...
    /**
     * BBIE
     *  Transport Progress Status. Note. Text
    ...
    /**
     * BBIE
     *  Transport Progress Status. Status Available_ Indicator. Indicator
     ...
     *  Indicator. Type
     *
     * @var bool $statusAvailableIndicator
     */
    private $statusAvailableIndicator = null;

    /**
     * ASBIE
     *  Transport Progress Status. Signature
    ...
    /**
     * ASBIE
     *  Transport Progress Status. Sender_ Party. Party
    ...
    /**
     * ASBIE
     *  Transport Progress Status. Receiver_ Party. Party
    ...
    /**
     * ASBIE
     *  Transport Progress Status. Source Issuer_ Party. Party
     ...
     *  Party
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\SourceIssuerParty $sourceIssuerParty
     */
    private $sourceIssuerParty = null;

    /**
     * ASBIE
     *  Transport Progress Status. Transport Progress Status Request_ Document Reference. Document Reference
     ...
     *  Document Reference
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\TransportProgressStatusRequestDocumentReference $transportProgressStatusRequestDocumentReference
     */
    private $transportProgressStatusRequestDocumentReference = null;

    /**
     * ASBIE
     *  Transport Progress Status. Transport Means
    ...
    /**
     * ASBIE
     *  Transport Progress Status. Transport Schedule
     ...
     *  Transport Schedule
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\TransportSchedule[] $transportSchedule
     */
    private $transportSchedule = [
    ...
    /**
     * Gets as statusAvailableIndicator
     *
     * BBIE
     *  Transport Progress Status. Status Available_ Indicator. Indicator
     *  Indicates whether transport progress information is available.
     ...
     * @return bool
     */
    public function getStatusAvailableIndicator()
    {
        return $this->statusAvailableIndicator;
    }

    /**
     * Sets a new statusAvailableIndicator
     *
     * BBIE
     *  Transport Progress Status. Status Available_ Indicator. Indicator
     *  Indicates whether transport progress information is available.
     ...
     *  Indicator. Type
     *
     * @param bool $statusAvailableIndicator
     * @return self
     */
    public function setStatusAvailableIndicator($statusAvailableIndicator)
    {
     ...
     *  Party
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\SourceIssuerParty
     */
    public function getSourceIssuerParty()
    {
        return $this->sourceIssuerParty;
    }

    /**
     * Sets a new sourceIssuerParty
     *
     * ASBIE
     *  Transport Progress Status. Source Issuer_ Party. Party
     *  The party that is the source of the Transport Progress Status.
     ...
     *  Party
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\SourceIssuerParty $sourceIssuerParty
     * @return self
     */
    public function setSourceIssuerParty(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\SourceIssuerParty $sourceIssuerParty = null)
    {
    ...
    /**
     * Gets as transportProgressStatusRequestDocumentReference
     *
     * ASBIE
     *  Transport Progress Status. Transport Progress Status Request_ Document Reference. Document Reference
     *  A reference to the Transport Progress Status Request document to which this status report is a response.
     ...
     *  Document Reference
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\TransportProgressStatusRequestDocumentReference
     */
    public function getTransportProgressStatusRequestDocumentReference()
    {
        return $this->transportProgressStatusRequestDocumentReference;
    }

    /**
     * Sets a new transportProgressStatusRequestDocumentReference
     *
     * ASBIE
     *  Transport Progress Status. Transport Progress Status Request_ Document Reference. Document Reference
     *  A reference to the Transport Progress Status Request document to which this status report is a response.
     ...
     *  Document Reference
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\TransportProgressStatusRequestDocumentReference $transportProgressStatusRequestDocumentReference
     * @return self
     */
    public function setTransportProgressStatusRequestDocumentReference(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\TransportProgressStatusRequestDocumentReference $transportProgressStatusRequestDocumentReference = null)
    {
     ...
     * @return self
     */
    public function setTransportMeans(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\TransportMeans $transportMeans)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\TransportSchedule $transportSchedule
     */
    public function addToTransportSchedule(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\TransportSchedule $transportSchedule)
    {
     ...
     * @return bool
     */
    public function issetTransportSchedule($index)
    {
        return isset($this->transportSchedule[$index]);
    }

    /**
     * unset transportSchedule
     *
     * ASBIE
     *  Transport Progress Status. Transport Schedule
     *  Describes the status and schedule of the transport means operating the transport service as well as the current location of the transport means.
     ...
     * @return void
     */
    public function unsetTransportSchedule($index)
    {
        unset($this->transportSchedule[$index]);
    }

    /**
     * Gets as transportSchedule
     *
     * ASBIE
     *  Transport Progress Status. Transport Schedule
     *  Describes the status and schedule of the transport means operating the transport service as well as the current location of the transport means.
     ...
     *  Transport Schedule
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\TransportSchedule[]
     */
     ...
     * @return self
     */
    public function setTransportSchedule(?array $transportSchedule = null)
    {
        $this->transportSchedule = $transportSchedule;
        return $this;
    }
