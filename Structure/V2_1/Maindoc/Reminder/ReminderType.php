...
namespace ECSSolutions\UblToolset\Structure\V2_1\Maindoc\Reminder;
...
class ReminderType
{
     ...
     *  Code. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ReminderTypeCode $reminderTypeCode
     */
     ...
     *  Numeric. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ReminderSequenceNumeric $reminderSequenceNumeric
     */
     ...
     *  Reminder Line
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ReminderLine[] $reminderLine
     */
     ...
     *  Code. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ReminderTypeCode
     */
     ...
     *  Code. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ReminderTypeCode $reminderTypeCode
     * @return self
     */
    public function setReminderTypeCode(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ReminderTypeCode $reminderTypeCode = null)
    {
     ...
     *  Numeric. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ReminderSequenceNumeric
     */
     ...
     *  Numeric. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ReminderSequenceNumeric $reminderSequenceNumeric
     * @return self
     */
    public function setReminderSequenceNumeric(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\ReminderSequenceNumeric $reminderSequenceNumeric = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ReminderLine $reminderLine
     */
    public function addToReminderLine(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ReminderLine $reminderLine)
    {
     ...
     *  Reminder Line
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ReminderLine[]
     */
