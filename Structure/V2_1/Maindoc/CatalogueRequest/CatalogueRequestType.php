...
namespace ECSSolutions\UblToolset\Structure\V2_1\Maindoc\CatalogueRequest;
...
class CatalogueRequestType
{
     ...
     *  Catalogue Reference
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\RequestedCatalogueReference $requestedCatalogueReference
     */
     ...
     *  Language
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\RequestedLanguage $requestedLanguage
     */
     ...
     *  Classification Scheme
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\RequestedClassificationScheme[] $requestedClassificationScheme
     */
     ...
     *  Catalogue Request Line
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\CatalogueRequestLine[] $catalogueRequestLine
     */
     ...
     *  Catalogue Reference
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\RequestedCatalogueReference
     */
     ...
     *  Catalogue Reference
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\RequestedCatalogueReference $requestedCatalogueReference
     * @return self
     */
    public function setRequestedCatalogueReference(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\RequestedCatalogueReference $requestedCatalogueReference = null)
    {
     ...
     *  Language
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\RequestedLanguage
     */
     ...
     *  Language
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\RequestedLanguage $requestedLanguage
     * @return self
     */
    public function setRequestedLanguage(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\RequestedLanguage $requestedLanguage = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\RequestedClassificationScheme $requestedClassificationScheme
     */
    public function addToRequestedClassificationScheme(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\RequestedClassificationScheme $requestedClassificationScheme)
    {
     ...
     *  Classification Scheme
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\RequestedClassificationScheme[]
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\CatalogueRequestLine $catalogueRequestLine
     */
    public function addToCatalogueRequestLine(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\CatalogueRequestLine $catalogueRequestLine)
    {
     ...
     *  Catalogue Request Line
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\CatalogueRequestLine[]
     */
