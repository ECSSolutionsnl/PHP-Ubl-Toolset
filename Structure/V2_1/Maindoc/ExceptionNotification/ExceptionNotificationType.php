...
namespace ECSSolutions\UblToolset\Structure\V2_1\Maindoc\ExceptionNotification;
...
class ExceptionNotificationType
{
     ...
     *  Exception Notification Line
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ExceptionNotificationLine[] $exceptionNotificationLine
     */
     ...
     * @return self
     */
    public function setExceptionObservationPeriod(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ExceptionObservationPeriod $exceptionObservationPeriod)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ExceptionNotificationLine $exceptionNotificationLine
     */
    public function addToExceptionNotificationLine(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ExceptionNotificationLine $exceptionNotificationLine)
    {
     ...
     *  Exception Notification Line
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ExceptionNotificationLine[]
     */
