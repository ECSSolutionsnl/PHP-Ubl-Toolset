...
namespace ECSSolutions\UblToolset\Structure\V2_1\Maindoc\GoodsItemItinerary;
...
class GoodsItemItineraryType
{
     ...
     *  Identifier. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\TransportExecutionPlanReferenceID $transportExecutionPlanReferenceID
     */
     ...
     *  Consignment
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ReferencedConsignment[] $referencedConsignment
     */
     ...
     *  Transport Equipment
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ReferencedTransportEquipment[] $referencedTransportEquipment
     */
     ...
     *  Package
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ReferencedPackage[] $referencedPackage
     */
     ...
     *  Goods Item
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ReferencedGoodsItem[] $referencedGoodsItem
     */
     ...
     *  Transportation Segment
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\TransportationSegment[] $transportationSegment
     */
     ...
     * @return self
     */
    public function setVersionID(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\VersionID $versionID)
    {
     ...
     *  Identifier. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\TransportExecutionPlanReferenceID
     */
     ...
     *  Identifier. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\TransportExecutionPlanReferenceID $transportExecutionPlanReferenceID
     * @return self
     */
    public function setTransportExecutionPlanReferenceID(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\TransportExecutionPlanReferenceID $transportExecutionPlanReferenceID)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ReferencedConsignment $referencedConsignment
     */
    public function addToReferencedConsignment(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ReferencedConsignment $referencedConsignment)
    {
     ...
     *  Consignment
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ReferencedConsignment[]
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ReferencedTransportEquipment $referencedTransportEquipment
     */
    public function addToReferencedTransportEquipment(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ReferencedTransportEquipment $referencedTransportEquipment)
    {
     ...
     *  Transport Equipment
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ReferencedTransportEquipment[]
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ReferencedPackage $referencedPackage
     */
    public function addToReferencedPackage(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ReferencedPackage $referencedPackage)
    {
     ...
     *  Package
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ReferencedPackage[]
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ReferencedGoodsItem $referencedGoodsItem
     */
    public function addToReferencedGoodsItem(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ReferencedGoodsItem $referencedGoodsItem)
    {
     ...
     *  Goods Item
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ReferencedGoodsItem[]
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\TransportationSegment $transportationSegment
     */
    public function addToTransportationSegment(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\TransportationSegment $transportationSegment)
    {
     ...
     *  Transportation Segment
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\TransportationSegment[]
     */
