...
namespace ECSSolutions\UblToolset\Structure\V2_1\Maindoc\ForecastRevision;
...
class ForecastRevisionType
{
     ...
     *  Code. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\RevisionStatusCode $revisionStatusCode
     */
     ...
     *  Code. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\PurposeCode $purposeCode
     */
     ...
     *  Forecast Revision Line
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ForecastRevisionLine[] $forecastRevisionLine
     */
     ...
     * @return self
     */
    public function setSequenceNumberID(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\SequenceNumberID $sequenceNumberID)
    {
     ...
     *  Code. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\RevisionStatusCode
     */
     ...
     *  Code. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\RevisionStatusCode $revisionStatusCode
     * @return self
     */
    public function setRevisionStatusCode(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\RevisionStatusCode $revisionStatusCode = null)
    {
     ...
     *  Code. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\PurposeCode
     */
     ...
     *  Code. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\PurposeCode $purposeCode
     * @return self
     */
    public function setPurposeCode(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\PurposeCode $purposeCode = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ForecastRevisionLine $forecastRevisionLine
     */
    public function addToForecastRevisionLine(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ForecastRevisionLine $forecastRevisionLine)
    {
     ...
     *  Forecast Revision Line
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ForecastRevisionLine[]
     */
