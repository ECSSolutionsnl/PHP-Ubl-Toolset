...
namespace ECSSolutions\UblToolset\Structure\V2_1\Maindoc\ProductActivity;
...
class ProductActivityType
{
     ...
     *  Activity Data Line
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\SupplyChainActivityDataLine[] $supplyChainActivityDataLine
     */
     ...
     * @return self
     */
    public function setActivityPeriod(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\ActivityPeriod $activityPeriod)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\SupplyChainActivityDataLine $supplyChainActivityDataLine
     */
    public function addToSupplyChainActivityDataLine(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\SupplyChainActivityDataLine $supplyChainActivityDataLine)
    {
     ...
     *  Activity Data Line
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\SupplyChainActivityDataLine[]
     */
