...
namespace ECSSolutions\UblToolset\Structure\V2_1\Maindoc\DocumentStatus;
...
class DocumentStatusType
{
     ...
     *  Document Response
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\AdditionalDocumentResponse[] $additionalDocumentResponse
     */
     ...
     * @return self
     */
    public function setDocumentResponse(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\DocumentResponse $documentResponse = null)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\AdditionalDocumentResponse $additionalDocumentResponse
     */
    public function addToAdditionalDocumentResponse(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\AdditionalDocumentResponse $additionalDocumentResponse)
    {
     ...
     *  Document Response
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\AdditionalDocumentResponse[]
     */
