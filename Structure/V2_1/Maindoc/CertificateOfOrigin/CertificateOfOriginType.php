...
namespace ECSSolutions\UblToolset\Structure\V2_1\Maindoc\CertificateOfOrigin;
...
class CertificateOfOriginType
{
     ...
     *  Certificate Of Origin Application
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\CertificateOfOriginApplication $certificateOfOriginApplication
     */
     ...
     *  Endorsement
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\IssuerEndorsement $issuerEndorsement
     */
     ...
     *  Endorsement
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\EmbassyEndorsement $embassyEndorsement
     */
     ...
     *  Endorsement
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\InsuranceEndorsement $insuranceEndorsement
     */
     ...
     *  Certificate Of Origin Application
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\CertificateOfOriginApplication
     */
     ...
     *  Certificate Of Origin Application
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\CertificateOfOriginApplication $certificateOfOriginApplication
     * @return self
     */
    public function setCertificateOfOriginApplication(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\CertificateOfOriginApplication $certificateOfOriginApplication)
    {
     ...
     *  Endorsement
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\IssuerEndorsement
     */
     ...
     *  Endorsement
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\IssuerEndorsement $issuerEndorsement
     * @return self
     */
    public function setIssuerEndorsement(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\IssuerEndorsement $issuerEndorsement)
    {
     ...
     *  Endorsement
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\EmbassyEndorsement
     */
     ...
     *  Endorsement
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\EmbassyEndorsement $embassyEndorsement
     * @return self
     */
    public function setEmbassyEndorsement(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\EmbassyEndorsement $embassyEndorsement = null)
    {
     ...
     *  Endorsement
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\InsuranceEndorsement
     */
     ...
     *  Endorsement
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\InsuranceEndorsement $insuranceEndorsement
     * @return self
     */
    public function setInsuranceEndorsement(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\InsuranceEndorsement $insuranceEndorsement = null)
    {
