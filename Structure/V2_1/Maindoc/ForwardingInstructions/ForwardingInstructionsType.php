...
namespace ECSSolutions\UblToolset\Structure\V2_1\Maindoc\ForwardingInstructions;
...
class ForwardingInstructionsType
{
     ...
     *  Amount. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\DeclaredCarriageValueAmount $declaredCarriageValueAmount
     */
     ...
     *  Amount. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\DeclaredCarriageValueAmount
     */
     ...
     *  Amount. Type
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\DeclaredCarriageValueAmount $declaredCarriageValueAmount
     * @return self
     */
    public function setDeclaredCarriageValueAmount(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\DeclaredCarriageValueAmount $declaredCarriageValueAmount = null)
    {
     ...
     */
    public function addToOtherInstruction(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\OtherInstruction $otherInstruction)
    {
