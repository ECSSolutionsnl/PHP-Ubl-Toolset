...
namespace ECSSolutions\UblToolset\Structure\V2_1\Maindoc\Catalogue;
...
class CatalogueType
{
     ...
     *  Catalogue Reference
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\SourceCatalogueReference $sourceCatalogueReference
     */
     ...
     *  Catalogue Line
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\CatalogueLine[] $catalogueLine
     */
     ...
     *  Catalogue Reference
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\SourceCatalogueReference
     */
     ...
     *  Catalogue Reference
     *
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\SourceCatalogueReference $sourceCatalogueReference
     * @return self
     */
    public function setSourceCatalogueReference(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\SourceCatalogueReference $sourceCatalogueReference = null)
    {
     ...
     */
    public function addToTradingTerms(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\TradingTerms $tradingTerms)
    {
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\CatalogueLine $catalogueLine
     */
    public function addToCatalogueLine(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\CatalogueLine $catalogueLine)
    {
     ...
     *  Catalogue Line
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\CatalogueLine[]
     */
