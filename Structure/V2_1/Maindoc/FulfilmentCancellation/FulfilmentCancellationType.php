...
namespace ECSSolutions\UblToolset\Structure\V2_1\Maindoc\FulfilmentCancellation;
...
class FulfilmentCancellationType
{
     ...
     *  Text. Type
     *
     * @var \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\CancellationNote[] $cancellationNote
     */
     ...
     *
     * @return self
     * @param \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\CancellationNote $cancellationNote
     */
    public function addToCancellationNote(\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\CancellationNote $cancellationNote)
    {
     ...
     *  Text. Type
     *
     * @return \ECSSolutions\UblToolset\Structure\V2_1\Common\CommonBasicComponents\CancellationNote[]
     */
     ...
     * @return self
     */
    public function setDeliveryCustomerParty(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\DeliveryCustomerParty $deliveryCustomerParty = null)
    {
     ...
     * @return self
     */
    public function setDespatchSupplierParty(?\ECSSolutions\UblToolset\Structure\V2_1\Common\CommonAggregateComponents\DespatchSupplierParty $despatchSupplierParty = null)
    {
